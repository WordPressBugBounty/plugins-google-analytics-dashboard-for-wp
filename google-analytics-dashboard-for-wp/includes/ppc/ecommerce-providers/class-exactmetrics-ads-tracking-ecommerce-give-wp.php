...
/**
 * ExactMetrics PPC Tracking - GiveWP tracking class.
 *
 * @access public
 * @since 9.7.0
 *
...
class ExactMetrics_Ads_Tracking_Ecommerce_GiveWP extends ExactMetrics_Ads_Tracking_Ecommerce_Tracking
{
	/**
	 * Give WP Donation
	 *
	...
	public function is_active() {
		return function_exists( 'Give' ) && apply_filters( 'exactmetrics_ppc_tracking_track_conversion_give', true );
	}
