...
add_action( 'wp_login', 'exactmetrics_clear_snoozed_on_login', 10, 2 );
 ...
 */
function exactmetrics_clear_snoozed_on_login( $user_login, $user ) {
	delete_user_meta( $user->ID, 'exactmetrics_notifications_snoozed' );
}
