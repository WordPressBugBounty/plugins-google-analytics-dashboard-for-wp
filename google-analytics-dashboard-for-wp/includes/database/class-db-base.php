 ...
 * Database Base Class
 *
 * Abstract base class for all ExactMetrics database tables.
 ...
 * @since 9.11.0
 */
abstract class ExactMetrics_DB_Base {
	...
	public function get_table_version() {
		$option_name = 'exactmetrics_' . $this->table_name . '_version';
	...
	public function drop_table() {
		...
		if ( $result !== false ) {
			delete_option( 'exactmetrics_' . $this->table_name . '_version' );
		}
