...
if ( $update_available ) : ?>
	<div class="mset-update-notice">
		<p><?php esc_html_e('An update is available for ExactMetrics.', 'google-analytics-dashboard-for-wp'); ?></p>
		<a href="<?php echo esc_url(admin_url('plugins.php')); ?>" class="mset-button-secondary">
			<?php esc_html_e('Upgrade to the latest version', 'google-analytics-dashboard-for-wp'); ?>
...
<div class="mset-section mset-analytics-report" style="background-color: #ffffff;">
	...
	<div class="mset-section-content">
		...
		<?php else : ?>
			<div class="mset-report-center-button">
				<a href="<?php echo esc_url( exactmetrics_get_upgrade_link('lite-email-summaries') ); ?>" class="mset-button-primary">
					<?php esc_html('Upgrade and Unlock', 'google-analytics-dashboard-for-wp'); ?>
				</a>
			</div>
		<?php endif; ?>
	</div>
...
<div class="mset-section mset-analytics-stats" style="background-color: #ffffff;">
	<div class="mset-section-header">
		<h2>📈 <?php esc_html_e('Analytics Stats', 'google-analytics-dashboard-for-wp'); ?></h2>
	</div>
	...
	<div class="mset-section-content">
		...
		<div class="mset-report-center-button">
			<a href="<?php echo esc_url(admin_url('admin.php?page=exactmetrics_reports')); ?>" class="mset-button-primary">
...
<div class="mset-section mset-top-pages" style="background-color: #ffffff;">
	<div class="mset-section-header">
		<h2>🌐 <?php esc_html_e('Your Top 5 Viewed Pages', 'google-analytics-dashboard-for-wp'); ?></h2>
	</div>

	<div class="mset-section-content">
		<div class="mset-pages-table">
			<div class="mset-table-header">
				<div class="mset-table-header-cell"><?php esc_html_e('Page Title', 'google-analytics-dashboard-for-wp'); ?></div>
				<div class="mset-table-header-cell"><?php esc_html_e('Page Views', 'google-analytics-dashboard-for-wp'); ?></div>
			</div>
...
<div class="mset-section" style="background-color: #ffffff;">
	<div class="mset-section-header">
		<h2>⭐ <?php esc_html_e('What\'s New at ExactMetrics', 'google-analytics-dashboard-for-wp'); ?></h2>
	</div>
	<div class="mset-section-content">
