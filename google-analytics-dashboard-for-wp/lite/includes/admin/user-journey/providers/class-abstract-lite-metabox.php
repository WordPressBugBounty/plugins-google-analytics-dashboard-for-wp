		...
		<div id="exactmetrics-user-journey-lite-metabox-container">
			...
			<div id="exactmetrics-lite-entry-user-journey" class="postbox">
				<div class="exactmetrics-lite-uj-container desktop">
					<div class="exactmetrics-lite-uj-modal-head">
						<h3><?php esc_html_e( 'Unlock User Journey', 'google-analytics-dashboard-for-wp' ); ?></h3>
					</div>
					<div class="exactmetrics-lite-uj-modal-content">
						<div class="exactmetrics-lite-modal-left">
							<h4><?php esc_html_e( 'With ExactMetrics Pro, See Each Step Your Visitor Took Before Purchasing From Your Website.', 'google-analytics-dashboard-for-wp' ); ?></h4>
							<p>
								<?php
								echo sprintf(
									...
									esc_html__('%1$sPlus%2$s, upgrading to Pro will unlock %3$sall%4$s of advanced reports, tracking, and integrations. %5$sLearn more about Pro%6$s', 'google-analytics-dashboard-for-wp'),
									'<strong>',
									'</strong>',
									'<strong>',
									'</strong>',
									'<a target="_blank" href="' . esc_url($learn_more) . '" title="'.  esc_attr__('Upgrade', 'google-analytics-dashboard-for-wp') .'">',
									'</a>'
								); ?>
							</p>
				...
				<div class="exactmetrics-lite-uj-container mobile">
					<div class="exactmetrics-lite-uj-modal-content">
						<div class="exactmetrics-lite-modal-left">
							<h4><?php esc_html_e( 'User Journey', 'google-analytics-dashboard-for-wp' ); ?></h4>
							<p><?php esc_html_e( 'See each step your visitor took before purchasing from your site', 'google-analytics-dashboard-for-wp' ); ?></p>
						</div>
					</div>
				</div>
			</div>
			<div class="exactmetrics-lite-uj-upgrade">
				<p>
					...
					<?php esc_html_e( 'This is a PRO feature.', 'google-analytics-dashboard-for-wp' ); ?>
					<a target="_blank" href="<?php echo esc_url( $upgrade_link ); ?>"
					   title=""><?php esc_html_e( 'Upgrade', 'google-analytics-dashboard-for-wp' ); ?></a>
				</p>
			</div>
		</div>
		<?php
