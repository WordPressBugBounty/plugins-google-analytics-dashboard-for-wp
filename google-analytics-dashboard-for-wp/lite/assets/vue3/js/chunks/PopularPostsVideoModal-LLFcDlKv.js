...
import { l as defineStore, j as ref, m as computed, C as watch, y as onMounted, J as onUnmounted, o as openBlock, c as createElementBlock, a as createBaseVNode, F as Fragment, f as renderList, i as normalizeClass, t as toDisplayString, s as createCommentVNode, x as nextTick, u as unref, X as defineComponent, L as reactive, aI as tryOnMounted, aJ as whenever, aK as useClipboard, aL as useDebounceFn, aM as useLocalStorage, I as inject, aC as getCurrentInstance, b as createVNode, r as resolveComponent, E as createBlock, D as withCtx, a5 as resolveDynamicComponent, ay as mergeProps, K as renderSlot, n as normalizeStyle, w as withDirectives, ax as vShow, Q as Teleport, a3 as useSlots, aN as onClickOutside, v as vModelText, A as createTextVNode, aO as pushScopeId, aP as popScopeId, M as provide, z as onBeforeUnmount, B as withModifiers } from "./toastStore-sH51RcCX.js";
import { f as fetchThemes, u as updateThemeSetting, s as sharedcountGetIndexProgress, a as sharedcountStartIndexing, g as getPosts, b as getPostTypes } from "./popularPosts-D2VRbV8A.js";
import { a as useToast } from "./addons-CsEzvEzl.js";
import { n as getUpgradeUrl, o as getUrl } from "./ajax-2wfIeviZ.js";
...
import { _ as _sfc_main$8 } from "./Modal-DdttPho6.js";
...
const _hoisted_1$6 = { class: "exactmetrics-pp-theme-picker-container" };
const _hoisted_2$5 = ["onClick"];
const _hoisted_3$5 = ["textContent"];
const _hoisted_4$2 = {
  key: 0,
  class: "exactmetrics-pp-theme-active-icon"
};
const _hoisted_5$2 = {
  key: 0,
  class: "exactmetrics-pp-themes-slider-controls"
};
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const picker_class = computed(
      () => "exactmetrics-pp-theme-picker exactmetrics-pp-theme-picker-" + props.name
    );
    ...
    function option_class(key) {
      let cls = "exactmetrics-pp-theme-option exactmetrics-pp-theme-" + key;
      if (active.value === key) {
        cls += " exactmetrics-pp-theme-option-selected";
      }
      if (!themeAvailable(props.options[key].level)) {
        cls += " exactmetrics-pp-theme-not-available";
      }
      return cls;
    }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ref_key: "slider",
            ref: slider,
            class: "exactmetrics-pp-themes-carousel"
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(slides.value, (slide, key) => {
              return openBlock(), createElementBlock("div", {
                ...
                ref_key: "slidesRef",
                ref: slidesRef,
                class: "exactmetrics-pp-themes-slide"
              }, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(slide, (option, index) => {
                  return openBlock(), createElementBlock("button", {
                    ...
                    _cache[1] || (_cache[1] = createBaseVNode("span", { class: "exactmetrics-pp-theme-icon" }, null, -1)),
                    createBaseVNode("span", {
                      class: "exactmetrics-pp-theme-name",
          ...
          slidesCount.value > 1 ? (openBlock(), createElementBlock("div", _hoisted_5$2, [
            createBaseVNode("button", {
              class: "exactmetrics-pp-themes-slider-button-prev",
            ...
            createBaseVNode("button", {
              class: "exactmetrics-pp-themes-slider-button-next",
...
const _hoisted_1$5 = { class: "exactmetrics-pp-upgrade-overlay" };
...
const _hoisted_1$4 = { class: "exactmetrics-color-picker" };
const _sfc_main$5 = {
  __name: "ColorPicker",
  props: {
    color: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", {
          class: "exactmetrics-colorpicker-preview",
        ...
        showColorPicker.value ? (openBlock(), createElementBlock("div", {
          ...
          ref_key: "pickerRef",
          ref: pickerRef,
          class: "exactmetrics-colorpicker-picker"
        }, [
...
const _hoisted_1$3 = { class: "exactmetrics-number-input-no-arrows" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", _hoisted_1$3, [
        ...
        createBaseVNode("span", { class: "exactmetrics-number-input-arrows" }, [
          createBaseVNode("button", {
            class: "exactmetrics-number-input-arrow exactmetrics-number-input-arrow-up",
            onClick: increment
          }, [..._cache[0] || (_cache[0] = [
            createBaseVNode("i", { class: "monstericon-arrow" }, null, -1)
          ])]),
          createBaseVNode("button", {
            class: "exactmetrics-number-input-arrow exactmetrics-number-input-arrow-down",
            onClick: decrement
          }, [..._cache[1] || (_cache[1] = [
            createBaseVNode("i", { class: "monstericon-arrow" }, null, -1)
          ])])
        ...
        __props.unit ? (openBlock(), createElementBlock("span", {
          key: 0,
          class: "exactmetrics-number-input-unit",
...
const _hoisted_1$2 = { class: "exactmetrics-pp-sharedcount-controls" };
...
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-sharedcount-status"
};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const text_sharedcount_api = __("SharedCount API Key", "google-analytics-dashboard-for-wp");
    ...
    const text_start_indexing = __("Start Indexing", "google-analytics-dashboard-for-wp");
    ...
    const sharedcountButtonClass = computed(() => {
      let cls = "exactmetrics-button exactmetrics-button-gray";
    ...
    async function start_sharedcount_indexing() {
      ...
      text_indexing_button.value = __("Please wait", "google-analytics-dashboard-for-wp");
      try {
        const data = await sharedcountStartIndexing();
        text_indexing_button.value = __("Indexing started", "google-analytics-dashboard-for-wp");
        if (data?.max_pages) {
...
const _hoisted_1$1 = { class: "exactmetrics-pp-posts-picker" };
...
const _sfc_main$2 = {
  ...
  props: {
    ...
    placeholder: {
      type: String,
      default: () => wp.i18n.__("Select posts/search", "google-analytics-dashboard-for-wp")
    }
  },
  setup(__props) {
    const { __, sprintf } = wp.i18n;
    ...
    const text_search_pages_not_found = __("Oops! No posts found.", "google-analytics-dashboard-for-wp");
    const text_search_no_options = __("Search by post title", "google-analytics-dashboard-for-wp");
    ...
    async function updateSetting(newValue) {
      ...
      try {
        await settingsStore.updateSetting({
          ...
          // before posting to `exactmetrics_vue_update_settings`.
          value: newValue
        });
        successToast({});
      } catch (_err) {
...
const _hoisted_1 = { class: "exactmetrics-pp-video-block" };
const _hoisted_2 = {
  key: 0,
  class: "exactmetrics-pp-video-block-icon"
};
const _hoisted_3 = ["innerHTML"];
const _hoisted_4 = { class: "exactmetrics-pp-video-modal-content" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_close = __("Close", "google-analytics-dashboard-for-wp");
    const imgClass = computed(() => `exactmetrics-bg-img${props.image}`);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(_sfc_main$8, {
          ...
          "overlay-class": "exactmetrics-dialog-shell-overlay exactmetrics-pp-video-modal",
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_4, [
              createBaseVNode("button", {
                type: "button",
                class: "exactmetrics-pp-video-modal-close",
