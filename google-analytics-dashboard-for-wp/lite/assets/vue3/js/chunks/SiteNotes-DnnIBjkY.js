import { l as defineStore, j as ref, C as watch, o as openBlock, c as createElementBlock, F as Fragment, a as createBaseVNode, t as toDisplayString, u as unref, B as withModifiers, i as normalizeClass, b as createVNode, s as createCommentVNode, f as renderList, n as normalizeStyle, w as withDirectives, v as vModelText, P as vModelSelect } from "./toastStore-nTGs-rGm.js";
...
import { s as saveNote, g as getCategories, a as getNotes } from "./siteNotes-BUC_iILe.js";
...
const _hoisted_1 = { class: "exactmetrics-overview-notes" };
const _hoisted_2 = { class: "exactmetrics-overview-notes__header" };
const _hoisted_3 = { class: "exactmetrics-overview-notes__header-left" };
const _hoisted_4 = { class: "exactmetrics-overview-notes__header-left-links" };
const _hoisted_5 = { class: "text" };
const _hoisted_6 = { class: "text" };
const _hoisted_7 = { class: "exactmetrics-overview-notes__header-right" };
const _hoisted_8 = { class: "exactmetrics-overview-notes__body" };
const _hoisted_9 = { class: "exactmetrics-overview-notes__body-list" };
const _hoisted_10 = {
  key: 0,
...
const _hoisted_12 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_13 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_14 = { class: "exactmetrics-overview-notes__date-cell" };
...
const _hoisted_19 = { class: "exactmetrics-overview-notes__col-note" };
const _hoisted_20 = { class: "exactmetrics-overview-notes__note-cell" };
const _hoisted_21 = ["onClick"];
const _hoisted_22 = { class: "exactmetrics-overview-notes__col-category" };
const _hoisted_23 = {
  key: 1,
...
const _hoisted_25 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_26 = { class: "exactmetrics-overview-notes__edit-date-cell" };
const _hoisted_27 = {
  key: 0,
  class: "star-icon",
  width: "18",
...
const _hoisted_29 = { class: "exactmetrics-overview-notes__col-note" };
const _hoisted_30 = { class: "exactmetrics-overview-notes__edit-note-cell" };
const _hoisted_31 = ["disabled"];
const _hoisted_32 = { class: "exactmetrics-overview-notes__edit-actions" };
const _hoisted_33 = ["disabled"];
const _hoisted_34 = { class: "exactmetrics-overview-notes__col-category" };
const _hoisted_35 = { class: "exactmetrics-site-note-select" };
const _hoisted_36 = ["disabled"];
const _hoisted_37 = { value: "0" };
const _hoisted_38 = ["value"];
const _hoisted_39 = { key: 0 };
const _hoisted_40 = { colspan: "3" };
const _hoisted_41 = { class: "exactmetrics-overview-notes__empty" };
const _hoisted_42 = {
  key: 1,
  class: "exactmetrics-overview-notes__create"
};
const _hoisted_43 = { class: "exactmetrics-overview-notes__create-header" };
const _hoisted_44 = { class: "exactmetrics-overview-notes__create-title" };
const _hoisted_45 = { class: "exactmetrics-overview-notes__create-form" };
const _hoisted_46 = { class: "exactmetrics-overview-notes__create-row" };
const _hoisted_47 = {
  key: 0,
  class: "star-icon",
  width: "24",
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function createNote() {
      ...
      try {
        ...
        createError.value = error?.title || error?.message || __("An error occurred.", "google-analytics-dashboard-for-wp");
      } finally {
        isSaving.value = false;
      }
    }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        showList.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("span", null, toDisplayString(unref(__)("Show:", "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("a", {
                  href: "#",
                  class: normalizeClass({ selected: unref(siteNotesStore).importantFilter === null }),
                  onClick: withModifiers(removeFilters, ["prevent"])
                }, [
                  createBaseVNode("span", _hoisted_5, toDisplayString(unref(__)("All", "google-analytics-dashboard-for-wp")), 1),
                ...
                createBaseVNode("a", {
                  ...
                  createBaseVNode("span", _hoisted_6, toDisplayString(unref(__)("Important", "google-analytics-dashboard-for-wp")), 1),
            ...
            createBaseVNode("div", _hoisted_7, [
              createBaseVNode("button", {
                ...
                createBaseVNode("span", null, toDisplayString(unref(__)("Add New Site Note", "google-analytics-dashboard-for-wp")), 1)
              ])
            ])
          ]),
              ...
              !unref(siteNotesStore).loading ? (openBlock(), createElementBlock("table", _hoisted_11, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", _hoisted_12, toDisplayString(unref(__)("Date", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__)("Site Note", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__)("Category", "google-analytics-dashboard-for-wp")), 1)
                  ])
                ]),
                createBaseVNode("tbody", null, [
                      ...
                      createBaseVNode("tr", null, [
                        ...
                        createBaseVNode("td", _hoisted_19, [
                          createBaseVNode("div", _hoisted_20, [
                            ...
                            }, toDisplayString(unref(__)("Edit", "google-analytics-dashboard-for-wp")), 9, _hoisted_21)
                          ])
                        ]),
                      ...
                      editingNote.value && editingNote.value.id === note.id ? (openBlock(), createElementBlock("tr", _hoisted_24, [
                        ...
                        createBaseVNode("td", _hoisted_29, [
                          ...
                          createBaseVNode("div", _hoisted_32, [
                            ...
                            }, toDisplayString(unref(__)("Save Changes", "google-analytics-dashboard-for-wp")), 9, _hoisted_33),
                            createBaseVNode("a", {
                              href: "#",
                        ...
                        createBaseVNode("td", _hoisted_34, [
                          createBaseVNode("div", _hoisted_35, [
                            withDirectives(createBaseVNode("select", {
                              ...
                              createBaseVNode("option", _hoisted_37, toDisplayString(unref(__)("Select Category", "google-analytics-dashboard-for-wp")), 1),
                  ...
                  unref(siteNotesStore).filteredNotes.length === 0 && !unref(siteNotesStore).loading ? (openBlock(), createElementBlock("tr", _hoisted_39, [
                    createBaseVNode("td", _hoisted_40, [
                      createBaseVNode("div", _hoisted_41, toDisplayString(unref(__)("There aren't any site notes. Go ahead and create one!", "google-analytics-dashboard-for-wp")), 1)
                    ])
                  ])) : createCommentVNode("", true)
                ])
              ])) : createCommentVNode("", true)
          ...
          createBaseVNode("div", _hoisted_43, [
            createBaseVNode("span", _hoisted_44, toDisplayString(unref(__)("Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ]),
          createBaseVNode("div", _hoisted_45, [
            createBaseVNode("div", _hoisted_46, [
              ...
              createBaseVNode("div", _hoisted_49, [
                createBaseVNode("label", null, toDisplayString(unref(__)("Date", "google-analytics-dashboard-for-wp")), 1),
                createVNode(unref(Component), {
              ...
              createBaseVNode("div", _hoisted_50, [
                createBaseVNode("label", null, toDisplayString(unref(__)("Name", "google-analytics-dashboard-for-wp")), 1),
                withDirectives(createBaseVNode("input", {
                  ...
                  placeholder: unref(__)("e.g. Checkout Funnel", "google-analytics-dashboard-for-wp"),
                  disabled: isSaving.value,
              ...
              createBaseVNode("div", _hoisted_53, [
                createBaseVNode("label", null, toDisplayString(unref(__)("Category", "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("div", _hoisted_54, [
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => newNote.value.category.id = $event),
                    disabled: isSaving.value
                  }, [
                    createBaseVNode("option", _hoisted_56, toDisplayString(unref(__)("Select Category", "google-analytics-dashboard-for-wp")), 1),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(siteNotesStore).categories, (category) => {
                      return openBlock(), createElementBlock("option", {
                        key: category.id,
                        value: category.id
            ...
            createBaseVNode("div", _hoisted_58, [
              ...
              }, toDisplayString(unref(__)("Cancel", "google-analytics-dashboard-for-wp")), 9, _hoisted_59),
              createBaseVNode("button", {
                class: "exactmetrics-button",
                disabled: isSaving.value,
                onClick: createNote
              }, toDisplayString(unref(__)("Create Note", "google-analytics-dashboard-for-wp")), 9, _hoisted_60)
            ])
          ])
        ]))
      ]);
