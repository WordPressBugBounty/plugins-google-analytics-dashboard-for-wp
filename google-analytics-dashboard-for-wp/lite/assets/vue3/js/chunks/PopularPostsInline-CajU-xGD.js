...
import { u as usePopularPostsStore, _ as _sfc_main$7, P as PopularPostsThemeLicense, a as _sfc_main$8, b as _sfc_main$9, d as debounce, c as _sfc_main$c, e as _sfc_main$d, f as _sfc_main$g, g as _sfc_main$h, h as _sfc_main$i } from "./PopularPostsVideoModal-DgmQq4jW.js";
...
import { o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, u as unref, i as normalizeClass, s as createCommentVNode, n as normalizeStyle, F as Fragment, f as renderList, E as createBlock, m as computed, b as createVNode, D as withCtx, j as ref, y as onMounted } from "./toastStore-nTGs-rGm.js";
import { a as useToast } from "./addons-lB_nbVC5.js";
import { _ as _sfc_main$b } from "./SettingsInputCheckbox-D8hqhYnn.js";
import { d as _sfc_main$a } from "./exactmetrics-Lite-Cb93Js0W.js";
import { n as getUpgradeUrl } from "./ajax-BSXoXmkG.js";
import "./popularPosts-COYZELqc.js";
import "./SettingsInputText-B4Gpn0Xm.js";
import "./SettingsInfoTooltip-D7paarX8.js";
import "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./vue-multiselect.esm-BBZB2c3P.js";
import "./SettingsInputSelect-DxTaCOj7.js";
...
import "./license-k2H2_IPt.js";
const _hoisted_1$5 = { class: "exactmetrics-pp-inline-theme-preview" };
const _hoisted_2$4 = ["textContent"];
const _hoisted_3$4 = ["textContent"];
const _hoisted_4$3 = {
  key: 0,
  class: "exactmetrics-inline-popular-posts-image"
};
const _hoisted_5$3 = { class: "exactmetrics-inline-popular-posts-text" };
const _hoisted_6$3 = {
  width: "14",
  height: "19",
  viewBox: "0 0 14 19",
...
const _hoisted_10$3 = {
  key: 4,
  class: "exactmetrics-inline-popular-posts-list"
};
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const themeClass = computed(
      () => "exactmetrics-inline-popular-posts-widget exactmetrics-inline-popular-posts-" + active.value
    );
    ...
    const renderCssClass = computed(() => {
      let cls = "exactmetrics-pp-inline-theme-preview-render";
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_5$3, [
              themeOptions.value.icon ? (openBlock(), createElementBlock("span", {
                key: 0,
                class: "exactmetrics-inline-popular-posts-icon",
              ...
              themeOptions.value.label ? (openBlock(), createElementBlock("span", {
                key: 1,
                class: "exactmetrics-inline-popular-posts-label",
              ...
              themeOptions.value.border ? (openBlock(), createElementBlock("span", {
                key: 2,
                class: "exactmetrics-inline-popular-posts-border",
              ...
              themeOptions.value.title && !themeOptions.value.list ? (openBlock(), createElementBlock("a", {
                key: 3,
                class: "exactmetrics-inline-popular-posts-title",
                href: "#",
              ...
              themeOptions.value.border && themeOptions.value.border.color2 ? (openBlock(), createElementBlock("span", {
                key: 5,
                class: "exactmetrics-inline-popular-posts-border-2",
...
const _hoisted_1$4 = { class: "exactmetrics-pp-theme-controls-holder" };
const _hoisted_2$3 = {
  key: 0,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-title"
};
const _hoisted_3$3 = ["textContent"];
const _hoisted_4$2 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_18$1 = {
  key: 2,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-icon"
};
...
const _hoisted_27 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_34 = { class: "exactmetrics-pp-controls-inputs" };
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const text_icon = __("Icon", "google-analytics-dashboard-for-wp");
    const preview = computed(() => popularPostsStore.theme_preview_inline);
    const active = computed(() => {
      return preview.value ? preview.value : settingsStore.getSettings[props.name];
    });
    ...
    const renderCssClass = computed(() => {
      let cls = "exactmetrics-pp-inline-theme-controls";
      if (!themeAvailable.value) {
        cls += " exactmetrics-pp-blurred";
      }
      return cls;
...
const _hoisted_1$3 = { class: "exactmetrics-dark" };
const _hoisted_2$2 = ["textContent"];
const _hoisted_3$2 = ["innerHTML"];
const _sfc_main$4 = {
  __name: "exactmetrics-PopularPostsGaInput-Lite",
  props: {
    name: String
  },
  setup(__props) {
...
const _sfc_main$3 = {
  __name: "exactmetrics-PopularPostsMultipleEntries-Lite",
  setup(__props) {
    const { __ } = wp.i18n;
    const text_multiple_entries = __("Multiple Entries", "google-analytics-dashboard-for-wp");
    return (_ctx, _cache) => {
...
const _hoisted_4$1 = { class: "exactmetrics-pp-manual-placement-options" };
const _hoisted_5$1 = ["onClick"];
const _hoisted_6$1 = ["innerHTML"];
const _hoisted_7$1 = ["textContent"];
const _hoisted_8$1 = {
  key: 0,
  class: "exactmetrics-pp-manual-placement-content"
};
const _hoisted_9$1 = ["textContent"];
const _hoisted_10$1 = ["textContent"];
const _hoisted_11$1 = { class: "exactmetrics-pp-manual-placement-content-columns" };
const _hoisted_12$1 = { class: "exactmetrics-pp-manual-placement-content-steps" };
...
const _hoisted_17 = { class: "exactmetrics-pp-manual-placement-content-columns" };
const _hoisted_18 = { class: "exactmetrics-pp-manual-placement-content-steps" };
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const text_display_method = __("Display Method", "google-analytics-dashboard-for-wp");
    const text_display_method_desc = __(
      "There are two ways to manual include the widget in your posts.",
      "google-analytics-dashboard-for-wp"
    );
    const text_gutenberg_title = __("Using the Gutenberg Block", "google-analytics-dashboard-for-wp");
    const text_shortcode_title = __("Using the Shortcode", "google-analytics-dashboard-for-wp");
    ...
    const text_shortcode = __("Shortcode", "google-analytics-dashboard-for-wp");
    ...
    function selectorClass(key) {
      let cls = "exactmetrics-pp-manual-placement-option exactmetrics-pp-manual-placement-option-" + key;
      if (key === selected.value) {
        cls += " exactmetrics-pp-manual-placement-option-active";
      }
      return cls;
    }
    function copyToClipboard() {
      document.querySelector("#exactmetrics-shortcode-copy").select();
        ...
        createBaseVNode("div", _hoisted_4$1, [
          (openBlock(), createElementBlock(Fragment, null, renderList(options, (option, key) => {
            return createBaseVNode("div", {
              ...
              createBaseVNode("span", {
                class: "exactmetrics-pp-manual-placement-options-icon",
            ...
            createBaseVNode("ul", _hoisted_18, [
              createBaseVNode("li", null, [
                ...
                _cache[4] || (_cache[4] = createBaseVNode("input", {
                  id: "exactmetrics-shortcode-copy",
                  type: "text",
                  readonly: true,
                  value: "[exactmetrics_popular_posts_inline]"
                }, null, -1)),
...
const video_gutenberg = "https://www.youtube.com/embed/z7kt3Xz8ToY";
const video_shortcode = "https://www.youtube.com/embed/oPzN_OIfewc";
const _sfc_main$1 = {
  __name: "exactmetrics-InlinePlacement",
  setup(__props) {
    return (_ctx, _cache) => {
...
const _hoisted_1 = { class: "exactmetrics-settings-content exactmetrics-settings-content-pp-inline" };
...
const _hoisted_6 = {
  key: 0,
  class: "exactmetrics-notice-no-posts"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_placement = __("Placement", "google-analytics-dashboard-for-wp");
    const text_placement_description = __(
      "Choose how you'd like to place the widget.",
      "google-analytics-dashboard-for-wp"
    );
    const text_insert_after = __("Insert After", "google-analytics-dashboard-for-wp");
    ...
    const text_words = __("words", "google-analytics-dashboard-for-wp");
