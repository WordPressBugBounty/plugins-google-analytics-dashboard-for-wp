...
import { o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, i as normalizeClass, s as createCommentVNode } from "./toastStore-sH51RcCX.js";
const _sfc_main = {
  __name: "LaunchWizardButton",
  props: {
    buttonClass: {
      type: [String, Object, Array],
      default: "exactmetrics-button"
    },
    buttonText: {
      type: String,
  ...
  setup(__props) {
    ...
    function launchSetupWizard() {
      ...
      loadingToast(__("Preparing setup wizard...", "google-analytics-dashboard-for-wp"));
