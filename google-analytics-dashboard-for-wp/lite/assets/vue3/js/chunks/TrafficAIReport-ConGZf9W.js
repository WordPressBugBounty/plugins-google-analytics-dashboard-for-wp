...
import { m as generateTrafficAISample, n as fetchTrafficAIData } from "./trafficSampleData-BTxFRSeQ.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const columns = [
      { key: "source", label: __("AI Source", "google-analytics-dashboard-for-wp"), sortable: true, iconKey: "sourceIcon" },
      ...
      { key: "avgSessionDuration", label: __("Avg. Session Duration", "google-analytics-dashboard-for-wp"), sortable: true, type: "duration", totalType: "average" }
    ];
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__)("AI Traffic Details", "google-analytics-dashboard-for-wp"),
            columns,
            rows: tableRows.value,
            "compare-rows": compareRows.value,
            "compare-date-labels": compareDateLabelsForTable.value,
            loading: unref(loading),
            "empty-message": unref(__)("No AI traffic data currently available.", "google-analytics-dashboard-for-wp")
