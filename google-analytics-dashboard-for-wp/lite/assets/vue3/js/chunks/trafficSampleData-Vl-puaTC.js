import { A as applyFiltersToQuery, B as relayReportingQuery, E as relayFallbackFetch } from "../reports-DMcJDRGZ.js";
...
async function fetchTrafficOverviewData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    errorLabel: __("Error loading traffic overview data", "google-analytics-dashboard-for-wp")
  });
}
async function fetchTrafficSocialData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    errorLabel: __("Error loading social traffic data", "google-analytics-dashboard-for-wp")
  });
}
async function fetchTrafficAIData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    tableId: "ai_table",
    errorLabel: __("Error loading AI traffic data", "google-analytics-dashboard-for-wp")
  });
}
async function fetchTrafficLandingPagesData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    errorLabel: __("Error loading landing pages data", "google-analytics-dashboard-for-wp")
  });
}
async function fetchTrafficTechnologyData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading technology data", "google-analytics-dashboard-for-wp");
  return fetchCachedReportSection({
    cacheGroup: "traffic",
...
async function fetchTrafficCampaignData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    errorLabel: __("Error loading campaigns data", "google-analytics-dashboard-for-wp")
  });
}
async function fetchTrafficSourceMediumData(dateRange, apiFilters = null) {
  return fetchChartPlusTable(dateRange, apiFilters, {
    ...
    errorLabel: __("Error loading source/medium data", "google-analytics-dashboard-for-wp")
  });
}
