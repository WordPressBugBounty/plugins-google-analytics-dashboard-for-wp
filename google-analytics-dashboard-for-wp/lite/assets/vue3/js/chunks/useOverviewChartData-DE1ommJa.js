...
import { m as computed, j as ref } from "./toastStore-CjmlShHI.js";
const RATE_METRICS = [
  "bounceRate",
  "engagementRate",
  "sessionKeyEventRate",
...
const OVERVIEW_METRIC_DISPLAY = {
  totalUsers: { id: "totalUsers", label: __("Total Users", "google-analytics-dashboard-for-wp") },
  screenPageViews: { id: "screenPageViews", label: __("Page Views", "google-analytics-dashboard-for-wp") },
  sessions: { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp") },
  bounceRate: { id: "bounceRate", label: __("Bounce Rate", "google-analytics-dashboard-for-wp") },
  ecommercePurchases: { id: "ecommercePurchases", label: __("eCommerce Purchases", "google-analytics-dashboard-for-wp") },
  itemsPurchased: { id: "itemsPurchased", label: __("Items Purchased", "google-analytics-dashboard-for-wp") },
  averagePurchaseRevenue: { id: "averagePurchaseRevenue", label: __("Revenue/Sales", "google-analytics-dashboard-for-wp") },
  newUsers: { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp") },
  engagementRate: { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp") },
  engagedSessions: { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp") },
  sessionKeyEventRate: { id: "sessionKeyEventRate", label: __("Key Event Rate", "google-analytics-dashboard-for-wp") },
  totalRevenue: { id: "totalRevenue", label: __("Revenue", "google-analytics-dashboard-for-wp") },
  returningUsers: { id: "returningUsers", label: __("Returning Users", "google-analytics-dashboard-for-wp") },
  pageViewsPerUser: { id: "pageViewsPerUser", label: __("Pageviews / User", "google-analytics-dashboard-for-wp") },
  averageSessionDuration: { id: "averageSessionDuration", label: __("Session Duration", "google-analytics-dashboard-for-wp") },
  couponUsedPercent: { id: "couponUsedPercent", label: __("Coupon Used %", "google-analytics-dashboard-for-wp") },
  cartAbandonRatePercent: { id: "cartAbandonRatePercent", label: __("Cart Abandon Rate %", "google-analytics-dashboard-for-wp") }
};
...
const PREVIOUS_PERIOD_LEGEND_LABEL = __("Previous Period", "google-analytics-dashboard-for-wp");
