import { a1 as storeToRefs, o as openBlock, E as createBlock, D as withCtx, b as createVNode, u as unref, m as computed, j as ref } from "./toastStore-nTGs-rGm.js";
...
async function fetchMediaReportData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading media report data", "google-analytics-dashboard-for-wp");
...
const SAMPLE_VIDEOS = [
  "[Case Study] 6 Ways WPBeginner Uses ExactMetrics to Grow Their Business",
  ...
  "ExactMetrics Just got 10X Better – New Design + Custom Reports + Powerful Addons",
  "30 Easy Ways to Make Money With OptinMonster",
  "Top 5 Creative Methods to Increase Sales with ExactMetrics in 2024",
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const chartTabs = [
      { id: "video_plays", label: __$1("Video Plays", "google-analytics-dashboard-for-wp"), icon: "video-play" }
    ];
    ...
    const columns = [
      { key: "title", label: __$1("Video Details", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "videoPlays", label: __$1("Video Plays", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "avgWatchTime", label: __$1("Avg. Watch Time", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "avgPercentWatched", label: __$1("Avg. % Watched", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "completionRate", label: __$1("Completion Rate", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    ...
    function buildMediaTableRowsForPeriod(rows, periodIdx, isCompareFormat) {
      ...
      return Object.values(videos).filter((v) => !shouldHideNotSetValue(v.title)).map((v) => {
        ...
        return {
          title: v.title || __$1("(not set)", "google-analytics-dashboard-for-wp"),
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__$1)("Video Details", "google-analytics-dashboard-for-wp"),
            columns,
            rows: tableRows.value,
            "compare-rows": compareTableRows.value,
            "compare-date-labels": compareDateLabelsForTable.value,
            loading: unref(loading),
            "empty-message": unref(__$1)("No video plays tracked during this time period.", "google-analytics-dashboard-for-wp")
