...
import { k as getMiGlobal, y as onMounted, z as onBeforeUnmount, C as watch, o as openBlock, c as createElementBlock, a as createBaseVNode, B as withModifiers, i as normalizeClass, w as withDirectives, ax as vShow, F as Fragment, f as renderList, K as renderSlot, A as createTextVNode, t as toDisplayString, aF as vModelCheckbox, u as unref, s as createCommentVNode, v as vModelText, b as createVNode, j as ref, m as computed, G as withKeys, l as defineStore, L as reactive, E as createBlock, D as withCtx } from "./toastStore-sH51RcCX.js";
import { s as script } from "./vue-multiselect.esm-CQyoXHGA.js";
import { g as getNonce, b as getAjaxUrl, q as sanitizeHtml } from "./ajax-2wfIeviZ.js";
...
const _hoisted_1$2 = { class: "exactmetrics-reports-datepicker" };
const _hoisted_2$2 = { class: "exactmetrics-reports-interval-dropdown-container" };
const _hoisted_3$2 = ["innerHTML"];
const _hoisted_4$2 = { class: "exactmetrics-datepicker-default-buttons" };
const _hoisted_5$2 = ["onClick", "innerHTML"];
const _hoisted_6$2 = ["textContent"];
const _hoisted_7$1 = { key: 0 };
const _hoisted_8$1 = { class: "exactmetrics-datepicker-input-switch" };
const _hoisted_9$1 = ["textContent"];
const _hoisted_10$1 = { class: "exactmetrics-datepicker-range-inputs" };
const _hoisted_11$1 = { class: "exactmetrics-datepicker-range-input" };
const _hoisted_12$1 = ["textContent"];
const _hoisted_13$1 = { class: "exactmetrics-datepicker-range-input-fields" };
const _hoisted_14$1 = {
  key: 0,
  class: "exactmetrics-datepicker-range-input"
};
const _hoisted_15$1 = ["textContent"];
const _hoisted_16$1 = { class: "exactmetrics-datepicker-range-input-fields" };
const _hoisted_17$1 = { class: "exactmetrics-datepicker-calender-wrapper" };
const _hoisted_18$1 = { class: "exactmetrics-datepicker-calenders" };
const _hoisted_19$1 = { class: "exactmetrics-datepicker-calender" };
const _hoisted_20$1 = {
  key: 0,
  class: "exactmetrics-datepicker-calender"
};
const _hoisted_21$1 = {
  key: 0,
  class: "exactmetrics-datepicker-calenders-bottom"
};
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const text_compare_to_previous = __2("Compare to Previous", "google-analytics-dashboard-for-wp");
    const text_cancel = __2("Cancel", "google-analytics-dashboard-for-wp");
    const text_apply = __2("Apply", "google-analytics-dashboard-for-wp");
    const text_date_range = __2("Date Range", "google-analytics-dashboard-for-wp");
    const text_compare_to = __2("Compare To", "google-analytics-dashboard-for-wp");
    ...
    const dropdownClass = computed(() => {
      let cls = "exactmetrics-reports-intervals-dropdown";
      if (!dropdownVisible.value) cls += " exactmetrics-hide";
      return cls;
    });
    const showDefaultButtons = computed(() => true);
    const textDatepickerPlaceholder = computed(() => {
      return isMobile.value ? __2("Custom Date Range", "google-analytics-dashboard-for-wp") : __2("Set Custom Date Range", "google-analytics-dashboard-for-wp");
    });
    const selectedIntervalText = computed(() => {
      if (props.modelValue.compareReport) {
        return sprintf(
          __2("%1$sComparison:%2$s %3$s To %4$s", "google-analytics-dashboard-for-wp"),
          '<b class="exactmetrics-custom-dates-label">',
          "</b>",
      ...
      return sprintf(
        __2("%1$sCustom dates:%2$s %3$s - %4$s", "google-analytics-dashboard-for-wp"),
        '<b class="exactmetrics-custom-dates-label">',
        "</b>",
    ...
    const showIfFlatpickrClass = computed(() => {
      if (!datePicker.value) return "exactmetrics-hide";
      if (isCalendarOpen.value || !interval.value) return "";
      return "exactmetrics-hide";
    });
    ...
    function intervalButtonClass(days) {
      ...
      if (interval.value === days) cls += " exactmetrics-interval-active";
      return cls;
    }
    ...
    function getIntervalFormatted(text, startDate, endDate) {
      return "<b>" + text + '<span class="exactmetrics-datepicker-colon">:</span></b> <span class="exactmetrics-datepicker-interval-dates">' + getIntervalText(startDate, endDate) + "</span>";
    }
        ...
        createBaseVNode("div", _hoisted_2$2, [
          ...
          createBaseVNode("div", {
            ...
            withDirectives(createBaseVNode("div", _hoisted_4$2, [
              ...
              __props.compareOptions ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
                createBaseVNode("div", _hoisted_8$1, [
                  createBaseVNode("label", null, [
                    createBaseVNode("span", {
                      class: normalizeClass(["exactmetrics-styled-checkbox", { "exactmetrics-styled-checkbox-checked": compareDate.value }])
                    }, null, 2),
            ...
            createBaseVNode("div", {
              class: normalizeClass(["exactmetrics-datepicker-range-wrapper", showIfFlatpickrClass.value])
            }, [
              ...
              createBaseVNode("div", _hoisted_17$1, [
                ...
                compareDate.value ? (openBlock(), createElementBlock("div", _hoisted_21$1, [
                  ...
                  createBaseVNode("button", {
                    class: normalizeClass(["exactmetrics-button", "exactmetrics-button-primary", { "exactmetrics-button-disabled": !isReadyToApply.value }]),
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const props = __props;
    const emit = __emit;
    const text_of = __2("of", "google-analytics-dashboard-for-wp");
...
const useUserJourneyStore = defineStore("userJourney", () => {
  const filterForm = reactive({
    search: "",
    sources: { value: "", label: __("All Sources", "google-analytics-dashboard-for-wp") },
    mediums: { value: "", label: __("All Mediums", "google-analytics-dashboard-for-wp") },
    campaigns: { value: "", label: __("All Campaigns", "google-analytics-dashboard-for-wp") }
  });
  ...
  async function fetchReport(page = 1) {
    ...
    formData.append("action", "exactmetrics_user_journey_report");
  ...
  async function fetchFilterParams() {
    const formData = new FormData();
    formData.append("action", "exactmetrics_user_journey_report_filter_params");
    formData.append("nonce", getNonce());
    try {
      const response = await fetch(getAjaxUrl(), { method: "POST", body: formData });
      const json = await response.json();
...
const _hoisted_1 = { class: "exactmetrics-navigation-bar" };
const _hoisted_2 = { class: "exactmetrics-container" };
const _hoisted_3 = { class: "exactmetrics-user-journey-navbar" };
const _hoisted_4 = ["textContent"];
const _hoisted_5 = {
  id: "exactmetrics-user-journey-report",
  class: "exactmetrics-user-journey-report"
};
const _hoisted_6 = { class: "exactmetrics-container" };
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-report-top"
};
const _hoisted_8 = ["textContent"];
const _hoisted_9 = { class: "exactmetrics-user-journey-report-filters" };
const _hoisted_10 = { class: "exactmetrics-user-journey-report-filters-left" };
const _hoisted_11 = { class: "exactmetrics-user-journey-report-filters-right" };
const _hoisted_12 = ["placeholder"];
const _hoisted_13 = ["onClick"];
const _hoisted_14 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_15 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_16 = ["href"];
const _hoisted_17 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_18 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_19 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_20 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_21 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_22 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_23 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_24 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_25 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_26 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_27 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_28 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_29 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_30 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_31 = ["innerHTML"];
const _hoisted_32 = { class: "exactmetrics-ujr-table-small-device-content" };
const _hoisted_33 = { class: "exactmetrics-ujr-table-small-device-label" };
const _hoisted_34 = { class: "exactmetrics-ujr-table-small-device-value" };
const _hoisted_35 = {
  key: 2,
  class: "exactmetrics-notice exactmetrics-notice-info"
};
const _hoisted_36 = { class: "exactmetrics-notice-inner" };
const _hoisted_37 = { class: "notice-content" };
const _hoisted_38 = { class: "exactmetrics-notice-content" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const text_heading = __2("User Journey Report", "google-analytics-dashboard-for-wp");
    const text_filter = __2("Filter", "google-analytics-dashboard-for-wp");
    const text_transaction_id = __2("Transaction ID", "google-analytics-dashboard-for-wp");
    const text_search_journeys = __2("Search Journeys", "google-analytics-dashboard-for-wp");
    const text_col_transaction = __2("Transaction ID", "google-analytics-dashboard-for-wp");
    const text_col_purchase_date = __2("Purchase Date", "google-analytics-dashboard-for-wp");
    const text_col_utm_campaign = __2("UTM Campaign", "google-analytics-dashboard-for-wp");
    const text_col_utm_medium = __2("UTM Medium", "google-analytics-dashboard-for-wp");
    const text_col_utm_source = __2("UTM Source", "google-analytics-dashboard-for-wp");
    const text_col_order_total = __2("Order Total", "google-analytics-dashboard-for-wp");
    const text_col_steps = __2("Steps to Purchase", "google-analytics-dashboard-for-wp");
    const text_no_items = __2("No User Journey's matched your filters. Please remove some conditions and try again.", "google-analytics-dashboard-for-wp");
    const text_demo_notice = __2("This is a demo report. The demo report will replaced after the first sale is tracked.", "google-analytics-dashboard-for-wp");
    ...
    const parameters = ref({
      sources: [{ value: "", label: __2("All Sources", "google-analytics-dashboard-for-wp") }],
      mediums: [{ value: "", label: __2("All Mediums", "google-analytics-dashboard-for-wp") }],
      campaigns: [{ value: "", label: __2("All Campaigns", "google-analytics-dashboard-for-wp") }]
    });
    ...
    watch(
      ...
      () => {
        ...
        loadingToast(__2("Searching Journeys", "google-analytics-dashboard-for-wp"));
    ...
    function pageChange(page) {
      loadingToast(__2("Loading Journeys", "google-analytics-dashboard-for-wp"));
        ...
        createBaseVNode("main", _hoisted_5, [
          createBaseVNode("div", _hoisted_6, [
            ...
            createBaseVNode("div", _hoisted_9, [
              ...
              createBaseVNode("div", _hoisted_11, [
                withDirectives(createBaseVNode("input", {
                  ...
                  class: "exactmetrics-search-transaction-id",
            ...
            unref(store).journeyReports.items && unref(store).journeyReports.items.length > 0 ? (openBlock(), createElementBlock("table", {
              key: 1,
              class: normalizeClass(["exactmetrics-user-journey-report-table", { "exactmetrics-ujr-table-small-device": isMobileView.value }])
            }, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store).journeyReports.items, (report, index) => {
                  return openBlock(), createElementBlock("tr", {
                    ...
                    class: normalizeClass({
                      "exactmetrics-ujr-table-small-device-row": isMobileView.value,
                      "exactmetrics-ujr-table-small-device-row-expanded": currentExpandedRow.value === index
                    })
                  }, [
                    createBaseVNode("td", {
                      class: "exactmetrics-ujr-table-small-device-heading",
                    ...
                    createBaseVNode("td", _hoisted_29, [
                      ...
                      createBaseVNode("span", {
                        class: "exactmetrics-ujr-table-small-device-value",
