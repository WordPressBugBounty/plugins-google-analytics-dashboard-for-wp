import { H as createPinia, q as purify, k as getMiGlobal$1 } from "./toastStore-CjmlShHI.js";
...
const getAddonsPageUrl = () => {
  return getMiGlobal("addons_page_url", "/wp-admin/admin.php?page=exactmetrics_settings#/addons");
};
const isAuthed = () => {
