...
const _hoisted_3 = { class: "exactmetrics-report-table-modal__search" };
const _hoisted_4 = ["placeholder"];
const _hoisted_5 = { class: "exactmetrics-report-table-modal__table-wrapper" };
const _hoisted_6 = { class: "exactmetrics-report-table-modal__table-scroll" };
const _hoisted_7 = { class: "exactmetrics-report-table-modal__table" };
const _hoisted_8 = ["onClick"];
const _hoisted_9 = { class: "exactmetrics-report-table-modal__th-content" };
const _hoisted_10 = { class: "exactmetrics-report-table-modal__cell-inner" };
const _hoisted_11 = {
  key: 0,
  class: "exactmetrics-report-table-modal__row-number"
};
const _hoisted_12 = {
  key: 1,
...
const _hoisted_18 = { class: "exactmetrics-report-table-modal__totals-row" };
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const totals = computed(() => {
      ...
      result[firstCol.key] = props.totalLabel || __("Totals", "google-analytics-dashboard-for-wp");
          ...
          createBaseVNode("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_3, [
              ...
              withDirectives(createBaseVNode("input", {
                ...
                placeholder: unref(__)("Search", "google-analytics-dashboard-for-wp")
              }, null, 8, _hoisted_4), [
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(__props.columns, (column) => {
                        return openBlock(), createElementBlock("th", {
                          ...
                          class: normalizeClass([
                            column.headerClass,
                            { "exactmetrics-report-table-modal__th--sortable": column.sortable !== false }
                          ]),
                            ...
                            createBaseVNode("div", _hoisted_10, [
                              ...
                              column.iconKey && item.row[column.iconKey] ? (openBlock(), createElementBlock("div", _hoisted_12, [
                                isUrl(item.row[column.iconKey]) ? (openBlock(), createElementBlock("img", {
                                  ...
                                  class: "exactmetrics-report-table-modal__row-icon-img"
                                ...
                                class: "exactmetrics-report-table-modal__cell-link"
