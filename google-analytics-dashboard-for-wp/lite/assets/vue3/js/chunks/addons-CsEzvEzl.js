...
import { u as unref, o as openBlock, c as createElementBlock, a as createBaseVNode, F as Fragment, f as renderList, i as normalizeClass, s as createCommentVNode, t as toDisplayString, S as Go, j as ref, m as computed, L as reactive, U as useToastStore, k as getMiGlobal, O as getExactMetricsUrl, l as defineStore } from "./toastStore-sH51RcCX.js";
import { q as sanitizeHtml, r as miAjax } from "./ajax-2wfIeviZ.js";
import { _ as _sfc_main$1 } from "./Modal-DdttPho6.js";
const _hoisted_1 = {
  key: 0,
  class: "exactmetrics-notices-area"
};
const _hoisted_2 = { class: "exactmetrics-container" };
const _hoisted_3 = { class: "exactmetrics-notice-inner" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function getNoticeClass(type, id) {
      return `exactmetrics-notice exactmetrics-notice-${type} exactmetrics-${id}`;
    }
    function buttonClass(type) {
      let cls = "exactmetrics-button";
      if (type === "success") {
        cls += " exactmetrics-button-green";
      }
      if (type === "error") {
        cls += " exactmetrics-button-error";
      }
      return cls;
    }
    return (_ctx, _cache) => {
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_3, [
                ...
                createBaseVNode("div", _hoisted_5, [
                  createBaseVNode("div", {
                    class: normalizeClass(notice.icon ? "exactmetrics-flex" : "")
                  }, [
                    notice.icon ? (openBlock(), createElementBlock("div", {
                      key: 0,
                      class: normalizeClass(`exactmetrics-notice-icon exactmetrics-${notice.id || id}-icon`)
                    }, [
                    ...
                    createBaseVNode("div", null, [
                      ...
                      createBaseVNode("span", {
                        class: "exactmetrics-notice-content",
...
function useDialog() {
  ...
  function confirm(opts = {}) {
    return new Promise((resolve) => {
      ...
      openModal({
        ...
        confirmButtonText: opts.confirmText || __$3("Confirm", "google-analytics-dashboard-for-wp"),
        cancelButtonText: opts.cancelText || __$3("Cancel", "google-analytics-dashboard-for-wp"),
        clickToClose: false,
        escToClose: false,
        onConfirm: () => done(true),
        onCancel: () => done(false),
  ...
  function alert(opts = {}) {
    ...
    return new Promise((resolve) => {
      ...
      openModal({
        ...
        message: opts.message || "",
        html: opts.html || "",
        confirmButtonText: opts.confirmText || __$3("OK", "google-analytics-dashboard-for-wp"),
        clickToClose: true,
        escToClose: true,
        onConfirm: done,
        onClosed: done
  ...
  function loading(opts = {}) {
    const controller = openModal({
      type: "loading",
      title: opts.title || __$3("Loading…", "google-analytics-dashboard-for-wp"),
      message: opts.message || "",
      clickToClose: false,
      escToClose: false
    });
...
function useToast() {
  ...
  function successToast(settings = {}) {
    if (savingToastId) {
      ...
      return add({
        type: "success",
        title: settings.title || __$2("Settings Updated", "google-analytics-dashboard-for-wp"),
        message: settings.text || "",
  ...
  function errorToast(settings = {}) {
    ...
    return add({
      type: "error",
      title: settings.title || __$2("Could Not Save Changes", "google-analytics-dashboard-for-wp"),
  ...
  function loadingToast(title) {
    ...
    loaderController = dialog.loading({
      title: title || __$2("Loading Settings", "google-analytics-dashboard-for-wp")
    });
  }
  function closeToast() {
    clearSaving();
...
const fetchAddons = async () => {
  return await miAjax("exactmetrics_vue_get_addons", {
...
const installAddon = async (addonUrl, ftpData = null) => {
  ...
  return await miAjax("exactmetrics_install_addon", data);
};
const installWPForms = async () => {
  return await miAjax("exactmetrics_onboarding_wpforms_install", {
    nonce: getMiGlobal("install_nonce", "")
  });
};
const activateAddon = async (addon) => {
  ...
  try {
    ...
    throw {
      title: __$1("Addon Activation Error", "exactmetrics"),
      message: response.error || response.message || __$1("Activation failed", "exactmetrics")
    };
  } catch (error) {
    if (error?.title) {
      throw error;
    ...
    throw {
      title: __$1("Addon activation failed", "exactmetrics"),
      message: error?.message || __$1("AJAX request failed", "exactmetrics"),
      support_url
    };
  }
};
const deactivateAddon = async (addon) => {
  const plugin = typeof addon === "string" ? addon : addon?.basename || "";
  try {
    const response = await miAjax("exactmetrics_deactivate_addon", {
    ...
    throw {
      title: __$1("Addon Deactivation Error", "exactmetrics"),
      message: response.error || response.message || __$1("Deactivation failed", "exactmetrics")
    };
  } catch (error) {
    if (error?.title) {
      throw error;
    ...
    throw {
      title: __$1("Addon deactivation failed", "exactmetrics"),
      message: error?.message || __$1("AJAX request failed", "exactmetrics")
    };
  }
};
const installPlugin = async (pluginSlug) => {
  return await miAjax("exactmetrics_vue_install_plugin", {
    slug: pluginSlug
  });
};
...
const activateUserFeedback = async () => {
  return await miAjax("exactmetrics_activate_addon", {
    nonce: getMiGlobal("activate_nonce"),
  ...
  actions: {
    ...
    addAddonNoticesAction() {
      ...
      if (this.isAddonActive("amp") && !this.isAddonActive("google_amp")) {
        ...
        const installActivateText = typeof installUrl === "string" && installUrl.indexOf("activate") > 0 ? __("Activate", "google-analytics-dashboard-for-wp") : __("Install", "google-analytics-dashboard-for-wp");
        const learnMoreLink = `<a target="_blank" rel="noopener noreferrer" href="${getExactMetricsUrl(
          "settings-panel",
          "amp-plugin-notice",
          "https://www.exactmetrics.com/docs/how-to-get-started-with-the-google-amp-addon/"
        )}">`;
        let content;
        if (getMiGlobal("install_plugins", false)) {
          content = sprintf(
            ...
            __(
              "In order for the ExactMetrics Google AMP addon to work properly, you need to install the WordPress AMP plugin by Automattic. %1$s%2$s Plugin%3$s | %4$sLearn More%5$s",
              "google-analytics-dashboard-for-wp"
            ),
            `<a href="${installUrl}">`,
            installActivateText,
          ...
          content = sprintf(
            ...
            __(
              "In order for the ExactMetrics Google AMP addon to work properly, please ask your webmaster to install the WordPress AMP plugin by Automattic. %1$sLearn More%2$s",
              "google-analytics-dashboard-for-wp"
            ),
            learnMoreLink,
            "</a>"
    ...
    /**
     * Install an addon by url (ExactMetrics addon download URL).
