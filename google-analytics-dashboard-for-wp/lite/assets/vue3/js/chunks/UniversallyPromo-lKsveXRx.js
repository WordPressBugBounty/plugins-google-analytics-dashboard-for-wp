import { o as openBlock, c as createElementBlock, a as createBaseVNode, s as createCommentVNode, t as toDisplayString, A as createTextVNode, u as unref, i as normalizeClass, m as computed, j as ref, k as getMiGlobal } from "./toastStore-CjmlShHI.js";
import { c as useAddonsStore } from "./addons-DcCBQDEz.js";
import { _ as __ } from "./default-i18n-KrIlCc2E.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
const _hoisted_1 = { class: "exactmetrics-universally-promo__text" };
const _hoisted_2 = {
  key: 0,
  class: "exactmetrics-universally-promo__info"
};
const _hoisted_3 = {
  key: 1,
  class: "exactmetrics-universally-promo__lead"
};
const _hoisted_4 = ["disabled"];
const _hoisted_5 = {
  key: 3,
  class: "exactmetrics-universally-promo__done"
};
...
const _sfc_main = {
  ...
  props: {
    ...
    lead: {
      type: String,
      default: () => __("Pro Tip:", "google-analytics-dashboard-for-wp")
    },
    // Text of the install link.
    linkText: {
      type: String,
      default: () => __("Install Now", "google-analytics-dashboard-for-wp")
    },
  ...
  setup(__props) {
    ...
    function dismiss() {
      ...
      if (window.wp && window.wp.ajax) {
        window.wp.ajax.post("exactmetrics_vue_dismiss_promo", {
    ...
    return (_ctx, _cache) => {
      return shouldShow.value ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass(["exactmetrics-universally-promo", { "exactmetrics-universally-promo--bare": __props.bare }])
      }, [
        createBaseVNode("span", _hoisted_1, [
          ...
          !installed.value ? (openBlock(), createElementBlock("button", {
            key: 2,
            type: "button",
            class: "exactmetrics-universally-promo__link",
            disabled: installing.value,
            onClick: handleInstall
          }, toDisplayString(installing.value ? unref(__)("Installing…", "google-analytics-dashboard-for-wp") : __props.linkText), 9, _hoisted_4)) : (openBlock(), createElementBlock("span", _hoisted_5, toDisplayString(unref(__)("Installed", "google-analytics-dashboard-for-wp")), 1))
        ]),
        __props.dismissible ? (openBlock(), createElementBlock("button", {
          key: 0,
          type: "button",
          class: "exactmetrics-universally-promo__dismiss",
          "aria-label": unref(__)("Dismiss this recommendation", "google-analytics-dashboard-for-wp"),
          onClick: dismiss
        }, [..._cache[1] || (_cache[1] = [
          createBaseVNode("svg", {
            width: "12",
...
const UniversallyPromo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0319b8c9"]]);
export {
