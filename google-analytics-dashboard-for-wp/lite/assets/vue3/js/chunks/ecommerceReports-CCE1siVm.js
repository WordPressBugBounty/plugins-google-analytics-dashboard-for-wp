import { F as isSampleDataEnabled, A as applyFiltersToQuery, B as relayReportingQuery, E as relayFallbackFetch } from "../reports-BxDiWuLl.js";
...
async function fetchEcommerceOverviewReportData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading eCommerce overview data", "google-analytics-dashboard-for-wp");
...
async function fetchEcommerceCouponsData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading coupons data", "google-analytics-dashboard-for-wp");
...
async function fetchCartAbandonmentData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading cart abandonment data", "google-analytics-dashboard-for-wp");
...
async function fetchSpendByDayData(dateRange, apiFilters = null) {
  ...
  const queries = [query];
  const errorLabel = __("Error loading spend by day data", "google-analytics-dashboard-for-wp");
  return fetchCachedReportSection({
    cacheGroup: "ecommerce",
...
async function fetchSpendByHourData(dateRange, apiFilters = null) {
  ...
  const queries = [query];
  const errorLabel = __("Error loading spend by hour data", "google-analytics-dashboard-for-wp");
  return fetchCachedReportSection({
    cacheGroup: "ecommerce",
...
async function fetchRefundsData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading refunds data", "google-analytics-dashboard-for-wp");
...
async function fetchPurchasesByLocationData(dateRange, apiFilters = null, breakdown = "country") {
  ...
  const errorLabel = __("Error loading purchases by location data", "google-analytics-dashboard-for-wp");
  const prevBody = isCompareActive(dateRange) ? buildRequestBody(dateRange.compareStart, dateRange.compareEnd, queries, null) : null;
  return fetchCachedReportSection({
    cacheGroup: "ecommerce",
...
async function fetchRefundsByGeoData(dateRange, apiFilters = null, breakdown = "country") {
  ...
  const errorLabel = __("Error loading refunds by geo data", "google-analytics-dashboard-for-wp");
  const prevBody = isCompareActive(dateRange) ? buildRequestBody(dateRange.compareStart, dateRange.compareEnd, queries, null) : null;
  return fetchCachedReportSection({
    cacheGroup: "ecommerce",
