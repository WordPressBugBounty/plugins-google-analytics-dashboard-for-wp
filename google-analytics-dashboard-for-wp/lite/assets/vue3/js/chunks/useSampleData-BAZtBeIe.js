...
import { o as openBlock, E as createBlock, D as withCtx, a as createBaseVNode, c as createElementBlock, t as toDisplayString, s as createCommentVNode, u as unref, b as createVNode, i as normalizeClass, F as Fragment, f as renderList, n as normalizeStyle, m as computed, az as getUpgradeUrl, k as getMiGlobal, j as ref } from "./toastStore-sH51RcCX.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { u as getSampleData } from "./ajax-2wfIeviZ.js";
const _hoisted_1 = { class: "exactmetrics-upsell-overlay" };
const _hoisted_2 = { class: "exactmetrics-upsell-modal" };
const _hoisted_3 = { class: "exactmetrics-upsell-top" };
const _hoisted_4 = ["textContent"];
const _hoisted_5 = ["aria-label"];
const _hoisted_6 = { class: "exactmetrics-upsell-content" };
const _hoisted_7 = { class: "exactmetrics-upsell-content__features" };
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const footerNotice = computed(() => {
      ...
      return sprintf(
        __("Upgrade to %1$s to unlock deeper insights, advanced tracking, and powerful integrations so you never miss what's driving results. %2$sLearn more about %1$s%3$s", "google-analytics-dashboard-for-wp"),
        upgradeLevel,
        `<a target="_blank" href="${getUpgradeLink()}" class="exactmetrics-upsell-learn-more">`,
        "</a>"
      );
    });
              ...
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("div", _hoisted_7, [
                  ...
                  createBaseVNode("div", _hoisted_12, [
                    ...
                    }, toDisplayString(unref(__)("See a Demo", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
                  ])
                ]),
