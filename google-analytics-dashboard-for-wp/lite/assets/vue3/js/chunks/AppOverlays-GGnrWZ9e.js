import { R as zo, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, s as createCommentVNode, u as unref, i as normalizeClass, m as computed, q as purify, E as createBlock, b as createVNode, D as withCtx, F as Fragment, f as renderList, a6 as TransitionGroup, Q as Teleport, U as useToastStore, L as reactive, a7 as Wo } from "./toastStore-CjmlShHI.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
function installOverlays(app) {
  app.use(zo());
}
const _hoisted_1$2 = {
  class: "exactmetrics-toast__icon",
  "aria-hidden": "true"
};
const _hoisted_2$1 = {
  key: 0,
...
const _hoisted_5 = {
  key: 3,
  class: "exactmetrics-toast__spinner"
};
const _hoisted_6 = {
  key: 4,
  viewBox: "0 0 20 20"
};
const _hoisted_7 = { class: "exactmetrics-toast__body" };
const _hoisted_8 = {
  key: 0,
  class: "exactmetrics-toast__title"
};
const _hoisted_9 = ["innerHTML"];
const _hoisted_10 = {
  key: 2,
  class: "exactmetrics-toast__message"
};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    const { __ } = wp.i18n;
    const props = __props;
    const closeLabel = __("Dismiss", "google-analytics-dashboard-for-wp");
    const safeHtml = computed(
      () => props.toast.html ? purify.sanitize(String(props.toast.html)) : ""
    );
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-toast", `exactmetrics-toast--${__props.toast.type}`]),
        role: "status"
      }, [
        ...
        __props.toast.dismissible ? (openBlock(), createElementBlock("button", {
          key: 0,
          type: "button",
          class: "exactmetrics-toast__close",
...
const _hoisted_1$1 = {
  class: "exactmetrics-toast-region",
  "aria-live": "polite",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        createBaseVNode("div", _hoisted_1$1, [
          createVNode(TransitionGroup, { name: "exactmetrics-toast" }, {
            default: withCtx(() => [
...
const _hoisted_1 = {
  key: 0,
  class: "exactmetrics-alert-stack"
};
const _hoisted_2 = { class: "exactmetrics-alert__message" };
    ...
    return (_ctx, _cache) => {
      return alerts.value.length ? (openBlock(), createElementBlock("div", _hoisted_1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(alerts.value, (alert) => {
          return openBlock(), createElementBlock("div", {
            key: alert.id,
            class: normalizeClass(["exactmetrics-alert", `exactmetrics-alert--${alert.type}`]),
            role: "alert"
          }, [
            ...
            alert.dismissible ? (openBlock(), createElementBlock("button", {
              key: 0,
              type: "button",
              class: "exactmetrics-alert__close",
              "aria-label": unref(closeLabel),
