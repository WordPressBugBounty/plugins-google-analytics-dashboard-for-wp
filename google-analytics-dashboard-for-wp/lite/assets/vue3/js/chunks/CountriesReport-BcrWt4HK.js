import { o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, w as withDirectives, v as vModelText, s as createCommentVNode, i as normalizeClass, u as unref, F as Fragment, f as renderList, b as createVNode, n as normalizeStyle, j as ref, m as computed, a1 as storeToRefs, E as createBlock, D as withCtx } from "./toastStore-nTGs-rGm.js";
import { _ as __$1 } from "./default-i18n-KrIlCc2E.js";
import { B as applyFiltersToQuery, E as relayReportingQuery, F as relayFallbackFetch, u as useOverviewReportStore, b as buildApiFilters } from "../reports-B_hJZd5_.js";
...
import { f as formatPct, a as formatCurr, b as formatNum } from "./overviewTableFormatters-WylMWTgV.js";
...
async function fetchCountriesReportData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading country report data", "google-analytics-dashboard-for-wp");
...
const _hoisted_1 = { class: "exactmetrics-overview-report-table exactmetrics-countries-expandable-table" };
const _hoisted_2 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_3 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_4 = {
  key: 0,
  class: "exactmetrics-overview-report-table__header-right"
};
const _hoisted_5 = ["placeholder"];
const _hoisted_6 = { class: "exactmetrics-overview-report-table__table-wrapper" };
const _hoisted_7 = { key: 0 };
const _hoisted_8 = {
  rowspan: "2",
  class: "exactmetrics-countries-expandable-table__country-col"
};
const _hoisted_9 = { class: "exactmetrics-overview-report-table__compare-dates-row" };
const _hoisted_10 = { key: 1 };
const _hoisted_11 = { class: "exactmetrics-countries-expandable-table__country-col" };
const _hoisted_12 = {
  key: 0,
...
const _hoisted_16 = { class: "exactmetrics-countries-expandable-table__label-cell" };
const _hoisted_17 = { class: "exactmetrics-overview-report-table__cell-inner" };
const _hoisted_18 = { class: "exactmetrics-overview-report-table__row-number" };
const _hoisted_19 = { class: "exactmetrics-countries-expandable-table__name" };
const _hoisted_20 = ["aria-expanded", "onClick"];
const _hoisted_21 = { class: "exactmetrics-overview-report-table__cell-compare" };
const _hoisted_22 = { class: "exactmetrics-countries-expandable-table__label-cell" };
const _hoisted_23 = { class: "exactmetrics-countries-expandable-table__name exactmetrics-countries-expandable-table__name--region" };
const _hoisted_24 = { class: "exactmetrics-overview-report-table__cell-compare" };
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const metricColumnDefs = [
      ...
      { key: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp") },
      { key: "bouncePercent", label: __$1("Bounce rate", "google-analytics-dashboard-for-wp") },
      ...
      { key: "averageOrderValue", label: __$1("Average Order Value", "google-analytics-dashboard-for-wp") }
    ];
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          ...
          __props.searchable ? (openBlock(), createElementBlock("div", _hoisted_4, [
            withDirectives(createBaseVNode("input", {
              ...
              type: "search",
              class: "exactmetrics-overview-report-table__search",
        ...
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("table", {
            class: normalizeClass(["exactmetrics-overview-report-table__table", { "exactmetrics-overview-report-table__table--compare": __props.hasCompare }])
          }, [
            __props.hasCompare ? (openBlock(), createElementBlock("thead", _hoisted_7, [
              createBaseVNode("tr", null, [
                createBaseVNode("th", _hoisted_8, toDisplayString(unref(__$1)("Country / Region", "google-analytics-dashboard-for-wp")), 1),
              ...
              createBaseVNode("tr", null, [
                createBaseVNode("th", _hoisted_11, toDisplayString(unref(__$1)("Country / Region", "google-analytics-dashboard-for-wp")), 1),
                (openBlock(), createElementBlock(Fragment, null, renderList(metricColumnDefs, (col) => {
                  return createBaseVNode("th", {
                    key: col.key
                  }, toDisplayString(col.label), 1);
            ...
            createBaseVNode("tbody", null, [
              __props.loading ? (openBlock(), createElementBlock("tr", _hoisted_12, [
                ...
                }, toDisplayString(__props.emptyMessage || unref(__$1)("No data available", "google-analytics-dashboard-for-wp")), 9, _hoisted_15)
                ...
                return openBlock(), createElementBlock(Fragment, {
                    ...
                    createBaseVNode("td", _hoisted_16, [
                      createBaseVNode("div", _hoisted_17, [
                        ...
                        country.regions && country.regions.length > 0 ? (openBlock(), createElementBlock("button", {
                          key: 0,
                          type: "button",
                          class: normalizeClass(["exactmetrics-countries-expandable-table__toggle", { "is-expanded": isExpanded(country.iso) }]),
                  ...
                  country.regions && country.regions.length && isExpanded(country.iso) ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(country.regions, (reg) => {
                    return openBlock(), createElementBlock("tr", {
                      ...
                      class: "exactmetrics-countries-expandable-table__region-row"
                    }, [
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(PublisherCountriesExpandableTable, {
            title: unref(__$1)("Country Report", "google-analytics-dashboard-for-wp"),
            countries: countriesWithLabels.value,
            "has-compare": isCompareActive2.value,
            "compare-date-labels": compareDateLabelsForTable.value,
            loading: unref(loading),
            searchable: "",
            "search-placeholder": unref(__$1)("Search countries or regions…", "google-analytics-dashboard-for-wp"),
            "empty-message": unref(__$1)("No country data for this period.", "google-analytics-dashboard-for-wp")
