import { k as getMiGlobal, o as openBlock, c as createElementBlock, n as normalizeStyle, i as normalizeClass, s as createCommentVNode, m as computed } from "./toastStore-CjmlShHI.js";
...
function useIcon() {
  ...
  function getTemplateIcon(templateName) {
    return getIcon(
      `templates/${"exactmetrics"}/${templateName}.svg`
    );
  }
  return {
    getIcon,
