import { a3 as useSlots, C as watch, y as onMounted, o as openBlock, c as createElementBlock, a as createBaseVNode, i as normalizeClass, w as withDirectives, aF as vModelCheckbox, s as createCommentVNode, K as renderSlot, E as createBlock, G as withKeys, B as withModifiers, b as createVNode, D as withCtx, m as computed, j as ref } from "./toastStore-nTGs-rGm.js";
...
const _hoisted_8 = { class: "exactmetrics-collapsible-content" };
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const componentClass = computed(() => {
      let cls = "exactmetrics-settings-input-checkbox";
    ...
    const labelClass = computed(() => {
      ...
      if (checked.value) cls += " exactmetrics-styled-checkbox-checked";
      return cls;
    });
    ...
    function stopClick(e) {
      if (!e.target.classList.contains("exactmetrics-styled-checkbox") && !e.target.classList.contains("exactmetrics-checkbox-label")) {
        toggleCollapsible(e);
        e.stopPropagation();
      } else {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("label", {
          class: normalizeClass(disabled.value ? "exactmetrics-styled-checkbox-faux" : ""),
          ...
          __props.description ? (openBlock(), createElementBlock("span", {
            key: 2,
            class: "exactmetrics-checkbox-description",
