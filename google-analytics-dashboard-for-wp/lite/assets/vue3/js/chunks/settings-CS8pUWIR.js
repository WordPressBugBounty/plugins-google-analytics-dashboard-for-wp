import { O as getExactMetricsUrl, Z as isPro, l as defineStore, j as ref, m as computed } from "./toastStore-nTGs-rGm.js";
import { r as miAjax } from "./ajax-BSXoXmkG.js";
const { __: __$1 } = wp.i18n;
const fetchSettings = async () => {
  try {
    return await miAjax("exactmetrics_vue_get_settings");
  } catch (error) {
    ...
    throw {
      title: __$1("Error Loading Settings", "google-analytics-dashboard-for-wp"),
      message: error?.message || __$1("You appear to be offline. Please check your connection.", "google-analytics-dashboard-for-wp"),
      support_url
    };
  }
};
const saveSettings = async (setting) => {
  ...
  try {
    await miAjax("exactmetrics_vue_update_settings", data);
    return true;
  } catch (error) {
    const support_url = getExactMetricsUrl(
      "admin-notices",
    ...
    throw {
      title: __$1("Error Saving Settings", "google-analytics-dashboard-for-wp"),
      message: error?.message || __$1("Could not save settings.", "google-analytics-dashboard-for-wp"),
      support_url
    };
  }
};
const saveBulkSettings = async (settings) => {
  try {
    return await miAjax("exactmetrics_vue_update_settings_bulk", {
...
const fetchLocalGtagRemote = async () => {
  try {
    return await miAjax("exactmetrics_vue_get_local_gtag_js_from_remote");
  } catch (error) {
    throw {
      title: __$1("Error Fetching Remote Gtag", "google-analytics-dashboard-for-wp"),
...
const updateIncludedMetrics = async (metrics) => {
  try {
    return await miAjax("exactmetrics_vue_update_included_metrics", {
      selected_metrics: metrics.selected_metrics
    });
  } catch (error) {
    throw {
      title: __$1("Error Updating Metrics", "google-analytics-dashboard-for-wp"),
      message: error?.message || error
    };
  }
};
...
const fetchIncludedMetrics = async () => {
  try {
    const response = await miAjax("exactmetrics_vue_get_user_included_metrics");
    if (response?.success) {
      if (false === isPro()) {
    ...
    throw {
      title: __$1("Error Fetching Metrics", "google-analytics-dashboard-for-wp"),
      message: error?.message || __$1("Could not fetch metrics.", "google-analytics-dashboard-for-wp"),
      support_url
    };
  }
};
...
const useSettingsStore = defineStore("settings", () => {
  ...
  const includedMetrics = ref([
    {
      id: "sessions",
      name: __("Sessions", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "pageviews",
      name: __("Page Views", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "totalusers",
      name: __("Total Users", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "pageviews_per_user",
      name: __("Page Views/User", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "average_session_duration",
      name: __("Session Duration", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "bounce_rate",
      name: __("Bounce Rate", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "revenue_sales",
      name: __("Revenue/Sales", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: true
    },
    {
      id: "average_revenue_per_user",
      name: __("Average revenue per user", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: true
    },
    {
      id: "average_revenue_per_session",
      name: __("Average revenue per session", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: true
    },
    {
      id: "new_users",
      name: __("New Users", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "ecommerce_purchases",
      name: __("ECommerce Purchases", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: true
    },
    {
      id: "engagement_rate",
      name: __("Engagement Rate", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    },
    {
      id: "sessions_per_user",
      name: __("Sessions per user", "google-analytics-dashboard-for-wp"),
      checked: false,
      isPro: false
    }
  ]);
  ...
  async function fetchSettingsAction() {
    try {
      ...
      if (data) {
        ...
        const errorDetails = {
          title: __("Fetch Settings Error", "google-analytics-dashboard-for-wp"),
          message: __(
      ...
      const errorDetails = {
        title: error.title || __("Fetch Settings Error", "google-analytics-dashboard-for-wp"),
  ...
  async function fetchUserIncludedMetricsAction() {
    try {
      ...
      if (typeof response === "string") {
        ...
        const errorDetails = {
          title: __("Fetch Metrics Error", "google-analytics-dashboard-for-wp"),
          message: __(
      ...
      const errorDetails = {
        title: error.title || __("Fetch Metrics Error", "google-analytics-dashboard-for-wp"),
        message: error.message,
        support_url: error.support_url
      };
      throw errorDetails;
