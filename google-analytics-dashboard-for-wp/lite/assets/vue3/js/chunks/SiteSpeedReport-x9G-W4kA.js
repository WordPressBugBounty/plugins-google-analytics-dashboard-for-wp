...
import { G as rejectReport, F as relayFallbackFetch, H as createRequestQueue, A as isSampleDataEnabled, _ as _sfc_main$1 } from "../reports-CaiFcwwu.js";
import { u as useReportPermissions } from "./useReportPermissions-BGwVQAy9.js";
import { k as getMiGlobal, j as ref, y as onMounted, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, u as unref, i as normalizeClass, b as createVNode, E as createBlock, D as withCtx, s as createCommentVNode, F as Fragment, n as normalizeStyle, f as renderList, m as computed } from "./toastStore-sH51RcCX.js";
import { e as ensureBearerToken, c as guardReportingConnection, q as sanitizeHtml } from "./ajax-2wfIeviZ.js";
...
async function fetchSiteSpeedData(strategy = "desktop", force = false) {
  const errorLabel = __("Error loading site speed report data", "google-analytics-dashboard-for-wp");
...
const _hoisted_1 = { class: "exactmetrics-site-speed-header" };
const _hoisted_2 = { class: "exactmetrics-site-speed-header__left" };
const _hoisted_3 = { class: "exactmetrics-site-speed-header__title" };
const _hoisted_4 = { class: "exactmetrics-device-toggle" };
const _hoisted_5 = { class: "exactmetrics-site-speed-header__right" };
const _hoisted_6 = ["disabled"];
const _hoisted_7 = { key: 1 };
const _hoisted_8 = { class: "exactmetrics-site-speed-report" };
const _hoisted_9 = {
  key: 0,
  class: "exactmetrics-site-speed-empty"
};
const _hoisted_10 = { class: "exactmetrics-site-speed-empty__title" };
const _hoisted_11 = { class: "exactmetrics-site-speed-empty__text" };
const _hoisted_12 = {
  key: 1,
  class: "exactmetrics-site-speed-loading"
};
const _hoisted_13 = { class: "exactmetrics-site-speed-main" };
const _hoisted_14 = { class: "exactmetrics-site-speed-gauge" };
const _hoisted_15 = { class: "exactmetrics-speed-indicator" };
const _hoisted_16 = { class: "exactmetrics-speed-indicator__device-icon" };
const _hoisted_17 = {
  key: 0,
  width: "35",
  height: "56",
...
const _hoisted_19 = { class: "exactmetrics-speed-indicator__label" };
const _hoisted_20 = {
  class: "exactmetrics-speed-indicator__ring",
  viewBox: "-4 -4 114 114",
  xmlns: "http://www.w3.org/2000/svg"
};
const _hoisted_21 = ["stroke", "stroke-dasharray"];
const _hoisted_22 = { class: "exactmetrics-site-speed-metrics" };
const _hoisted_23 = {
  key: 0,
  width: "20",
  height: "20",
...
const _hoisted_26 = { class: "exactmetrics-site-speed-metric__value" };
const _hoisted_27 = { class: "exactmetrics-site-speed-metric__label" };
const _hoisted_28 = {
  key: 0,
  class: "exactmetrics-site-speed-accordion"
};
const _hoisted_29 = { class: "exactmetrics-site-speed-accordion__title" };
...
const _hoisted_34 = { class: "exactmetrics-site-speed-accordion__header-text" };
const _hoisted_35 = ["innerHTML"];
const STORAGE_KEY = "exactmetrics_sitespeed_current_device";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const METRIC_DEFS = [
      { key: "total-blocking-time", label: __$1("Total Blocking Time", "google-analytics-dashboard-for-wp") },
      { key: "cumulative-layout-shift", label: __$1("Cumulative Layout Shift", "google-analytics-dashboard-for-wp") },
      { key: "largest-contentful-paint", label: __$1("Largest Contentful Paint", "google-analytics-dashboard-for-wp") },
      { key: "server-response-time", label: __$1("Server Response Time", "google-analytics-dashboard-for-wp") },
      { key: "first-contentful-paint", label: __$1("First Contentful Paint", "google-analytics-dashboard-for-wp") },
      { key: "interaction-to-next-paint", label: __$1("Interaction to Next Paint", "google-analytics-dashboard-for-wp") }
    ];
    ...
    function buildAccordionContent() {
      ...
      if (data["cumulative-layout-shift"]) {
        ...
        items.push({
          ...
          title: sprintf(__$1("Cumulative Layout Shift - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            ...
            __$1("Cumulative Layout Shift is a measure of the largest burst of layout shift scores for every unexpected layout shift that occurs during the lifespan of a page. A layout shift occurs any time a visible element changes its position from one rendered frame to the next.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for 0.1 or less.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            __$1("A common reason for unexpected layout shifts is images without specified dimensions or reserved space for their aspect ratio. This can also be the case for ads, embeds, or any other late-loaded content.", "google-analytics-dashboard-for-wp"),
            ...
            __$1("Downloading and rendering web fonts can cause layout shifts. If you are using custom fonts we recommend reading", "google-analytics-dashboard-for-wp"),
            __$1("this article", "google-analytics-dashboard-for-wp")
          )
        });
      }
      if (data["largest-contentful-paint"]) {
        ...
        items.push({
          ...
          score: d.score,
          icon: getStatIcon(d.score),
          title: sprintf(__$1("Largest Contentful Paint - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            "<p>%1$s</p><p><strong>%2$s </strong>%3$s</p><h2>%4$s</h2><p>%5$s</p><p>%6$s</p>",
            __$1("Largest Contentful Paint reports the render time of the largest image or text block visible in the viewport, relative to when the user first navigated to the page.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for 2.5 seconds or less.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            __$1("A number of factors can affect how quickly the browser can load and render a web page(including Time to first byte), and delays across any of them can have a significant impact on Largest Contentful Paint.", "google-analytics-dashboard-for-wp"),
            __$1("To improve Largest Contentful Paint you have to look at the entire loading process and make sure every step along the way is optimized and there are no delays for resources.", "google-analytics-dashboard-for-wp")
          )
        });
      }
      if (data["server-response-time"]) {
        ...
        items.push({
          ...
          score: d.score,
          icon: getStatIcon(d.score),
          title: sprintf(__$1("Server Response Time - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            ...
            __$1("Server Response Time is the time it takes to connect to the website server to the time it takes the server to process your request and start returning data to load the website.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for 600ms or less server response time.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            ...
            __$1("We also have a great roundup of the best ways to improve your website's performance that can be found", "google-analytics-dashboard-for-wp"),
            __$1("here", "google-analytics-dashboard-for-wp")
          )
        });
      }
      if (data["first-contentful-paint"]) {
        ...
        items.push({
          ...
          score: d.score,
          icon: getStatIcon(d.score),
          title: sprintf(__$1("First Contentful Paint - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            ...
            __$1("First Contentful Paint looks at the time it takes for the first visible element on your page to be rendered, like images and fonts.", "google-analytics-dashboard-for-wp"),
            __$1("The score you get is based on a comparison of your page's first contentful paint with other live websites.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for a time of 1.5 seconds or less.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            __$1("The most common reason causing issues with the First Contentful Paint is using custom fonts that get rendered too slow as they have to load first. If you are using custom fonts, we recommend reading", "google-analytics-dashboard-for-wp"),
            __$1("this article", "google-analytics-dashboard-for-wp"),
            __$1("Another way to improve First Contentful Paint is to make sure the images on your site are optimized to load as fast as possible. For tips on how to speed up image loading time, check out", "google-analytics-dashboard-for-wp"),
            __$1("this helpful guide", "google-analytics-dashboard-for-wp")
          )
        });
      }
      if (data["total-blocking-time"]) {
        ...
        items.push({
          ...
          score: d.score,
          icon: getStatIcon(d.score),
          title: sprintf(__$1("Total Blocking Time - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            ...
            __$1("Total Blocking time is a measurement of the time it takes until your website visitor can interact with your website. When your page first loads it takes a moment before you can click/tap or scroll the page.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for a Total Blocking Time of 300ms or less.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            __$1("The most common reason for a long blocking time is JavaScript code that is either not efficient or is too large. A quick way to improve that is to use an efficient caching plugin that will improve the way scripts are loaded on your page. For an easy way to improve your Total Blocking Time, check out", "google-analytics-dashboard-for-wp"),
            __$1("this summary", "google-analytics-dashboard-for-wp")
          )
        });
      }
      if (data["interaction-to-next-paint"]) {
        ...
        items.push({
          ...
          score: d.score,
          icon: getStatIcon(d.score),
          title: sprintf(__$1("Interaction to Next Paint - %s", "google-analytics-dashboard-for-wp"), d.value),
          details: sprintf(
            ...
            __$1("Interaction to Next Paint looks at the time it takes for the next paint after the user interacts with the page.", "google-analytics-dashboard-for-wp"),
            __$1("The score you get is based on a comparison of your page's interaction to next paint with other live websites.", "google-analytics-dashboard-for-wp"),
            __$1("Goal:", "google-analytics-dashboard-for-wp"),
            __$1("You should be aiming for a time of 1.5 seconds or less.", "google-analytics-dashboard-for-wp"),
            __$1("How to Improve", "google-analytics-dashboard-for-wp"),
            __$1("Ideally, you should diagnose and find slow user interactions in the field to optimize them.", "google-analytics-dashboard-for-wp"),
            __$1("It takes time and effort to improve INP, but the reward is a better user experience. That's why we recommend to learn more about", "google-analytics-dashboard-for-wp"),
            __$1("Interaction to Next Paint ", "google-analytics-dashboard-for-wp")
          )
        });
      }
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("h2", _hoisted_3, toDisplayString(unref(__$1)("Site Speed", "google-analytics-dashboard-for-wp")), 1),
            createBaseVNode("div", _hoisted_4, [
              createBaseVNode("button", {
                class: normalizeClass(["exactmetrics-device-toggle__btn", { "exactmetrics-device-toggle__btn--active": strategy.value === "mobile" }]),
              ...
              createBaseVNode("button", {
                class: normalizeClass(["exactmetrics-device-toggle__btn", { "exactmetrics-device-toggle__btn--active": strategy.value === "desktop" }]),
          ...
          createBaseVNode("div", _hoisted_5, [
            ...
            createBaseVNode("button", {
              class: "exactmetrics-run-audit-btn",
              disabled: isAuditing.value,
              onClick: runAudit
            }, [
              isAuditing.value ? (openBlock(), createBlock(LoadingSpinnerInline, { key: 0 })) : (openBlock(), createElementBlock("span", _hoisted_7, toDisplayString(unref(__$1)("Run Audit", "google-analytics-dashboard-for-wp")), 1))
            ], 8, _hoisted_6)
          ])
        ]),
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_8, [
              !siteSpeedData.value && !isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_9, [
                _cache[4] || (_cache[4] = createBaseVNode("div", { class: "exactmetrics-site-speed-empty__icon" }, [
                  createBaseVNode("svg", {
                    width: "64",
                    height: "64",
                    viewBox: "0 0 64 64",
                ...
                createBaseVNode("h3", _hoisted_10, toDisplayString(unref(__$1)('Click "Run Audit" to check your site speed', "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("p", _hoisted_11, toDisplayString(unref(__$1)("Run a PageSpeed Insights audit to see your performance score, core web vitals, and tips to improve your site speed.", "google-analytics-dashboard-for-wp")), 1)
              ])) : createCommentVNode("", true),
              isLoading.value && !siteSpeedData.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
                createVNode(LoadingSpinnerInline),
                createBaseVNode("span", null, toDisplayString(unref(__$1)("Running site speed audit...", "google-analytics-dashboard-for-wp")), 1)
              ])) : createCommentVNode("", true),
              siteSpeedData.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                createBaseVNode("div", _hoisted_13, [
                  createBaseVNode("div", _hoisted_14, [
                    createBaseVNode("div", _hoisted_15, [
                      ...
                      createBaseVNode("div", {
                        class: "exactmetrics-speed-indicator__score",
                        style: normalizeStyle({ color: scoreColor.value })
                      }, toDisplayString(formattedScore.value), 5),
                      createBaseVNode("div", _hoisted_19, toDisplayString(unref(__$1)("Overall Score", "google-analytics-dashboard-for-wp")), 1),
                  ...
                  createBaseVNode("div", _hoisted_22, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(metricCards.value, (metric) => {
                      return openBlock(), createElementBlock("div", {
                        key: metric.key,
                        class: "exactmetrics-site-speed-metric"
                      }, [
                        createBaseVNode("span", {
                          class: normalizeClass(["exactmetrics-site-speed-metric__icon", "exactmetrics-site-speed-metric__icon--" + metric.icon])
                        }, [
                ...
                accordionItems.value.length ? (openBlock(), createElementBlock("div", _hoisted_28, [
                  createBaseVNode("h2", _hoisted_29, toDisplayString(unref(__$1)("How to Improve", "google-analytics-dashboard-for-wp")), 1),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(accordionItems.value, (item, index) => {
                    return openBlock(), createElementBlock("div", {
                      key: item.key,
                      class: normalizeClass(["exactmetrics-site-speed-accordion__item", { "exactmetrics-site-speed-accordion__item--open": openAccordion.value === index }])
                    }, [
                      createBaseVNode("button", {
                        class: "exactmetrics-site-speed-accordion__header",
                        onClick: ($event) => toggleAccordion(index)
                      }, [
                        createBaseVNode("span", {
                          class: normalizeClass(["exactmetrics-site-speed-accordion__icon", "exactmetrics-site-speed-accordion__icon--" + item.icon])
                        }, [
                        ...
                        _cache[14] || (_cache[14] = createBaseVNode("span", { class: "exactmetrics-site-speed-accordion__arrow" }, [
                          createBaseVNode("svg", {
                            width: "12",
                            height: "8",
                            viewBox: "0 0 12 8",
                      ...
                      openAccordion.value === index ? (openBlock(), createElementBlock("div", {
                        key: 0,
                        class: "exactmetrics-site-speed-accordion__body",
