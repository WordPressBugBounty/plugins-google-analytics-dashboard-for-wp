...
import { G as rejectReport, E as relayFallbackFetch, H as createRequestQueue, F as isSampleDataEnabled } from "../reports-kVhDfd9w.js";
import { k as getMiGlobal, y as onMounted, z as onBeforeUnmount, o as openBlock, E as createBlock, D as withCtx, a as createBaseVNode, t as toDisplayString, u as unref, c as createElementBlock, s as createCommentVNode, b as createVNode, m as computed, j as ref } from "./toastStore-sH51RcCX.js";
import { e as ensureBearerToken, c as guardReportingConnection } from "./ajax-2wfIeviZ.js";
import { u as useReportPermissions } from "./useReportPermissions-BGwVQAy9.js";
import { u as useModal } from "./addons-CsEzvEzl.js";
import { b as formatNum } from "./overviewTableFormatters-Bc6bK3SS.js";
...
async function fetchRealtimeData() {
  const errorLabel = __("Error loading real-time report data", "google-analytics-dashboard-for-wp");
...
const _hoisted_1 = { class: "exactmetrics-report-row exactmetrics-overview-report-two-col" };
const _hoisted_2 = { class: "exactmetrics-overview-report-table exactmetrics-realtime-right-now" };
const _hoisted_3 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_4 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_5 = { class: "exactmetrics-realtime-right-now__body" };
const _hoisted_6 = {
  key: 0,
  class: "exactmetrics-realtime-right-now__count"
};
const _hoisted_7 = {
  key: 1,
  class: "exactmetrics-realtime-right-now__label"
};
const _hoisted_8 = {
  key: 2,
  class: "exactmetrics-realtime-right-now__unavailable"
};
const _hoisted_9 = { class: "exactmetrics-realtime-right-now__note" };
const _hoisted_10 = { class: "exactmetrics-realtime-right-now__refresh" };
const _hoisted_11 = { class: "exactmetrics-overview-report-table exactmetrics-realtime-chart" };
const _hoisted_12 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_13 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_14 = { class: "exactmetrics-realtime-chart__body" };
const _hoisted_15 = {
  key: 0,
...
const _hoisted_16 = {
  key: 2,
  class: "exactmetrics-realtime-chart__empty"
};
const _hoisted_17 = { class: "exactmetrics-overview-report-two-col" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const chartData = computed(() => {
      ...
      return {
        series: [{
          name: __$1("Pageviews", "google-analytics-dashboard-for-wp"),
          data: pv.datapoints
        }],
        categories: pv.labels.map(
          (m) => sprintf(__$1("%s min ago", "google-analytics-dashboard-for-wp"), m)
        )
      };
    });
    ...
    const topPagesColumns = [
      { key: "page", label: __$1("Page", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "count", label: __$1("Pageview Count", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "percent", label: __$1("Percent of Total", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "eventCount", label: __$1("Events Count", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    const topPagesRows = computed(() => {
      ...
      return pages.filter((row) => !shouldHideNotSetValue(row.title)).map((row) => ({
        page: row.title || __$1("(not set)", "google-analytics-dashboard-for-wp"),
    ...
    const countriesColumns = [
      { key: "country", label: __$1("Country", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "count", label: __$1("Count", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "percent", label: __$1("Percent", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    const countriesRows = computed(() => {
      ...
      return countries.filter((row) => !shouldHideNotSetValue(row.name || row.country)).map((row) => {
        ...
        const name = row.name || row.country || __$1("(not set)", "google-analytics-dashboard-for-wp");
        return {
          country: name,
          countryFlag: iso,
          count: formatNum(row.count),
    ...
    const citiesColumns = [
      { key: "city", label: __$1("City", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "country", label: __$1("Country", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "count", label: __$1("Count", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    const citiesRows = computed(() => {
      ...
      return cities.filter((row) => !shouldHideNotSetValue(row.city)).map((row) => {
        const name = row.name || row.country || __$1("(not set)", "google-analytics-dashboard-for-wp");
        return {
          city: row.city || __$1("(not set)", "google-analytics-dashboard-for-wp"),
          country: name,
          count: formatNum(row.count)
        };
      });
    ...
    const refreshAgoText = computed(
      () => sprintf(
        __$1("The real-time report was last updated %s seconds ago.", "google-analytics-dashboard-for-wp"),
        seconds.value
      )
    );
    ...
    function showPausedModal() {
      ...
      pausedModal = showConfirmModal({
        title: __$1("Real-Time Report Paused", "google-analytics-dashboard-for-wp"),
        message: __$1("The Real-Time Report automatically paused due to inactivity. Click Resume to continue receiving live data.", "google-analytics-dashboard-for-wp"),
        confirmButtonText: __$1("Resume", "google-analytics-dashboard-for-wp"),
        cancelButtonText: __$1("Close", "google-analytics-dashboard-for-wp"),
        clickToClose: true,
        escToClose: true,
        onConfirm: () => {
          loadData(true);
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("div", _hoisted_3, [
                createBaseVNode("h3", _hoisted_4, toDisplayString(unref(__$1)("Right Now", "google-analytics-dashboard-for-wp")), 1)
              ]),
              createBaseVNode("div", _hoisted_5, [
                ...
                realtimeData.value ? (openBlock(), createElementBlock("div", _hoisted_7, toDisplayString(unref(__$1)("Active users on site", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true),
                !realtimeData.value && !loading.value ? (openBlock(), createElementBlock("p", _hoisted_8, toDisplayString(unref(__$1)("The real-time graph of visitors over time is not currently available for this site. Please try again later.", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true),
                createBaseVNode("p", _hoisted_9, toDisplayString(unref(__$1)("Important: this only includes users who are tracked in real-time. Not all users are tracked in real-time including (but not limited to) logged-in site administrators, certain mobile users, and users who match a Google Analytics filter.", "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("p", _hoisted_10, toDisplayString(unref(__$1)("The real-time report automatically updates approximately every 60 seconds.", "google-analytics-dashboard-for-wp")) + " " + toDisplayString(refreshAgoText.value) + " " + toDisplayString(unref(__$1)("The latest data will be automatically shown on this page when it becomes available.", "google-analytics-dashboard-for-wp")), 1)
              ])
            ]),
            createBaseVNode("div", _hoisted_11, [
              createBaseVNode("div", _hoisted_12, [
                createBaseVNode("h3", _hoisted_13, toDisplayString(unref(__$1)("Pageviews Per Minute", "google-analytics-dashboard-for-wp")), 1)
              ]),
              createBaseVNode("div", _hoisted_14, [
                ...
                }, null, 8, ["data"])) : (openBlock(), createElementBlock("div", _hoisted_16, toDisplayString(unref(__$1)("No pageview data available.", "google-analytics-dashboard-for-wp")), 1))
              ])
            ])
          ]),
          createVNode(_sfc_main$1, {
            title: unref(__$1)("Top Pages", "google-analytics-dashboard-for-wp"),
            columns: topPagesColumns,
            rows: topPagesRows.value,
            loading: loading.value,
            "empty-message": unref(__$1)("No pageviews currently.", "google-analytics-dashboard-for-wp"),
            "has-load-more": false
          }, null, 8, ["title", "rows", "loading", "empty-message"]),
          createBaseVNode("div", _hoisted_17, [
            createVNode(_sfc_main$1, {
              title: unref(__$1)("Top Countries", "google-analytics-dashboard-for-wp"),
              columns: countriesColumns,
              rows: countriesRows.value,
              loading: loading.value,
              "empty-message": unref(__$1)("No traffic currently.", "google-analytics-dashboard-for-wp"),
              "has-load-more": false
            }, null, 8, ["title", "rows", "loading", "empty-message"]),
            createVNode(_sfc_main$1, {
              title: unref(__$1)("Top Cities", "google-analytics-dashboard-for-wp"),
