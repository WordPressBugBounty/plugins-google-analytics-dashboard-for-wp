...
import { u as usePopularPostsStore, _ as _sfc_main$9, P as PopularPostsThemeLicense$1, d as debounce, a as _sfc_main$a, b as _sfc_main$b, c as _sfc_main$h, e as _sfc_main$i, f as _sfc_main$j, g as _sfc_main$k, h as _sfc_main$l } from "./PopularPostsVideoModal-LLFcDlKv.js";
import { _ as _sfc_main$e } from "./SettingsBlock-C5coD8IO.js";
import { _ as _sfc_main$c } from "./SettingsInputRadio-DrnwycOy.js";
import { _ as _sfc_main$d } from "./SettingsInputCheckbox-CJuBL4N8.js";
...
import { o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, u as unref, i as normalizeClass, B as withModifiers, s as createCommentVNode, F as Fragment, f as renderList, n as normalizeStyle, A as createTextVNode, E as createBlock, m as computed, j as ref, D as withCtx, b as createVNode, w as withDirectives, ax as vShow, y as onMounted } from "./toastStore-sH51RcCX.js";
import { a as useToast, c as useAddonsStore, d as useDialog } from "./addons-CsEzvEzl.js";
import { u as useAuth, d as _sfc_main$f } from "./exactmetrics-Lite-BAwJMo6f.js";
import { S as SettingsInputSelect } from "./SettingsInputSelect-BvNEvMN6.js";
import { u as useLicenseStore } from "./license-aovyLeA0.js";
import { j as getMiGlobal, o as getUrl } from "./ajax-2wfIeviZ.js";
import { _ as _sfc_main$g } from "./SettingsInfoTooltip-BkvPcRVr.js";
import { c as grabPopularPostsReport } from "./popularPosts-D2VRbV8A.js";
...
const _hoisted_1$7 = { class: "exactmetrics-pp-widget-theme-preview" };
const _hoisted_2$6 = ["textContent"];
const _hoisted_3$6 = { class: "exactmetrics-pp-widget-theme-preview-width" };
const _hoisted_4$4 = { class: "exactmetrics-buttons-toggle" };
const _hoisted_5$4 = ["textContent"];
const _hoisted_6$3 = ["textContent"];
const _hoisted_7$3 = { class: "exactmetrics-dummy-text" };
const _hoisted_8$3 = {
  key: 0,
  class: "exactmetrics-widget-popular-posts-list"
};
const _hoisted_9$3 = { class: "exactmetrics-widget-popular-posts-text" };
const _hoisted_10$3 = ["textContent"];
const _hoisted_11$3 = ["textContent"];
const _hoisted_12$2 = {
  key: 0,
  class: "exactmetrics-widget-popular-posts-author"
};
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    const text_theme_preview = __("Theme Preview", "google-analytics-dashboard-for-wp");
    const text_wide = __("Wide", "google-analytics-dashboard-for-wp");
    const text_narrow = __("Narrow", "google-analytics-dashboard-for-wp");
    const text_yesterday = __("Yesterday", "google-analytics-dashboard-for-wp");
    ...
    const themeClass = computed(
      () => "exactmetrics-widget-popular-posts-widget exactmetrics-widget-popular-posts-" + active.value + " exactmetrics-widget-popular-posts-columns-" + columns.value
    );
    const outputClass = computed(
      () => "exactmetrics-pp-widget-theme-preview-output exactmetrics-pp-widget-theme-preview-output-" + preview_width.value
    );
    ...
    const renderCssClass = computed(() => {
      let cls = "exactmetrics-pp-widget-theme-preview-render";
      if (!themeAvailable.value) {
        cls += " exactmetrics-pp-blurred";
      }
      return cls;
    });
    ...
    function themeWidthButtonClass(width) {
      ...
      if (width === preview_width.value) {
        cls += " exactmetrics-selected-interval";
      }
      return cls;
    }
    function imgClass(img) {
      const normalized = img.replace(".jpg", "").replace(".png", "");
      return "exactmetrics-bg-img exactmetrics-pp-" + normalized;
    }
    return (_ctx, _cache) => {
                  ...
                  return openBlock(), createElementBlock("li", {
                    ...
                    createBaseVNode("div", _hoisted_9$3, [
                      themeOptions.value.label ? (openBlock(), createElementBlock("span", {
                        key: 0,
                        class: "exactmetrics-widget-popular-posts-label",
                      ...
                      themeOptions.value.meta ? (openBlock(), createElementBlock("div", {
                        ...
                        themeOptions.value.meta.date && "off" !== getThemeOption("meta", "date") ? (openBlock(), createElementBlock("span", {
                          key: 2,
                          class: "exactmetrics-widget-popular-posts-date",
                      ...
                      themeOptions.value.meta && themeOptions.value.meta.comments && "off" !== getThemeOption("meta", "comments") ? (openBlock(), createElementBlock("span", {
                        key: 2,
                        class: "exactmetrics-widget-popular-posts-comments",
...
const _hoisted_1$6 = { class: "exactmetrics-settings-input-select-simple" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("select", {
          name: __props.name,
          class: "exactmetrics-settings-select",
          autocomplete: "off",
...
const _hoisted_1$5 = { class: "exactmetrics-pp-inline-theme-controls" };
const _hoisted_2$4 = {
  key: 0,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-title"
};
const _hoisted_3$4 = ["textContent"];
const _hoisted_4$3 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_9$2 = {
  key: 1,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-label"
};
const _hoisted_10$2 = ["textContent"];
const _hoisted_11$2 = { class: "exactmetrics-pp-controls-inputs" };
const _hoisted_12$1 = { key: 0 };
const _hoisted_13$1 = ["textContent"];
const _hoisted_14$1 = { class: "exactmetrics-pp-color-input-inline" };
const _hoisted_15$1 = ["value"];
const _hoisted_16$1 = { key: 1 };
const _hoisted_17$1 = ["textContent"];
const _hoisted_18$1 = {
  key: 2,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-background"
};
const _hoisted_19$1 = ["textContent"];
const _hoisted_20$1 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_25$1 = {
  key: 3,
  class: "exactmetrics-pp-controls exactmetrics-pp-controls-border"
};
const _hoisted_26$1 = ["textContent"];
const _hoisted_27$1 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_32$1 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_39 = { class: "exactmetrics-pp-controls-inputs" };
...
const _hoisted_50 = {
  key: 2,
  class: "exactmetrics-inline-checkboxes"
};
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const popularPostsStore = usePopularPostsStore();
    const { savingToast, successToast, errorToast } = useToast();
    const text_customize_design = __("Customize Design", "google-analytics-dashboard-for-wp");
    const text_title = __("Title", "google-analytics-dashboard-for-wp");
    const text_color = __("Color", "google-analytics-dashboard-for-wp");
    const text_size = __("Size", "google-analytics-dashboard-for-wp");
    const text_border = __("Border", "google-analytics-dashboard-for-wp");
    const text_meta = __("Author/Date", "google-analytics-dashboard-for-wp");
    const text_label = __("Label", "google-analytics-dashboard-for-wp");
    const text_background = __("Background", "google-analytics-dashboard-for-wp");
    const text_wide_label = __("Wide-Layout Options", "google-analytics-dashboard-for-wp");
    const text_wide_desc = __(
      "Adjust the number of columns displayed when the widget is placed in a wide container.",
      "google-analytics-dashboard-for-wp"
    );
    const text_display_options = __("Display Options", "google-analytics-dashboard-for-wp");
    const text_display_options_desc = __(
      "Choose which content you would like displayed in the widget.",
      "google-analytics-dashboard-for-wp"
    );
    const text_display_author = __("Display Author", "google-analytics-dashboard-for-wp");
    const text_display_date = __("Display Date", "google-analytics-dashboard-for-wp");
    const text_display_comments = __("Display Comments", "google-analytics-dashboard-for-wp");
    const text_comments = __("Comments", "google-analytics-dashboard-for-wp");
    const text_post_count = __("Post Count", "google-analytics-dashboard-for-wp");
    ...
    const wide_columns = [
      {
        label: '<span class="exactmetrics-wide-column exactmetrics-wide-column-three"><span></span><span></span><span></span><span></span><span></span><span></span></span>',
        value: "3"
      },
      {
        label: '<span class="exactmetrics-wide-column exactmetrics-wide-column-two"><span></span><span></span><span></span><span></span></span>',
        value: "2"
      },
      {
        label: '<span class="exactmetrics-wide-column exactmetrics-wide-column-one"><span></span><span></span></span>',
        value: "1"
      }
    ];
    const preview = computed(() => popularPostsStore.theme_preview_widget);
    ...
    const renderCssClass = computed(() => themeAvailable.value ? "" : " exactmetrics-pp-blurred");
    function getThemeOption(object, key) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$e, {
        ...
        class: "exactmetrics-pp-widget-controls",
        ...
        default: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_1$5, [
              themeOptions.value.title ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
                createBaseVNode("label", {
                  class: "exactmetrics-pp-controls-description",
                ...
                createBaseVNode("div", _hoisted_4$3, [
                  themeOptions.value.title.color ? (openBlock(), createElementBlock("label", _hoisted_5$3, [
                    createBaseVNode("span", {
                      class: "exactmetrics-pp-control-label",
            ...
            _cache[14] || (_cache[14] = createBaseVNode("div", { class: "exactmetrics-separator" }, null, -1)),
            ...
            createVNode(_sfc_main$c, {
              ...
              class: "exactmetrics-wide-column-options",
              onUpdated: updateCount
            }),
            _cache[15] || (_cache[15] = createBaseVNode("div", { class: "exactmetrics-separator" }, null, -1)),
            createBaseVNode("p", null, [
              createBaseVNode("span", {
                class: "exactmetrics-dark",
...
const _hoisted_1$4 = { class: "exactmetrics-popular-posts-widget-category exactmetrics-popular-posts-widget-category-lite" };
const _hoisted_2$3 = ["textContent"];
const _hoisted_3$3 = ["innerHTML"];
const _sfc_main$5 = {
  __name: "exactmetrics-PopularPostsWidgetCategory-Lite",
  setup(__props) {
    const { __ } = wp.i18n;
    ...
    const options = [];
    const forced = [
      { label: __("News", "google-analytics-dashboard-for-wp"), value: "" },
      { label: __("Technology", "google-analytics-dashboard-for-wp"), value: "" }
    ];
    return (_ctx, _cache) => {
...
const _sfc_main$4 = {
  __name: "exactmetrics-PopularPostsProPill-Pro",
  props: {
    level: {
      type: String,
      default: "pro"
...
const _hoisted_1$2 = { class: "exactmetrics-popular-posts-ga-settings" };
const _hoisted_2$2 = { class: "exactmetrics-dark" };
const _hoisted_3$2 = ["textContent"];
const _hoisted_4$2 = ["innerHTML"];
const _hoisted_5$2 = ["textContent"];
const _sfc_main$3 = {
  __name: "exactmetrics-PopularPostsGaInput-Pro",
  props: {
    name: {
      type: String,
      required: true
  ...
  setup(__props) {
    ...
    const text_add_top_5_ga = __("Add Top 5 Posts from Google Analytics", "google-analytics-dashboard-for-wp");
    const text_add_top_5_ga_tooltip = __(
      "To load the top posts from Google Analytics, you must enable the Custom Dimensions addon and set up the Post Type custom dimension in the ExactMetrics settings.",
      "google-analytics-dashboard-for-wp"
    );
    const text_check_data = __("Test Automated Posts", "google-analytics-dashboard-for-wp");
    ...
    const text_automated = __("Automated + Curated", "google-analytics-dashboard-for-wp");
    const text_automated_description = sprintf(
      ...
      '<a href="#/conversions">',
      "</a>",
      `<a target="_blank" href="${getUrl("popular-posts", "automated-ga", "https://exactmetrics.com/docs/how-to-include-your-popular-posts-from-google-analytics/")}">`,
      "</a>"
    );
    const text_needs_pro = __("Pro version is required.", "google-analytics-dashboard-for-wp");
    ...
    const ga_check_button_class = computed(() => {
      let cls = "exactmetrics-button exactmetrics-button-secondary";
    ...
    async function start_tracking() {
      const loader = loading({ title: __("Verifying Popular Posts data", "google-analytics-dashboard-for-wp") });
      try {
        await grabPopularPostsReport();
        loader.close();
        await alert({
          variant: "success",
          title: __("Popular Posts data can be fetched correctly", "google-analytics-dashboard-for-wp"),
          message: __(
          ...
          confirmText: __("Close", "google-analytics-dashboard-for-wp")
        });
      } catch (err) {
        loader.close();
        ...
        if (footer === "install_addon") {
          const verb = isAddonInstalled("dimensions") ? __("activate", "google-analytics-dashboard-for-wp") : __("install", "google-analytics-dashboard-for-wp");
          ...
          const goToAddons = await confirm({
            ...
            confirmText: __("Visit addons page", "google-analytics-dashboard-for-wp"),
            cancelText: __("Close", "google-analytics-dashboard-for-wp")
          });
          if (goToAddons) {
        ...
        if (footer) {
          ...
          const goToLink = await confirm({
            title: __("Error", "google-analytics-dashboard-for-wp"),
            message: error_message,
            confirmText: anchor?.innerText || __("OK", "google-analytics-dashboard-for-wp"),
            cancelText: __("Close", "google-analytics-dashboard-for-wp")
          });
...
const _hoisted_1$1 = { class: "exactmetrics-pp-manual-placement" };
const _hoisted_2$1 = ["textContent"];
const _hoisted_3$1 = ["textContent"];
const _hoisted_4$1 = { class: "exactmetrics-pp-placement-options-accordion" };
const _hoisted_5$1 = { class: "exactmetrics-pp-accordion-item-title" };
const _hoisted_6$1 = { class: "exactmetrics-pp-accordion-item-title-top" };
const _hoisted_7$1 = ["textContent"];
const _hoisted_8$1 = { class: "exactmetrics-pp-accordion-item-title-bottom-container" };
const _hoisted_9$1 = ["textContent"];
const _hoisted_10$1 = { class: "exactmetrics-pp-accordion-item-title-top" };
...
const _hoisted_14 = { class: "exactmetrics-pp-accordion-item-content" };
const _hoisted_15 = { class: "exactmetrics-pp-manual-placement-content-columns" };
const _hoisted_16 = { class: "exactmetrics-pp-manual-placement-content-steps" };
const _hoisted_17 = ["innerHTML"];
const _hoisted_18 = { class: "exactmetrics-pp-accordion-item-title-top" };
...
const _hoisted_22 = { class: "exactmetrics-pp-accordion-item-content" };
const _hoisted_23 = { class: "exactmetrics-pp-manual-placement-content-columns" };
const _hoisted_24 = { class: "exactmetrics-pp-manual-placement-content-steps" };
const _hoisted_25 = ["textContent"];
const _hoisted_26 = ["textContent"];
const _hoisted_27 = ["textContent"];
const _hoisted_28 = { class: "exactmetrics-pp-accordion-item-title-top" };
...
const _hoisted_32 = { class: "exactmetrics-pp-accordion-item-content" };
const _hoisted_33 = { class: "exactmetrics-pp-manual-placement-content-columns" };
const _hoisted_34 = { class: "exactmetrics-pp-manual-placement-content-steps" };
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const text_automatic_placement = __("Automatic Placement", "google-analytics-dashboard-for-wp");
    const text_gutenberg_block = __("Display using Gutenberg Blocks", "google-analytics-dashboard-for-wp");
    const text_embed_options = __("Embed Options", "google-analytics-dashboard-for-wp");
    const text_embed_options_desc = __(
      "All Embed Options can be used in conjunction with one another.",
      "google-analytics-dashboard-for-wp"
    );
    const text_shortcode_title = __("Display using a Shortcode", "google-analytics-dashboard-for-wp");
    ...
    const text_shortcode = __("Display using a Shortcode", "google-analytics-dashboard-for-wp");
    ...
    const text_copy = __("Copy Shortcode", "google-analytics-dashboard-for-wp");
    ...
    const text_sidebar_title = __("Display in a Sidebar", "google-analytics-dashboard-for-wp");
    ...
    function copyToClipboard() {
      document.querySelector("#exactmetrics-shortcode-widget-copy").select();
    ...
    function accordionTitleClass(key) {
      let cls = "exactmetrics-pp-accordion-item-title exactmetrics-pp-accordion-item-title-toggle ";
      if (selected.value === key) {
        cls += "exactmetrics-pp-accordion-item-title-active";
      }
      return cls;
    }
    return (_ctx, _cache) => {
        ...
        createBaseVNode("div", _hoisted_4$1, [
          createBaseVNode("div", _hoisted_5$1, [
            ...
            createBaseVNode("div", _hoisted_8$1, [
              createBaseVNode("div", {
                class: "exactmetrics-pp-accordion-item-title-bottom",
              ...
              createBaseVNode("ul", _hoisted_24, [
                createBaseVNode("li", null, [
                  ...
                  _cache[8] || (_cache[8] = createBaseVNode("input", {
                    id: "exactmetrics-shortcode-widget-copy",
                    type: "text",
                    readonly: true,
                    value: "[exactmetrics_popular_posts_widget]"
                  }, null, -1)),
                  createBaseVNode("button", {
...
const video_gutenberg = "https://www.youtube.com/embed/i-WSdWgL0g8";
const video_shortcode = "https://www.youtube.com/embed/pW5o95X2mmo";
const video_sidebar = "https://www.youtube.com/embed/_XH2jT3VIfY";
const _sfc_main$1 = {
  __name: "exactmetrics-WidgetPlacement",
  setup(__props) {
    return (_ctx, _cache) => {
...
const _hoisted_1 = { class: "exactmetrics-settings-content exactmetrics-settings-content-pp-widget" };
const _hoisted_2 = {
  key: 2,
  class: "exactmetrics-separator"
};
...
const _hoisted_9 = {
  key: 0,
  class: "exactmetrics-input-text-small"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const settingsStore = useSettingsStore();
    const popularPostsStore = usePopularPostsStore();
    const text_choose_theme = __("Choose Theme", "google-analytics-dashboard-for-wp");
    const text_behavior = __("Behavior", "google-analytics-dashboard-for-wp");
    const text_widget_styling = __("Widget Styling", "google-analytics-dashboard-for-wp");
    const text_widget_styling_desc = __(
      "Choose how you want to determine the colors, font sizes and spacing of the widget.",
      "google-analytics-dashboard-for-wp"
    );
    const text_sort_by = __("Sort By", "google-analytics-dashboard-for-wp");
    const text_sort_by_description = __(
      "Choose how you'd like the widget to determine your popular posts.",
      "google-analytics-dashboard-for-wp"
    );
    const text_display_title = __("Display Title", "google-analytics-dashboard-for-wp");
    const text_widget_title = __("Widget Title", "google-analytics-dashboard-for-wp");
    const text_widget_title_desc = __(
      "Title your widget and set its display preferences.",
      "google-analytics-dashboard-for-wp"
    );
    const text_post_type = __("Include in Post Types", "google-analytics-dashboard-for-wp");
    const text_exclude_posts = __("Exclude from specific posts", "google-analytics-dashboard-for-wp");
    ...
    const text_loading_themes = __("Loading Themes", "google-analytics-dashboard-for-wp");
