...
import { h as fetchRefundsByGeoData } from "./ecommerceReports-CCE1siVm.js";
...
import { a as formatCurr, b as formatNum, f as formatPct } from "./overviewTableFormatters-CC_6ogRL.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const columns = [
      ...
      { key: "pctRefunds", label: __("% of Refunds", "google-analytics-dashboard-for-wp"), sortable: true, totalType: "average" },
      { key: "refundAmount", label: __("Refund Amount", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "pctRefundAmount", label: __("% of Refund Amount", "google-analytics-dashboard-for-wp"), sortable: true, totalType: "average" },
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__)("Refunds by Geography", "google-analytics-dashboard-for-wp"),
            columns,
