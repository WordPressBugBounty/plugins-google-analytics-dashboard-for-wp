import { a1 as storeToRefs, o as openBlock, E as createBlock, D as withCtx, b as createVNode, u as unref, j as ref, m as computed } from "./toastStore-nTGs-rGm.js";
...
async function fetchFormsReportData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading forms report data", "google-analytics-dashboard-for-wp");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const chartTabs = [
      ...
      { id: "form_impressions", label: __$1("Form Impressions", "google-analytics-dashboard-for-wp"), icon: "form-impressions" },
      { id: "form_completions", label: __$1("Form Completions", "google-analytics-dashboard-for-wp"), icon: "form-completions" }
    ];
    const breakdownTabs = [
      { label: __$1("None", "google-analytics-dashboard-for-wp"), value: "none" },
      { label: __$1("Source / Medium", "google-analytics-dashboard-for-wp"), value: "source-medium" },
    ...
    const tableTitle = __$1("Forms Report", "google-analytics-dashboard-for-wp");
    const columns = computed(() => {
      let firstCol;
      if (activeBreakdown.value === "source-medium") {
        firstCol = { key: "name", label: __$1("Source / Medium", "google-analytics-dashboard-for-wp"), sortable: true };
      } else if (activeBreakdown.value === "campaign") {
        firstCol = { key: "name", label: __$1("Campaign", "google-analytics-dashboard-for-wp"), sortable: true };
      } else {
        firstCol = { key: "name", label: __$1("Form ID", "google-analytics-dashboard-for-wp"), sortable: true };
      }
      return [
        firstCol,
        { key: "impressions", label: __$1("Impressions", "google-analytics-dashboard-for-wp"), sortable: true },
        { key: "conversions", label: __$1("Conversions", "google-analytics-dashboard-for-wp"), sortable: true },
    ...
    function aggregateFormRows(rows, dims) {
      ...
      return Object.entries(grouped).filter(([key]) => !shouldHideNotSetValue(key)).map(([key, data]) => {
        const name = key && String(key).trim() !== "" ? String(key) : __$1("(not set)", "google-analytics-dashboard-for-wp");
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            ...
            loading: unref(loading),
            "empty-message": unref(__$1)("No form data currently available.", "google-analytics-dashboard-for-wp"),
