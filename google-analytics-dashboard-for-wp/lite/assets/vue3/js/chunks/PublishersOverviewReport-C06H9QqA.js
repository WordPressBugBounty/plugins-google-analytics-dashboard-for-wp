import { a1 as storeToRefs, C as watch, y as onMounted, o as openBlock, E as createBlock, D as withCtx, a as createBaseVNode, c as createElementBlock, b as createVNode, t as toDisplayString, u as unref, F as Fragment, s as createCommentVNode, j as ref, m as computed } from "./toastStore-nTGs-rGm.js";
import { _ as __$1, s as sprintf } from "./default-i18n-KrIlCc2E.js";
import { B as applyFiltersToQuery, E as relayReportingQuery, F as relayFallbackFetch, u as useOverviewReportStore, A as isSampleDataEnabled, b as buildApiFilters } from "../reports-B_hJZd5_.js";
import { u as useReportPermissions } from "./useReportPermissions-C-5w1M_B.js";
import { f as fetchCachedReportSection } from "./reportCache-BKxm938n.js";
import { q as sanitizeHtml, n as getUpgradeUrl, j as getMiGlobal, t as getExactMetricsUrl } from "./ajax-BSXoXmkG.js";
import { f as formatPct, b as formatNum } from "./overviewTableFormatters-WylMWTgV.js";
...
import { _ as _sfc_main$2 } from "./ReportPieChart-DRNYn8qZ.js";
import { A as ApexBarChart } from "./ApexBarChart-D-BBUm7i.js";
...
const LANDING_PAGE_ROWS = [
  ...
  { title: "Features — ExactMetrics Overview", path: "/features/" },
...
const _hoisted_1 = { class: "exactmetrics-overview-report exactmetrics-publishers-report" };
const _hoisted_2 = {
  key: 0,
  class: "exactmetrics-publishers-report__loading"
};
const _hoisted_3 = {
  key: 1,
  class: "exactmetrics-publishers-report__error"
};
const _hoisted_4 = { class: "exactmetrics-publishers-report__section" };
const _hoisted_5 = { class: "exactmetrics-publishers-report__row exactmetrics-overview-report-two-col" };
const _hoisted_6 = { class: "exactmetrics-publishers-report__col" };
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-overview-report-table"
};
const _hoisted_8 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_9 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_10 = { class: "exactmetrics-publishers-report__section-error" };
const _hoisted_11 = { class: "exactmetrics-publishers-report__col" };
const _hoisted_12 = {
  key: 0,
  class: "exactmetrics-overview-report-table"
};
const _hoisted_13 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_14 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_15 = { class: "exactmetrics-publishers-report__section-error" };
const _hoisted_16 = { class: "exactmetrics-publishers-report__section" };
const _hoisted_17 = {
  key: 0,
  class: "exactmetrics-overview-report-table"
};
const _hoisted_18 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_19 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_20 = { class: "exactmetrics-publishers-report__section-error" };
const _hoisted_21 = {
  key: 0,
  class: "exactmetrics-publishers-report__row exactmetrics-overview-report-two-col exactmetrics-publishers-report__row--charts"
};
const _hoisted_22 = { class: "exactmetrics-publishers-report__chart-card" };
const _hoisted_23 = { class: "exactmetrics-publishers-report__chart-title" };
const _hoisted_24 = {
  key: 1,
  class: "exactmetrics-publishers-report__chart-empty"
};
const _hoisted_25 = { class: "exactmetrics-publishers-report__chart-card" };
const _hoisted_26 = { class: "exactmetrics-publishers-report__chart-title" };
const _hoisted_27 = {
  key: 0,
  class: "exactmetrics-publishers-report__period-label"
};
const _hoisted_28 = { class: "exactmetrics-publishers-report__period-label exactmetrics-publishers-report__period-label--prev" };
const _hoisted_29 = {
  key: 1,
  class: "exactmetrics-publishers-report__chart-empty"
};
const _hoisted_30 = { class: "exactmetrics-publishers-report__row exactmetrics-publishers-report__row--interest-scroll-split" };
const _hoisted_31 = {
  key: 0,
  class: "exactmetrics-publishers-report__col exactmetrics-publishers-report__col--interests"
};
const _hoisted_32 = {
  key: 1,
  class: "exactmetrics-publishers-report__scroll-card"
};
const _hoisted_33 = { class: "exactmetrics-publishers-report__scroll-title" };
const _hoisted_34 = {
  key: 0,
  class: "exactmetrics-publishers-report__scroll-error"
};
const _hoisted_35 = { class: "exactmetrics-publishers-report__scroll-metric" };
const _hoisted_36 = { class: "exactmetrics-publishers-report__scroll-label" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const previousDateLabel = computed(() => {
      ...
      if (!s || !e) return __$1("Previous period", "google-analytics-dashboard-for-wp");
      return `${formatShortDate(s)} – ${formatShortDate(e)}`;
    });
    const compareDateLabels = computed(() => ({
      current: currentDateLabel.value || __$1("Current period", "google-analytics-dashboard-for-wp"),
      previous: previousDateLabel.value || __$1("Previous period", "google-analytics-dashboard-for-wp")
    }));
    const landingColumns = [
      { key: "pageTitle", label: __$1("Page Titles", "google-analytics-dashboard-for-wp"), sortable: true, linkKey: "pageUrl" },
      { key: "visits", label: __$1("Visits", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" },
      { key: "duration", label: __$1("Avg. Duration", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" },
      { key: "bounce", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" }
    ];
    const outboundColumns = [
      { key: "link", label: __$1("Links", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "clicks", label: __$1("Total Clicks", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" }
    ];
    const affiliateColumns = [
      { key: "label", label: __$1("Label", "google-analytics-dashboard-for-wp"), sortable: true, compare: false },
      { key: "link", label: __$1("Link", "google-analytics-dashboard-for-wp"), sortable: true, compare: false },
      { key: "clicks", label: __$1("Total Clicks", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" }
    ];
    const downloadColumns = [
      { key: "label", label: __$1("Link Label", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "clicks", label: __$1("Clicks", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" }
    ];
    const interestColumns = [
      { key: "category", label: __$1("Categories", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "percent", label: __$1("% of Interest", "google-analytics-dashboard-for-wp"), sortable: true, type: "string" }
    ];
    ...
    const landingTotals = computed(() => {
      ...
      return {
        pageTitle: __$1("Totals", "google-analytics-dashboard-for-wp"),
    ...
    const textErrors = {
      ...
      UNKNOWN_ERROR: __$1("An unknown error has occurred.", "google-analytics-dashboard-for-wp")
    };
    ...
    const scrollExplainerHtml = computed(() => {
      const url = getExactMetricsUrl(
        "docs",
        "scroll-tracking",
        "https://www.exactmetrics.com/docs/scroll-tracking-and-reporting/"
      );
      return sprintf(
        __$1(
        ...
        '<span class="exactmetrics-ignore-data-from-pdf-reports">',
    ...
    function gaLinkOrUpgrade(key) {
      if (isBlocked.value) {
        return getUpgradeUrl("report", "publisher", "https://www.exactmetrics.com/pricing/");
      }
    ...
    async function loadData() {
      ...
      try {
        ...
        loadError.value = e?.message || __$1("Error loading report.", "google-analytics-dashboard-for-wp");
        publisher.value = {};
      } finally {
        loading.value = false;
      }
            ...
            loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
              ...
              createBaseVNode("div", _hoisted_4, [
                createVNode(_sfc_main$1, {
                  title: unref(__$1)("Top Landing Pages", "google-analytics-dashboard-for-wp"),
                  ...
                  "ga-link-label": unref(__$1)("View Full Top Landing Pages Report", "google-analytics-dashboard-for-wp"),
                  "empty-message": unref(__$1)("No landing pages tracked during this time period.", "google-analytics-dashboard-for-wp")
                ...
                createBaseVNode("div", _hoisted_6, [
                  sectionError("outboundlinks") ? (openBlock(), createElementBlock("div", _hoisted_7, [
                    createBaseVNode("div", _hoisted_8, [
                      createBaseVNode("h3", _hoisted_9, toDisplayString(unref(__$1)("Top Outbound Links", "google-analytics-dashboard-for-wp")), 1)
                    ]),
                    createBaseVNode("div", _hoisted_10, toDisplayString(sectionError("outboundlinks")), 1)
                  ])) : (openBlock(), createBlock(_sfc_main$1, {
                    key: 1,
                    title: unref(__$1)("Top Outbound Links", "google-analytics-dashboard-for-wp"),
                    columns: outboundColumns,
                    rows: outboundRows.value,
                    "compare-rows": outboundCompareRows.value,
                    "compare-date-labels": compareDateLabels.value,
                    loading: false,
                    "empty-message": unref(__$1)("No outbound link clicks detected for this time period.", "google-analytics-dashboard-for-wp")
                ...
                createBaseVNode("div", _hoisted_11, [
                  sectionError("affiliatelinks") ? (openBlock(), createElementBlock("div", _hoisted_12, [
                    createBaseVNode("div", _hoisted_13, [
                      createBaseVNode("h3", _hoisted_14, toDisplayString(unref(__$1)("Top Affiliate Links", "google-analytics-dashboard-for-wp")), 1)
                    ]),
                    createBaseVNode("div", _hoisted_15, toDisplayString(sectionError("affiliatelinks")), 1)
                  ])) : (openBlock(), createBlock(_sfc_main$1, {
                    key: 1,
                    title: unref(__$1)("Top Affiliate Links", "google-analytics-dashboard-for-wp"),
                    columns: affiliateColumns,
                    rows: affiliateRows.value,
                    "compare-rows": affiliateCompareRows.value,
                    "compare-date-labels": compareDateLabels.value,
                    loading: false,
                    "empty-message": unref(__$1)("No affiliate link clicks detected for this time period.", "google-analytics-dashboard-for-wp")
                  }, null, 8, ["title", "rows", "compare-rows", "compare-date-labels", "empty-message"]))
                ])
              ]),
              createBaseVNode("div", _hoisted_16, [
                sectionError("downloadlinks") ? (openBlock(), createElementBlock("div", _hoisted_17, [
                  createBaseVNode("div", _hoisted_18, [
                    createBaseVNode("h3", _hoisted_19, toDisplayString(unref(__$1)("Top Download Links", "google-analytics-dashboard-for-wp")), 1)
                  ]),
                  createBaseVNode("div", _hoisted_20, toDisplayString(sectionError("downloadlinks")), 1)
                ])) : (openBlock(), createBlock(_sfc_main$1, {
                  key: 1,
                  title: unref(__$1)("Top Download Links", "google-analytics-dashboard-for-wp"),
                  ...
                  "ga-link-label": unref(__$1)("View All Download Links Report", "google-analytics-dashboard-for-wp"),
                  "empty-message": unref(__$1)("No download link clicks detected for this time period.", "google-analytics-dashboard-for-wp")
              ...
              showAgeGenderRow.value ? (openBlock(), createElementBlock("div", _hoisted_21, [
                createBaseVNode("div", _hoisted_22, [
                  createBaseVNode("h3", _hoisted_23, toDisplayString(unref(__$1)("Age", "google-analytics-dashboard-for-wp")), 1),
                  ...
                  }, null, 8, ["data", "height", "show-legend"])) : (openBlock(), createElementBlock("div", _hoisted_24, toDisplayString(unref(__$1)("No age data available.", "google-analytics-dashboard-for-wp")), 1))
                ]),
                createBaseVNode("div", _hoisted_25, [
                  createBaseVNode("h3", _hoisted_26, toDisplayString(unref(__$1)("Gender", "google-analytics-dashboard-for-wp")), 1),
                  genderChartCurrent.value.series?.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    ...
                    isCompareActive2.value && genderChartPrev.value.series?.length ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      _cache[0] || (_cache[0] = createBaseVNode("div", { class: "exactmetrics-publishers-report__compare-divider" }, null, -1)),
                  ...
                  ], 64)) : (openBlock(), createElementBlock("div", _hoisted_29, toDisplayString(unref(__$1)("No gender data available.", "google-analytics-dashboard-for-wp")), 1))
                ])
              ])) : createCommentVNode("", true),
              createBaseVNode("div", _hoisted_30, [
                publisher.value.interest ? (openBlock(), createElementBlock("div", _hoisted_31, [
                  createVNode(_sfc_main$1, {
                    title: unref(__$1)("Interests", "google-analytics-dashboard-for-wp"),
                    ...
                    "ga-link-label": unref(__$1)("View Full Interests Report", "google-analytics-dashboard-for-wp"),
                    "empty-message": unref(__$1)("No interest groups detected for this time period.", "google-analytics-dashboard-for-wp")
                  }, null, 8, ["title", "rows", "compare-rows", "compare-date-labels", "ga-link", "ga-link-label", "empty-message"])
                ])) : createCommentVNode("", true),
                publisher.value.scroll ? (openBlock(), createElementBlock("div", _hoisted_32, [
                  createBaseVNode("h3", _hoisted_33, toDisplayString(unref(__$1)("Scroll", "google-analytics-dashboard-for-wp")), 1),
                  scrollErrorText.value ? (openBlock(), createElementBlock("div", _hoisted_34, toDisplayString(scrollErrorText.value), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    ...
                    createBaseVNode("div", _hoisted_36, toDisplayString(unref(__$1)("Average Scroll Depth", "google-analytics-dashboard-for-wp")), 1)
                  ], 64)),
                  createBaseVNode("p", {
                    class: "exactmetrics-publishers-report__scroll-explainer",
