...
const installWPConsent = async () => {
  try {
    ...
    throw {
      title: __("WPConsent installation failed", "google-analytics-dashboard-for-wp"),
...
const activateWPConsent = async () => {
  try {
    ...
    throw {
      title: __("WPConsent activation failed", "google-analytics-dashboard-for-wp"),
      message: error?.message || __("AJAX request failed", "google-analytics-dashboard-for-wp")
    };
  }
};
...
const _hoisted_1$1 = { class: "exactmetrics-userfeedback-logos" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [..._cache[0] || (_cache[0] = [
    ...
    createBaseVNode("div", { class: "exactmetrics-userfeedback-logos-item" }, [
      createBaseVNode("svg", {
...
const _hoisted_6 = { class: "exactmetrics-userfeedback-features exactmetrics-wpconsent-features" };
const _hoisted_7 = { class: "exactmetrics-wpconsent-screenshot" };
const _hoisted_8 = ["src"];
const _hoisted_9 = { class: "exactmetrics-userfeedback-features-list" };
const _hoisted_10 = ["textContent"];
const _hoisted_11 = { class: "exactmetrics-userfeedback-install-box-step" };
const _hoisted_12 = ["textContent"];
const _hoisted_13 = { class: "exactmetrics-userfeedback-install-box-info" };
...
const _hoisted_19 = { class: "exactmetrics-userfeedback-install-box-info" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const textInstallHeading = __2("Install & Activate WPConsent", "google-analytics-dashboard-for-wp");
    const textInstallDescription = __2(
      "Install WPConsent by clicking the button below.",
      "google-analytics-dashboard-for-wp"
    );
    const textInstallButton = __2("Install WPConsent", "google-analytics-dashboard-for-wp");
    const textActivateButton = __2("Activate WPConsent", "google-analytics-dashboard-for-wp");
    const textInstallingPlugin = __2("Installing WPConsent", "google-analytics-dashboard-for-wp");
    const textActivatingPlugin = __2("Activating WPConsent", "google-analytics-dashboard-for-wp");
    const textInstalledPlugin = __2("Installed & Active", "google-analytics-dashboard-for-wp");
    const textSetupHeading = __2("Set Up WPConsent", "google-analytics-dashboard-for-wp");
    const textSetupDescription = __2(
      "Run the WPConsent setup wizard to launch a fully functional cookie banner within minutes.",
      "google-analytics-dashboard-for-wp"
    );
    const textSetupButton = __2("Start Setup", "google-analytics-dashboard-for-wp");
    ...
    const firstStepClass = computed(() => {
      if (pluginInstalledAndActive.value) return "exactmetrics-inactive";
      if (loading.value) return "exactmetrics-loading";
      return "";
    });
    const secondStepClass = computed(
      () => pluginInstalledAndActive.value ? "" : "exactmetrics-inactive"
    );
