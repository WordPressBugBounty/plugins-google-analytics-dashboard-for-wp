...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const link = computed(() => {
      ...
      return getUrl("logo", "header", "https://www.exactmetrics.com/lite/");
    });
...
const markReadNotification = (id) => new Promise((resolve) => {
  const action = "exactmetrics_notification_mark_read";
  const ajaxData = {
    nonce: getMiGlobal("nonce", ""),
    id
  };
...
const saveNotification = (id) => new Promise((resolve, reject) => {
  const action = "exactmetrics_notification_save";
  const ajaxData = {
    nonce: getMiGlobal("nonce", ""),
    id
  };
  wp.ajax.post(action, ajaxData).done((response) => {
    ...
    let message = errorThrown || __("An error occurred while saving the notification.", "exactmetrics");
    if (jqXHR?.responseJSON?.message) {
      message = jqXHR.responseJSON.message;
    }
    reject({
      title: __("Save Notification Network Error", "exactmetrics"),
      message
    });
  });
});
const remindMeNotification = (id) => new Promise((resolve, reject) => {
  const action = "exactmetrics_notification_remind_me";
  const ajaxData = {
    nonce: getMiGlobal("nonce", ""),
    id
  };
  wp.ajax.post(action, ajaxData).done((response) => {
    ...
    let message = errorThrown || __("An error occurred while snoozing the notification.", "exactmetrics");
    if (jqXHR?.responseJSON?.message) {
      message = jqXHR.responseJSON.message;
    }
    reject({
      title: __("Remind Me Network Error", "exactmetrics"),
      message
    });
  });
});
...
const _sfc_main$6 = {
  ...
  props: {
     ...
     * is scoped under an app-root ancestor (e.g. `.exactmetrics-admin-page`) that a
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, {
        ...
        __props.open ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(["exactmetrics-drawer-overlay", __props.overlayClass]),
          onClick: _cache[0] || (_cache[0] = withModifiers(($event) => _ctx.$emit("close"), ["self"]))
        }, [
          createBaseVNode("div", {
            ref_key: "panelRef",
            ref: panelRef,
            class: normalizeClass(["exactmetrics-drawer", __props.panelClass]),
            role: "dialog",
            "aria-modal": "true",
...
const _hoisted_2$5 = { class: "exactmetrics-notificationsv3-notification-details" };
const _hoisted_3$2 = { class: "exactmetrics-notificationsv3-notification-title" };
...
const _hoisted_9$1 = { class: "exactmetrics-notificationsv3-notification-actions" };
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const text_remind_me = __2("Remind Me", "google-analytics-dashboard-for-wp");
    const text_dismiss = __2("Dismiss", "google-analytics-dashboard-for-wp");
    const text_read_more = __2("Read More", "google-analytics-dashboard-for-wp");
    ...
    const buttonClass = (type, index) => {
      return index === 0 ? "exactmetrics-notificationsv3-btn-primary" : "exactmetrics-notificationsv3-btn-secondary";
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-notificationsv3-single-notification", props.notification.read === false ? "exactmetrics-notificationsv3-single-notification-unread" : "exactmetrics-notificationsv3-single-notification-read"])
      }, [
        createBaseVNode("div", {
        ...
        createBaseVNode("div", _hoisted_2$5, [
          createBaseVNode("div", _hoisted_3$2, [
            ...
            createBaseVNode("button", {
              class: normalizeClass(["exactmetrics-notificationsv3-notification-save", __props.notification.saved ? "exactmetrics-notificationsv3-notification-save-active" : ""]),
              onClick: toggleSave
            }, [
          ...
          createBaseVNode("div", {
            class: normalizeClass(["exactmetrics-notificationsv3-notification-content", isExpanded.value ? "is-expanded" : ""])
          }, [
            createBaseVNode("div", {
              ref_key: "contentEl",
              ref: contentEl,
              class: "exactmetrics-notificationsv3-notification-content-text",
            ...
            isOverflowing.value && !isExpanded.value ? (openBlock(), createElementBlock("span", {
              key: 0,
              class: "exactmetrics-notificationsv3-notification-read-more",
          ...
          createBaseVNode("div", _hoisted_9$1, [
            __props.notification.has_remind_me ? (openBlock(), createElementBlock("button", {
              key: 0,
              class: "exactmetrics-button exactmetrics-notificationsv3-btn-primary exactmetrics-notificationsv3-btn-remind-me",
              onClick: remindMe
            }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.notification.btns, (button, button_type, index) => {
              return openBlock(), createElementBlock("a", {
                key: button_type,
                href: "#",
                class: normalizeClass(["exactmetrics-button", buttonClass(button_type, __props.notification.has_remind_me ? index + 1 : index)]),
...
const _hoisted_1$4 = { class: "exactmetrics-notificationsv3-no-notifications" };
...
const _hoisted_1$3 = { class: "exactmetrics-notificationsv3-sidebar-header" };
const _hoisted_2$3 = { class: "exactmetrics-notificationsv3-sidebar-header-title" };
const _hoisted_3$1 = ["textContent"];
const _hoisted_4 = {
  key: 0,
  class: "exactmetrics-notificationsv3-sidebar-header-count"
};
const _hoisted_5 = { class: "exactmetrics-notificationsv3-sidebar-header-actions" };
const _hoisted_6 = ["textContent"];
const _hoisted_7 = { class: "exactmetrics-notificationsv3-tabs" };
...
const _hoisted_14 = {
  key: 2,
  class: "exactmetrics-notificationsv3-sidebar-notifications exactmetrics-notificationsv3-notifications-saved"
};
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const text_mark_all_read = __2("Mark All Read", "google-analytics-dashboard-for-wp");
    const text_all = __2("All", "google-analytics-dashboard-for-wp");
    const text_archived = __2("Archived", "google-analytics-dashboard-for-wp");
    const text_saved = __2("Saved", "google-analytics-dashboard-for-wp");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$6, {
        open: __props.isOpen,
        "teleport-to": false,
        "overlay-class": "exactmetrics-notificationsv3-container",
        "panel-class": "exactmetrics-notificationsv3-sidebar exactmetrics-notificationsv3-sidebar-in",
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$3, [
            ...
            createBaseVNode("div", _hoisted_5, [
              unreadCount.value > 0 ? (openBlock(), createElementBlock("span", {
                key: 0,
                class: "exactmetrics-notificationsv3-mark-all-read",
                onClick: markAllRead,
          ...
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("button", {
              class: normalizeClass(["exactmetrics-notificationsv3-tab", activeTab.value === "all" ? "exactmetrics-notificationsv3-tab-active" : ""]),
              ...
              unreadCount.value > 0 ? (openBlock(), createElementBlock("span", {
                key: 0,
                class: "exactmetrics-notificationsv3-tab-badge",
                textContent: toDisplayString(unreadCount.value)
              }, null, 8, _hoisted_9)) : createCommentVNode("", true)
            ], 2),
            createBaseVNode("button", {
              class: normalizeClass(["exactmetrics-notificationsv3-tab", activeTab.value === "archived" ? "exactmetrics-notificationsv3-tab-active" : ""]),
            ...
            createBaseVNode("button", {
              class: normalizeClass(["exactmetrics-notificationsv3-tab", activeTab.value === "saved" ? "exactmetrics-notificationsv3-tab-active" : ""]),
...
const _hoisted_2$2 = { class: "exactmetrics-notificationsv3-inbox-button" };
...
const _hoisted_1$1 = {
  key: 0,
  class: "exactmetrics-floating-bar"
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const barLink = getExactMetricsUrl(
      "floatbar",
      "upgrade",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: "exactmetrics-slide" }, {
        default: withCtx(() => [
          __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
            createBaseVNode("span", {
              class: "exactmetrics-floating-bar-text",
              innerHTML: unref(barText)
            }, null, 8, _hoisted_2$1),
            createBaseVNode("button", {
              class: "exactmetrics-floating-bar-close",
...
const _hoisted_1 = { class: "exactmetrics-container exactmetrics-header-container" };
const _hoisted_2 = { class: "exactmetrics-float-right" };
const _sfc_main = {
  __name: "TheAppHeader",
  setup(__props) {
    const showFloatingBar = ref(false);
    const headerClass = computed(() => ({
      "exactmetrics-header": true,
      "exactmetrics-header-with-floating-bar": showFloatingBar.value
    }));
    async function fetchFloatbarStatus() {
      try {
        const response = await miAjax("exactmetrics_get_floatbar");
    ...
    async function dismissFloatingBar() {
      showFloatingBar.value = false;
      try {
        await miAjax("exactmetrics_hide_floatbar");
      } catch {
      }
    }
    onMounted(() => {
