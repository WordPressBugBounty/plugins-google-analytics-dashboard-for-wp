import { o as openBlock, E as createBlock, D as withCtx, i as normalizeClass, u as unref, aA as Ro, m as computed, K as renderSlot, c as createElementBlock, a as createBaseVNode, s as createCommentVNode, t as toDisplayString, q as purify } from "./toastStore-CjmlShHI.js";
...
const _sfc_main = {
  ...
  props: {
     ...
     *  - Gates → default to `.exactmetrics-app-surface` (each app root carries this
  ...
  setup(__props, { emit: __emit }) {
    ...
    const resolvedContentClass = computed(
      () => props.contentClass || `exactmetrics-${props.variant}-modal`
    );
    const resolvedOverlayClass = computed(
      () => props.overlayClass || `exactmetrics-${props.variant}-modal-overlay`
    );
    ...
    const resolvedTeleportTo = computed(
      () => props.teleportTo !== void 0 ? props.teleportTo : isGate.value ? ".exactmetrics-app-surface" : void 0
    );
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Ro), {
        ...
        class: normalizeClass([resolvedOverlayClass.value, { "exactmetrics-gate": isGate.value }]),
