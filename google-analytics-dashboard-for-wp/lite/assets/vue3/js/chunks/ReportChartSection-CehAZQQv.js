import { o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, i as normalizeClass, s as createCommentVNode, m as computed, C as watch, y as onMounted, J as onUnmounted, F as Fragment, f as renderList, E as createBlock, b as createVNode, u as unref, B as withModifiers } from "./toastStore-nTGs-rGm.js";
...
import { u as useSiteNotesStore, _ as _sfc_main$2 } from "./SiteNotes-DnnIBjkY.js";
import { b as formatNum, f as formatPct, a as formatCurr } from "./overviewTableFormatters-WylMWTgV.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { f as formatDateLabel } from "./useOverviewChartData-B58GYprm.js";
import { u as useChartColors } from "./useChartColors-DfB5TXg7.js";
const _hoisted_1$1 = { class: "exactmetrics-report-info-card__label" };
const _hoisted_2$1 = { class: "exactmetrics-report-info-card__value-wrap" };
const _hoisted_3$1 = { class: "exactmetrics-report-info-card__value" };
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-report-info-card", { "exactmetrics-report-info-card--highlighted": __props.highlighted }])
      }, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          ...
          __props.percentChange ? (openBlock(), createElementBlock("span", {
            key: 0,
            class: normalizeClass(["exactmetrics-report-info-card__change", __props.percentChange.positive ? "exactmetrics-report-info-card__change--positive" : "exactmetrics-report-info-card__change--negative"])
...
const _hoisted_1 = { class: "exactmetrics-overview-report-traffic-chart-section" };
const _hoisted_2 = {
  key: 0,
  class: "exactmetrics-overview-report-traffic-chart-tabs"
};
const _hoisted_3 = ["onClick"];
const _hoisted_4 = { class: "exactmetrics-overview-tab__label" };
const _hoisted_5 = {
  key: 1,
  class: "exactmetrics-overview-report-traffic-chart-heading"
};
const _hoisted_6 = { class: "exactmetrics-overview-report-traffic-chart-content" };
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-traffic-chart-key-metrics"
};
const _hoisted_8 = { class: "exactmetrics-traffic-chart-key-metrics__row" };
const _hoisted_9 = { class: "exactmetrics-traffic-chart-key-metrics__container" };
const _hoisted_10 = { class: "exactmetrics-overview-report-traffic-chart-wrapper" };
const _hoisted_11 = {
  key: 0,
...
const _hoisted_13 = { class: "exactmetrics-site-notes-toggle" };
const _hoisted_14 = {
  key: 3,
  ...
  setup(__props, { emit: __emit }) {
    ...
    function applySiteNoteAnnotations() {
      ...
      try {
        ...
        if (!baseEl) return;
        baseEl.querySelectorAll(".exactmetrics-site-note-icon").forEach((el) => el.remove());
        ...
        for (const annotation of annotations) {
          ...
          img.classList.add("exactmetrics-site-note-icon");
        ...
        __props.tabs.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.tabs, (tab) => {
            return openBlock(), createElementBlock("button", {
              key: tab.id,
              type: "button",
              class: normalizeClass(["exactmetrics-overview-tab", { "exactmetrics-overview-tab--active": __props.activeTab === tab.id }]),
