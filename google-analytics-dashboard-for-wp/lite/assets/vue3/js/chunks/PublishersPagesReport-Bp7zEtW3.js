import { a1 as storeToRefs, o as openBlock, E as createBlock, D as withCtx, u as unref, c as createElementBlock, t as toDisplayString, m as computed } from "./toastStore-CjmlShHI.js";
...
import { n as getUpgradeUrl, j as getMiGlobal } from "./ajax-Uw5S1uqk.js";
...
async function fetchEngagementPagesData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading pages report data", "google-analytics-dashboard-for-wp");
...
const _hoisted_1 = {
  key: 0,
  class: "exactmetrics-publishers-report__section-error"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function pageEntryToRow(entry, vals) {
      ...
      const pagePath = hasPath ? String(dimVal) : __$1("(not set)", "google-analytics-dashboard-for-wp");
    ...
    const columns = [
      { key: "pagePath", label: __$1("Page", "google-analytics-dashboard-for-wp"), sortable: true, linkKey: "pageUrl" },
      { key: "pageviews", label: __$1("Page Views", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "newSessions", label: __$1("New Sessions", "google-analytics-dashboard-for-wp"), sortable: true },
      ...
      { key: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    const gaAllPagesUrl = computed(() => {
      if (isBlocked.value) {
        return getUpgradeUrl("report", "engagement-pages", "https://www.exactmetrics.com/pricing/");
      }
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          unref(error) ? (openBlock(), createElementBlock("div", _hoisted_1, toDisplayString(unref(error)), 1)) : (openBlock(), createBlock(_sfc_main$1, {
            key: 1,
            title: unref(__$1)("Pages Report", "google-analytics-dashboard-for-wp"),
            columns,
            ...
            "ga-link-label": unref(__$1)("View All Pages", "google-analytics-dashboard-for-wp"),
            "empty-message": unref(__$1)("No data currently for the Pages report.", "google-analytics-dashboard-for-wp")
