...
import { b as fetchCartAbandonmentData } from "./ecommerceReports-D8kccHM9.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const productColumns = [
      ...
      { key: "cartAbandonment", label: __("Cart Abandonment", "google-analytics-dashboard-for-wp"), sortable: true, totalType: "average" },
      { key: "checkoutAbandonment", label: __("Checkout Abandonment", "google-analytics-dashboard-for-wp"), sortable: true, totalType: "average" }
    ];
    const dayColumns = [
      { key: "date", label: __("Date", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "quantity", label: __("Quantity", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "cartAbandonment", label: __("Cart Abandonment", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "checkoutAbandonment", label: __("Checkout Abandonment", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__)("Cart Abandonment", "google-analytics-dashboard-for-wp"),
            columns: productColumns,
            rows: productRows.value,
            "compare-rows": compareProductRows.value,
            "compare-date-labels": compareDateLabelsForTable.value,
            loading: unref(loading),
            "empty-message": unref(__)("No data currently for the Cart Abandonment report.", "google-analytics-dashboard-for-wp"),
            "required-addon": "ecommerce",
            "required-addon-name": "eCommerce"
          }, null, 8, ["title", "rows", "compare-rows", "compare-date-labels", "loading", "empty-message"]),
          createVNode(_sfc_main$1, {
            title: unref(__)("Cart Abandonment by Day", "google-analytics-dashboard-for-wp"),
            columns: dayColumns,
            rows: dayRows.value,
            "compare-rows": compareDayRows.value,
            "compare-date-labels": compareDateLabelsForTable.value,
            loading: unref(loading),
            "empty-message": unref(__)("No daily abandonment data available.", "google-analytics-dashboard-for-wp"),
            "required-addon": "ecommerce",
            "required-addon-name": "eCommerce"
          }, null, 8, ["title", "rows", "compare-rows", "compare-date-labels", "loading", "empty-message"])
        ]),
