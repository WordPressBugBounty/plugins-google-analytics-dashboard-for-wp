...
const _hoisted_1 = { class: "exactmetrics-overview-report-table exactmetrics-exceptions-report" };
...
const _hoisted_4 = { class: "exactmetrics-overview-report-table__header-right" };
const _hoisted_5 = { class: "exactmetrics-filter-modal__select-wrapper" };
const _hoisted_6 = ["value"];
const _hoisted_7 = { class: "exactmetrics-filter-modal__select-wrapper" };
const _hoisted_8 = ["value"];
const _hoisted_9 = { class: "exactmetrics-overview-report-table__table-wrapper" };
const _hoisted_10 = { class: "exactmetrics-overview-report-table__table" };
...
const _hoisted_16 = { class: "exactmetrics-exceptions-report__status-cell" };
const _hoisted_17 = {
  key: 0,
  class: "exactmetrics-exceptions-report__action-cell"
};
const _hoisted_18 = ["onClick"];
const _hoisted_19 = {
  key: 0,
  class: "exactmetrics-exceptions-report__pagination"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const statusOptions = [
      { value: "", label: __("Any", "google-analytics-dashboard-for-wp") },
      { value: "resolved", label: __("Once", "google-analytics-dashboard-for-wp") },
      { value: "unresolved", label: __("Recurring", "google-analytics-dashboard-for-wp") }
    ];
    const categoryOptions = [
      { value: "", label: __("All Categories", "google-analytics-dashboard-for-wp") },
      { value: "ecommerce", label: __("eCommerce", "google-analytics-dashboard-for-wp") },
      { value: "engagement", label: __("Engagement", "google-analytics-dashboard-for-wp") },
      { value: "marketing", label: __("Marketing", "google-analytics-dashboard-for-wp") },
      { value: "sources", label: __("Sources", "google-analytics-dashboard-for-wp") }
    ];
    ...
    async function fetchReport() {
      ...
      try {
        ...
        formData.set("action", "exactmetrics_exceptions_report");
    ...
    async function deleteException(exceptionId) {
      showLoadingModal({ title: __("Deleting Exception", "google-analytics-dashboard-for-wp") });
      try {
        const formData = new FormData();
        formData.set("action", "exactmetrics_exceptions_delete");
        formData.set("nonce", getNonce());
        ...
        closeModal();
        showErrorModal({ title: __("Error deleting exception.", "google-analytics-dashboard-for-wp") });
      }
    }
    watch(dateRange, () => {
      pageNumber.value = 1;
        ...
        table: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("h3", _hoisted_3, toDisplayString(unref(__)("Exceptions Report", "google-analytics-dashboard-for-wp")), 1),
              ...
              createBaseVNode("table", _hoisted_10, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    ...
                    createBaseVNode("th", null, toDisplayString(unref(__)("Time", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__)("Recurring", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__)("Description", "google-analytics-dashboard-for-wp")), 1),
                    !unref(isBlocked) ? (openBlock(), createElementBlock("th", _hoisted_11, toDisplayString(unref(__)("Action", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
                  ])
                ]),
                createBaseVNode("tbody", null, [
                  loading.value ? (openBlock(), createElementBlock("tr", _hoisted_12, [
                    ...
                    }, toDisplayString(unref(__)("No exceptions found for the selected date range.", "google-analytics-dashboard-for-wp")), 9, _hoisted_15)
                    ...
                    return openBlock(), createElementBlock("tr", {
                      ...
                      !unref(isBlocked) ? (openBlock(), createElementBlock("td", _hoisted_17, [
                        createBaseVNode("button", {
                          type: "button",
                          class: "exactmetrics-exceptions-report__delete-btn",
            ...
            pagination.value.pages > 1 ? (openBlock(), createElementBlock("div", _hoisted_19, [
              ...
              }, toDisplayString(unref(__)("Previous", "google-analytics-dashboard-for-wp")), 9, _hoisted_20),
              createBaseVNode("span", null, toDisplayString(unref(sprintf)(unref(__)("Page %1$d of %2$d", "google-analytics-dashboard-for-wp"), pageNumber.value, pagination.value.pages)), 1),
              createBaseVNode("button", {
                type: "button",
                disabled: pageNumber.value >= pagination.value.pages,
                onClick: _cache[3] || (_cache[3] = ($event) => goToPage(pageNumber.value + 1))
              }, toDisplayString(unref(__)("Next", "google-analytics-dashboard-for-wp")), 9, _hoisted_21)
            ])) : createCommentVNode("", true)
          ])
        ]),
        _: 1
