...
import { m } from "./vue3-apexcharts-ErQ4EB6K.js";
import { o as openBlock, c as createElementBlock, F as Fragment, a as createBaseVNode, b as createVNode, u as unref, f as renderList, n as normalizeStyle, t as toDisplayString, s as createCommentVNode, i as normalizeClass, m as computed } from "./toastStore-CjmlShHI.js";
const _hoisted_1 = { class: "exactmetrics-report-pie-chart__donut" };
const _hoisted_2 = {
  key: 0,
  class: "exactmetrics-report-pie-chart__cards"
};
const _hoisted_3 = { class: "exactmetrics-report-pie-chart__card-text" };
const _hoisted_4 = { class: "exactmetrics-report-pie-chart__card-label" };
const _hoisted_5 = { class: "exactmetrics-report-pie-chart__card-value" };
const _hoisted_6 = {
  key: 1,
...
const _sfc_main = {
  ...
  setup(__props) {
    const apexchart = m;
    const EM_COLORS = ["#6528F5", "#DC3FD6", "#9BE3EC", "#A78BFA", "#F9A8D4", "#67E8F9", "#34D399", "#F472B6"];
    const props = __props;
    ...
    const chartOptions = computed(() => ({
      ...
      tooltip: {
        ...
        custom({ series: series2, seriesIndex, w }) {
          ...
          return '<div class="exactmetrics-chart-tooltip"><div class="exactmetrics-chart-tooltip__row"><span class="exactmetrics-chart-tooltip__dot" style="background:' + color + '"></span><span class="exactmetrics-chart-tooltip__label">' + label + ': </span><span class="exactmetrics-chart-tooltip__value">' + value.toLocaleString() + " (" + pct + "%)</span></div></div>";
        }
      },
      legend: {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-report-pie-chart", { "exactmetrics-report-pie-chart--cards": __props.layout === "cards" }])
      }, [
          ...
          __props.layout === "cards" ? (openBlock(), createElementBlock("ul", _hoisted_2, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(chartLabels.value, (label, index) => {
              return openBlock(), createElementBlock("li", {
                key: index,
                class: "exactmetrics-report-pie-chart__card"
              }, [
                createBaseVNode("span", {
                  class: "exactmetrics-report-pie-chart__card-dot",
        ...
        ], 64)) : (openBlock(), createElementBlock("div", _hoisted_6, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ], 2);
    };
  }
};
