import { o as openBlock, c as createElementBlock, a as createBaseVNode, s as createCommentVNode, t as toDisplayString, u as unref, B as withModifiers, E as createBlock, w as withDirectives, v as vModelText, m as computed, j as ref } from "./toastStore-sH51RcCX.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_reset = __("Reset to default", "google-analytics-dashboard-for-wp");
    const updated_number_value = ref(false);
    const text_error_value = sprintf(__("Please enter a value between %1$s and %2$s", "google-analytics-dashboard-for-wp"), "<strong>" + props.min + "</strong>", "<strong>" + props.max + "</strong>");
    const text_error_has_min = sprintf(__("Please enter a value higher than %s", "google-analytics-dashboard-for-wp"), "<strong>" + props.min + "</strong>");
    const text_error_has_max = sprintf(__("Please enter a value lower than %s", "google-analytics-dashboard-for-wp"), "<strong>" + props.max + "</strong>");
    const text_error_generic = __("Please enter a number", "google-analytics-dashboard-for-wp");
    const text_error_round = __("Value has to be a round number", "google-analytics-dashboard-for-wp");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        __props.label ? (openBlock(), createElementBlock("label", {
          ...
          showReset.value ? (openBlock(), createElementBlock("a", {
            key: 1,
            class: "exactmetrics-reset-default",
            href: "#",
        ...
        createBaseVNode("div", _hoisted_5, [
          ...
          __props.inline_desc ? (openBlock(), createElementBlock("span", {
            key: 0,
            class: "exactmetrics-inline-desc",
