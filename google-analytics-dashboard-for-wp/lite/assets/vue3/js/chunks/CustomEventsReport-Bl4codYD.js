...
async function fetchCustomEventsReportData(dateRange, apiFilters = null) {
  ...
  const errorLabel = __("Error loading custom events report data", "google-analytics-dashboard-for-wp");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const columns = [
      { key: "event_name", label: __$1("Event Name", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "event_count", label: __$1("Event Count", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "engaged_sessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), sortable: true },
      {
        key: "key_event",
        label: __$1("Key event", "google-analytics-dashboard-for-wp"),
        sortable: false,
        compare: false,
        iconKey: "key_event_icon",
        excludeFromTotals: true,
        headerClass: "exactmetrics-overview-report-table__th--key-event exactmetrics-report-table-modal__th--key-event",
        cellClass: "exactmetrics-overview-report-table__td--key-event exactmetrics-report-table-modal__td--key-event"
      }
    ];
      ...
      return openBlock(), createBlock(ReportPageLayout, {
        ...
        table: withCtx(() => [
          createVNode(_sfc_main$1, {
            title: unref(__$1)("Custom Events Report", "google-analytics-dashboard-for-wp"),
            columns,
            ...
            "empty-message": unref(__$1)("No custom events for this period.", "google-analytics-dashboard-for-wp")
