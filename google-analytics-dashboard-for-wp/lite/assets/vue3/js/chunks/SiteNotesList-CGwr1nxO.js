import { y as onMounted, C as watch, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, w as withDirectives, P as vModelSelect, F as Fragment, f as renderList, s as createCommentVNode, i as normalizeClass, v as vModelText, G as withKeys, A as createTextVNode, j as ref, L as reactive, m as computed, B as withModifiers, aF as vModelCheckbox, K as renderSlot, a3 as useSlots, E as createBlock, D as withCtx, u as unref, b as createVNode, az as getUpgradeUrl, k as getMiGlobal, Z as isPro$1 } from "./toastStore-sH51RcCX.js";
import { _ as _sfc_main$a } from "./SettingsBlock-C5coD8IO.js";
import { q as sanitizeHtml, k as isPro } from "./ajax-2wfIeviZ.js";
import { C as Component } from "./flatpickr-DYNmg7pa.js";
import { g as getCategories, s as saveNote, a as getNotes, t as trashNotes, r as restoreNotes, d as deleteNotes, e as exportNotes, i as importNotes } from "./siteNotes-Dr3kC5XC.js";
import { a as useToast } from "./addons-CsEzvEzl.js";
...
const _sfc_main$9 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const texts = {
      selectBulkAction: __("Select bulk action", "google-analytics-dashboard-for-wp"),
      bulkActions: __("Bulk Actions", "google-analytics-dashboard-for-wp"),
      apply: __("Apply", "google-analytics-dashboard-for-wp"),
      currentPage: __("Current Page", "google-analytics-dashboard-for-wp"),
      firstPage: __("First Page", "google-analytics-dashboard-for-wp"),
      prevPage: __("Previous Page", "google-analytics-dashboard-for-wp"),
      nextPage: __("Next Page", "google-analytics-dashboard-for-wp"),
      lastPage: __("Last Page", "google-analytics-dashboard-for-wp"),
      of: __("of", "google-analytics-dashboard-for-wp"),
      search_placeholder: __("Search..", "google-analytics-dashboard-for-wp")
    };
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    const texts = {
      selectAll: __("Select All", "google-analytics-dashboard-for-wp"),
      actions: __("Actions", "google-analytics-dashboard-for-wp")
    };
...
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const texts = computed(() => ({
      selectItem: sprintf(__("Select %s", "google-analytics-dashboard-for-wp"), rowTitle.value)
    }));
  ...
  setup(__props, { emit: __emit }) {
    ...
    const config = {
      ...
      onReady: (_selectedDates, _dateStr, instance) => {
        instance.calendarContainer.classList.add("exactmetrics-site-note-calendar");
      }
    };
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Component), {
        ...
        config,
        class: "exactmetrics-site-notes-datepicker"
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    const texts = {
      note_medias: __("Media", "google-analytics-dashboard-for-wp"),
      uploadImage: __("Select Media", "google-analytics-dashboard-for-wp"),
      chooseAnother: __("Change Media", "google-analytics-dashboard-for-wp")
    };
    ...
    function uploadImage() {
      ...
      const fileFrame = window.wp.media({
        title: __("Select or upload image", "google-analytics-dashboard-for-wp"),
        button: { text: __("Set Image", "google-analytics-dashboard-for-wp") },
        multiple: false
      }).on("select", () => {
          ...
          createBaseVNode("div", null, [
            !hasValue.value ? (openBlock(), createElementBlock("div", _hoisted_4$3, [
              createBaseVNode("div", _hoisted_5$3, [
                createBaseVNode("a", {
                  href: "#",
                  class: "exactmetrics-upload-button",
...
const _hoisted_1$2 = { class: "exactmetrics-site-notes-create-form" };
const _hoisted_2$2 = {
  key: 0,
  class: "exactmetrics-loader is-inline"
};
const _hoisted_3$2 = { class: "exactmetrics-site-notes-create__table-item" };
const _hoisted_4$2 = ["textContent"];
const _hoisted_5$2 = { class: "settings-input exactmetrics-site-notes-create__table-item-note" };
const _hoisted_6$2 = ["placeholder"];
const _hoisted_7$2 = { class: "exactmetrics-flex-container" };
const _hoisted_8$1 = { class: "exactmetrics-site-notes-create__table-item" };
const _hoisted_9$1 = ["textContent"];
const _hoisted_10$1 = { class: "settings-input" };
const _hoisted_11$1 = { class: "exactmetrics-site-notes-create__table-item" };
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const texts = {
      note_date: __("Date", "google-analytics-dashboard-for-wp"),
      note_title: __("Your Note", "google-analytics-dashboard-for-wp"),
      note_category: __("Category", "google-analytics-dashboard-for-wp"),
      note_category_select: __("Select Category", "google-analytics-dashboard-for-wp"),
      save_changes: __("Add Site Note", "google-analytics-dashboard-for-wp"),
      save_changes_update: __("Save Changes", "google-analytics-dashboard-for-wp"),
      cancel: __("Cancel", "google-analytics-dashboard-for-wp"),
      title: __("Title", "google-analytics-dashboard-for-wp")
    };
    ...
    const starClasses = computed(() => {
      return "exactmetrics-star" + (!localNote.value.important ? "-empty" : "");
    });
    ...
    function saveNote$1() {
      ...
      saveNote(localNote.value).then((result) => {
        if (result?.published) {
          successToast({
            title: localNote.value.id ? __("Site note is updated successfully.", "google-analytics-dashboard-for-wp") : __("Site note is added successfully.", "google-analytics-dashboard-for-wp")
          });
          emit("site-note-save-success", isEdit.value, localNote.value);
        } else {
          errorToast({
            title: result?.message || __("Could not save site note", "google-analytics-dashboard-for-wp"),
            text: __("Please add some information into your site notes.", "google-analytics-dashboard-for-wp")
          });
        }
      }).catch((error) => {
        errorToast({
          title: error?.title || error?.message || __("Could not save site note", "google-analytics-dashboard-for-wp"),
          text: error?.message
        });
      }).finally(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        ...
        createBaseVNode("div", {
          class: normalizeClass(["exactmetrics-site-notes-create__table", isSaving.value ? "loading" : ""])
        }, [
          ...
          createBaseVNode("div", _hoisted_7$2, [
            ...
            createVNode(_sfc_main$3, {
              ...
              "class-names": "exactmetrics-site-notes-create__table-item"
            }, null, 8, ["modelValue"])
          ])
        ], 2),
        createBaseVNode("div", {
          class: normalizeClass(["exactmetrics-site-notes-create__button", isSaving.value ? "loading" : ""])
        }, [
          createBaseVNode("div", null, [
...
const _hoisted_1$1 = {
  key: 0,
  class: "exactmetrics-import-upsell-popup"
};
const _hoisted_2$1 = { class: "exactmetrics-import-upsell-popup-inner" };
const _hoisted_3$1 = ["aria-label"];
const _hoisted_4$1 = ["textContent"];
const _hoisted_5$1 = ["textContent"];
const _hoisted_6$1 = { class: "exactmetrics-popup-buttons" };
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const texts = {
      title: __("Upgrade to Pro", "google-analytics-dashboard-for-wp"),
      message: __("Upgrade to PRO to easily import your site notes from Google Analytics.", "google-analytics-dashboard-for-wp"),
      upgrade: __("Upgrade", "google-analytics-dashboard-for-wp"),
      close: __("Close", "google-analytics-dashboard-for-wp")
    };
    function onClose() {
      emit("close");
    }
    return (_ctx, _cache) => {
      return __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("button", {
            class: "exactmetrics-popup-close",
...
const _hoisted_1 = { class: "exactmetrics-site-notes-wrapper" };
const _hoisted_2 = { class: "exactmetrics-site-notes-list__table" };
const _hoisted_3 = { class: "exactmetrics-site-notes-list__table-create" };
const _hoisted_4 = ["textContent"];
const _hoisted_5 = { class: "exactmetrics-site-notes-list__table-create-link-wrapper" };
const _hoisted_6 = {
  key: 0,
  class: "exactmetrics-site-notes-list__table-create-link"
};
const _hoisted_7 = ["textContent"];
const _hoisted_8 = { class: "exactmetrics-site-notes-list__table-create-link--export" };
const _hoisted_9 = {
  key: 0,
  class: "exactmetrics-loader is-inline"
};
const _hoisted_10 = {
  class: "exactmetrics-import-button-wrapper",
  style: { "position": "relative", "display": "inline-block" }
};
const _hoisted_11 = {
  key: 0,
  class: "exactmetrics-site-notes-list__table-create-form"
};
const _hoisted_12 = {
  key: 0,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const pro = isPro$1();
    const { successToast, errorToast } = useToast();
    const text_site_notes = __("Site Notes", "google-analytics-dashboard-for-wp");
    const text_empty_notes = __("There aren’t any site notes. Go ahead and create one!", "google-analytics-dashboard-for-wp");
    const text_filter_category = __("All Categories", "google-analytics-dashboard-for-wp");
    const text_add_new = __("Add Site Note", "google-analytics-dashboard-for-wp");
    const text_add_new_description = __("Keep track of important website events with Site Notes. Site Notes can help you track and monitor changes to your website traffic, clicks, or conversion rates over a period of time.", "google-analytics-dashboard-for-wp");
    const text_edit_title = __("Edit Site Note", "google-analytics-dashboard-for-wp");
    ...
    function starClasses(item) {
      return "exactmetrics-star" + (!item.important ? "-empty" : "");
    }
    function getStarAriaLabel(item) {
      return item.important ? __("Remove from important", "google-analytics-dashboard-for-wp") : __("Mark as important", "google-analytics-dashboard-for-wp");
    }
    ...
    function restoreSelectedNotes(noteIds) {
      ...
      restoreNotes(ids).then((result) => {
        if (result?.success) {
          successToast({ title: __("Restored successfully.", "google-analytics-dashboard-for-wp") });
          maybeResetFilters(ids.length);
          fetchNotes();
        } else {
          errorToast({ title: result?.message || __("Could not restore notes", "google-analytics-dashboard-for-wp") });
        }
      }).catch((error) => errorToast({ title: error?.message || __("Could not restore notes", "google-analytics-dashboard-for-wp") })).finally(() => {
    ...
    function trashSelectedNotes(noteIds) {
      ...
      trashNotes(ids).then((result) => {
        if (result?.success) {
          successToast({ title: __("Trashed successfully.", "google-analytics-dashboard-for-wp") });
          maybeResetFilters(ids.length);
          fetchNotes();
        } else {
          errorToast({ title: result?.message || __("Could not trash notes", "google-analytics-dashboard-for-wp") });
        }
      }).catch((error) => errorToast({ title: error?.message || __("Could not trash notes", "google-analytics-dashboard-for-wp") })).finally(() => {
        deletingIds.value = [];
      });
    }
    function deleteSelectedNotes(noteIds) {
      ...
      deleteNotes(ids).then((result) => {
        if (result?.success) {
          successToast({ title: __("Deleted successfully.", "google-analytics-dashboard-for-wp") });
          maybeResetFilters(ids.length);
          fetchNotes();
        } else {
          errorToast({ title: result?.message || __("Could not delete notes", "google-analytics-dashboard-for-wp") });
        }
      }).catch((error) => errorToast({ title: error?.message || __("Could not delete notes", "google-analytics-dashboard-for-wp") })).finally(() => {
        deletingIds.value = [];
      });
    }
    ...
    function runExportNotes() {
      ...
      if (allNotes.length === 0) {
        errorToast({ title: __("No notes to export.", "google-analytics-dashboard-for-wp") });
        return;
      }
    ...
    const tableColumns = computed(() => {
      const columns = [
        {
          title: __("Site Note", "google-analytics-dashboard-for-wp"),
          key: "note_title",
          sortable: true,
          isRowTitle: true
        },
        {
          title: __("Author", "google-analytics-dashboard-for-wp"),
          key: "author",
          value: (note) => note.author ? note.author.name : "-",
          sortable: true
        },
        {
          title: __("Created", "google-analytics-dashboard-for-wp"),
          key: "note_date",
          sortable: true
        },
        {
          title: __("Category", "google-analytics-dashboard-for-wp"),
          key: "category",
          sortable: true,
          value: (note) => {
            if (!note.category || !note.category.name) return "";
            if (note.category.background_color) {
              return '<span class="exactmetrics-category-with-bg" style="background-color: ' + note.category.background_color + ';">' + note.category.name + "</span>";
            }
            return '<span class="exactmetrics-category-without-bg">' + note.category.name + "</span>";
          }
        }
      ];
      return columns;
    ...
    const rowActions = computed(() => [
      {
        label: __("Edit", "google-analytics-dashboard-for-wp"),
        path: "edit",
      ...
      {
        path: "trash",
        label: __("Trash", "google-analytics-dashboard-for-wp"),
        handle: trashSelectedNotes,
        hide: (note) => note.status === "trash" || note.id === selectedItemID.value
      },
      {
        path: "restore",
        label: __("Restore", "google-analytics-dashboard-for-wp"),
        handle: restoreSelectedNotes,
        hide: (note) => note.status === "publish"
      },
      {
        path: "delete",
        label: __("Delete Permanently", "google-analytics-dashboard-for-wp"),
    ...
    const tableBulkActions = computed(() => {
      if (currentQuickFilter.value === "status:trash") {
        return [
          { label: __("Restore", "google-analytics-dashboard-for-wp"), value: "restore", handle: restoreSelectedNotes },
          { label: __("Delete Permanently", "google-analytics-dashboard-for-wp"), value: "delete", handle: deleteSelectedNotes }
        ];
      }
      return [
        { label: __("Trash", "google-analytics-dashboard-for-wp"), value: "trash", handle: trashSelectedNotes }
      ];
    });
    ...
    const quickFilters = computed(() => {
      ...
      const getStatusLabel = (status) => {
        switch (status) {
          case "all":
            return __("All", "google-analytics-dashboard-for-wp");
          case "draft":
            return __("Draft", "google-analytics-dashboard-for-wp");
          case "trash":
            return __("Trash", "google-analytics-dashboard-for-wp");
          default:
            return status;
        }
      };
          ...
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("div", _hoisted_3, [
                createBaseVNode("div", {
                  class: "exactmetrics-site-notes-list__table-create-text",
              ...
              createVNode(_sfc_main$5, {
                ...
                "table-loading": withCtx(() => [..._cache[4] || (_cache[4] = [
                  createBaseVNode("div", { class: "exactmetrics-loader" }, null, -1)
                ])]),
                "table-empty": withCtx(() => [
                  createBaseVNode("div", {
