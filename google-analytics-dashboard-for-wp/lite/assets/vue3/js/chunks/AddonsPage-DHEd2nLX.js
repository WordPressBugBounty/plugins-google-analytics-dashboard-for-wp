...
import { o as openBlock, c as createElementBlock, a as createBaseVNode, i as normalizeClass, t as toDisplayString, w as withDirectives, aF as vModelCheckbox, s as createCommentVNode, u as unref, B as withModifiers, m as computed, j as ref, a1 as storeToRefs, E as createBlock, D as withCtx, aS as isRef, v as vModelText, aT as vModelRadio, A as createTextVNode, y as onMounted, F as Fragment, f as renderList, b as createVNode } from "./toastStore-nTGs-rGm.js";
import { c as useAddonsStore, a as useToast, d as useDialog } from "./addons-lB_nbVC5.js";
import { u as useLicenseStore } from "./license-k2H2_IPt.js";
import { n as getUpgradeUrl, k as isPro } from "./ajax-BSXoXmkG.js";
import { _ as _sfc_main$3 } from "./Modal-BA3yRruc.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./useNotices-CjxoPqYP.js";
const _hoisted_1$2 = ["id"];
const _hoisted_2$2 = { class: "exactmetrics-addon-top" };
const _hoisted_3$2 = { class: "exactmetrics-addon-image" };
const _hoisted_4$2 = {
  key: 0,
  class: "icon"
};
...
const _hoisted_8$2 = { class: "exactmetrics-addon-text" };
const _hoisted_9$2 = { class: "exactmetrics-addon-title" };
const _hoisted_10$2 = ["href", "textContent"];
const _hoisted_11$2 = {
  key: 0,
  class: "exactmetrics-settings-input-checkbox"
};
const _hoisted_12$2 = {
  key: 0,
  class: "exactmetrics-addon-excerpt-row"
};
const _hoisted_13$2 = ["textContent"];
const _hoisted_14$2 = { class: "exactmetrics-interior" };
const _hoisted_15$2 = ["textContent"];
const _hoisted_16$2 = { class: "exactmetrics-addon-action" };
  ...
  setup(__props) {
    ...
    const actionsClass = computed(() => {
      ...
      if (props.addon.type === "licensed") {
        if (props.addon.active) cls += "exactmetrics-addon-active";
        else if (props.addon.installed === false)
          cls += "exactmetrics-addon-not-installed";
        else cls += "exactmetrics-addon-inactive";
      } else {
    ...
    const textButtonAction = computed(() => {
      ...
      if (activating.value)
        return __("Activating...", "google-analytics-dashboard-for-wp");
      if (deactivating.value)
        return __("Deactivating...", "google-analytics-dashboard-for-wp");
      if (installing.value)
        return __("Installing...", "google-analytics-dashboard-for-wp");
      if (props.addon.active)
        return __("Deactivate", "google-analytics-dashboard-for-wp");
      if (props.addon.installed)
        return __("Activate", "google-analytics-dashboard-for-wp");
      if (props.addon.redirect)
        return __("Visit Website", "google-analytics-dashboard-for-wp");
      return __("Download & Activate", "google-analytics-dashboard-for-wp");
    });
    ...
    async function activate() {
      ...
      try {
        ...
        errorToast({
          title: e?.title || __("Could not activate addon", "google-analytics-dashboard-for-wp"),
          text: e?.message || ""
        });
      } finally {
    ...
    async function deactivate() {
      ...
      savingToast({
        title: __("Deactivating Addon", "google-analytics-dashboard-for-wp")
      });
      try {
        await addonsStore.deactivateAddonAction(props.addon);
        successToast({
          title: __("Addon Deactivated", "google-analytics-dashboard-for-wp")
        });
      } catch (e) {
        errorToast({
          title: e?.title || __("Could not deactivate addon", "google-analytics-dashboard-for-wp"),
          text: e?.message || ""
        });
      } finally {
    ...
    function onVisibilityChange() {
      ...
      let html = sprintf(
        ...
        sprintf(
          ...
          '<a href="https://www.exactmetrics.com/contact/" target="_blank">',
          "</a>"
        )
      );
      html += sprintf(
        ...
        sprintf(
          ...
          __(
            "After purchasing a license, %1$sjust enter your license key on the ExactMetrics Settings page%2$s. This will let your site automatically upgrade to ExactMetrics Pro! (Don't worry, all your reports and settings will be preserved.)",
            "google-analytics-dashboard-for-wp"
          ),
          "<strong>",
          "</strong>"
      ...
      html += sprintf(
        ...
        sprintf(
          ...
          '<a href="https://www.exactmetrics.com/docs/go-lite-pro/" target="_blank">',
          "</a>"
        )
      );
      dialog.alert({
        variant: "info",
        title: __(
          "Thanks for your interest in ExactMetrics Pro!",
          "google-analytics-dashboard-for-wp"
        ),
        html
      });
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_2$2, [
          createBaseVNode("div", _hoisted_3$2, [
            __props.addon.svg_icon_path ? (openBlock(), createElementBlock("div", _hoisted_4$2, [
              ...
              key: 2,
              class: normalizeClass(["exactmetrics-bg-img", `exactmetrics-addon-${__props.addon.slug}`])
            }, null, 2))
          ]),
            ...
            createBaseVNode("label", null, [
              createBaseVNode("span", {
                class: normalizeClass({
                  "exactmetrics-styled-checkbox": true,
                  "exactmetrics-styled-checkbox-checked": __props.addon.active
                })
              }, null, 2),
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_14$2, [
            createBaseVNode("p", {
              class: "exactmetrics-addon-badge",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const text_form_title = __("Connection Information", "google-analytics-dashboard-for-wp");
    const text_form_description = __(
      "To perform the requested action, WordPress needs to access your web server. Please enter your FTP credentials to proceed. If you do not remember your credentials, you should contact your web host.",
      "google-analytics-dashboard-for-wp"
    );
    const text_hostname_label = __("Hostname", "google-analytics-dashboard-for-wp");
    const text_username_label = __("FTP Username", "google-analytics-dashboard-for-wp");
    const text_password_label = __("FTP Password", "google-analytics-dashboard-for-wp");
    const text_password_description = __(
      "This password will not be stored on the server.",
      "google-analytics-dashboard-for-wp"
    );
    const text_connection_type_label = __("Connection Type", "google-analytics-dashboard-for-wp");
    const text_button_cancel = __("Cancel", "google-analytics-dashboard-for-wp");
    const text_button_proceed = __("Proceed", "google-analytics-dashboard-for-wp");
...
const _hoisted_2 = { class: "exactmetrics-addons-area" };
const _hoisted_3 = {
  key: 0,
  class: "exactmetrics-addons-list"
};
const _hoisted_4 = {
  key: 1,
  class: "exactmetrics-notice exactmetrics-notice-warning"
};
const _hoisted_5 = { class: "exactmetrics-notice-inner" };
...
const _hoisted_9 = {
  key: 2,
  class: "exactmetrics-addons-upsell"
};
...
const _hoisted_16 = { class: "exactmetrics-addons-upsell-action" };
...
const _hoisted_21 = {
  key: 0,
  class: "exactmetrics-addons-no-results"
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_no_addons_found = __("No addons found.", "google-analytics-dashboard-for-wp");
    const text_refresh_addons = __("Refresh Addons", "google-analytics-dashboard-for-wp");
    ...
    const text_upsell_list_2 = __("eCommerce Reporting", "google-analytics-dashboard-for-wp");
    ...
    const text_save_50 = __("Save 50%", "google-analytics-dashboard-for-wp");
    const text_upgrade_now = __("Upgrade Now", "google-analytics-dashboard-for-wp");
    ...
    async function refreshAddons() {
      loadingToast(__("Refreshing Addons", "google-analytics-dashboard-for-wp"));
      try {
    ...
    async function processAdsAddonDeactivation() {
      loadingToast(__("Deactivating Ads Addon", "google-analytics-dashboard-for-wp"));
      await addonsStore.deactivateAddonAction({
        basename: "exactmetrics-ads/exactmetrics-ads.php",
        slug: "ads"
      });
      ...
      const poll = async () => {
        if (addonsStore.addons?.["ppc-tracking"]) {
          ...
          loadingToast(
            __("Installing PPC Tracking Addon", "google-analytics-dashboard-for-wp")
          );
          try {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", {
        id: "exactmetrics-addons",
        class: "exactmetrics-addons exactmetrics-container",
        ...
        createBaseVNode("div", _hoisted_2, [
          unref(isFilterMode) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            unref(filteredAddons).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_3, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(filteredAddons), (addon, index) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  class: "exactmetrics-addon-column"
                }, [
            ...
            createBaseVNode("h2", {
              class: "exactmetrics-addons-heading",
          ...
          !unref(isProVersion) ? (openBlock(), createElementBlock("section", _hoisted_9, [
            createBaseVNode("h2", {
              class: "exactmetrics-addons-upsell-heading",
            ...
            createBaseVNode("div", _hoisted_16, [
              createBaseVNode("div", {
                class: "exactmetrics-addons-upsell-action-offer",
