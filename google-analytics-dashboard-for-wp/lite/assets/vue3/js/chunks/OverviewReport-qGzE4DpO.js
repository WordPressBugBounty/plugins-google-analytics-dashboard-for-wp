...
const _hoisted_1$7 = { class: "exactmetrics-traffic-chart-metrics-dropdown__grid" };
const _hoisted_2$7 = ["onClick"];
const _hoisted_3$7 = { class: "exactmetrics-traffic-chart-metrics-dropdown__checkbox" };
const _sfc_main$9 = {
...
const _hoisted_2$6 = { class: "exactmetrics-ecommerce-upsell-overlay__content" };
const _hoisted_3$6 = { class: "exactmetrics-ecommerce-upsell-overlay__text-section" };
const _hoisted_4$6 = { class: "exactmetrics-ecommerce-upsell-overlay__title" };
const _hoisted_5$5 = { class: "exactmetrics-ecommerce-upsell-overlay__integrations" };
const _hoisted_6$5 = ["src", "alt"];
const _hoisted_7$5 = { class: "exactmetrics-ecommerce-upsell-overlay__description" };
const _hoisted_8$5 = { class: "exactmetrics-ecommerce-upsell-overlay__actions" };
const _hoisted_9$4 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon" };
const _hoisted_10$3 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon-label" };
const _hoisted_11$3 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon-code" };
const _hoisted_12$3 = {
  key: 0,
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    const upsellText = {
      title: __("Upgrade to ExactMetrics Pro to Unlock More Actionable Insights", "google-analytics-dashboard-for-wp"),
      titleLine2: __("& Save 50% OFF!", "google-analytics-dashboard-for-wp"),
      description: __("It's easy to double your traffic and sales when you know exactly how people find and use your website. ExactMetrics Pro shows you the stats that matter!", "google-analytics-dashboard-for-wp"),
      couponLabel: __("SAVE 50% Coupon Code", "google-analytics-dashboard-for-wp"),
      upgradeToPro: __("Upgrade to Pro", "google-analytics-dashboard-for-wp")
    };
    const copiedLabel = __("Copied!", "google-analytics-dashboard-for-wp");
...
const METRIC_DISPLAY_CONFIG = {
  totalUsers: { label: __("Total Users", "google-analytics-dashboard-for-wp"), type: "number", key: "totalUsers" },
  newUsers: { label: __("New Users", "google-analytics-dashboard-for-wp"), type: "number", key: "newUsers" },
  returningUsers: { label: __("Returning Users", "google-analytics-dashboard-for-wp"), type: "number", key: "returningUsers" },
  engagementRate: { label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "engagementRate" },
  pageViewsPerUser: { label: __("Pageviews / User", "google-analytics-dashboard-for-wp"), type: "decimal", key: "pageViewsPerUser" },
  bounceRate: { label: __("Bounce Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "bounceRate" },
  ecommercePurchases: { label: __("Purchases", "google-analytics-dashboard-for-wp"), type: "number", key: "ecommercePurchases" },
  totalRevenue: { label: __("Revenue", "google-analytics-dashboard-for-wp"), type: "currency", key: "totalRevenue" },
  averagePurchaseRevenue: { label: __("Average Order Value", "google-analytics-dashboard-for-wp"), type: "currency", key: "averagePurchaseRevenue" },
  averageSessionDuration: { label: __("Session Duration", "google-analytics-dashboard-for-wp"), type: "duration", key: "averageSessionDuration" },
  sessions: { label: __("Sessions", "google-analytics-dashboard-for-wp"), type: "number", key: "sessions" },
  engagedSessions: { label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), type: "number", key: "engagedSessions" },
  sessionKeyEventRate: { label: __("Key Event Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "sessionKeyEventRate" },
  screenPageViews: { label: __("Page Views", "google-analytics-dashboard-for-wp"), type: "number", key: "screenPageViews" },
  itemsPurchased: { label: __("Items Purchased", "google-analytics-dashboard-for-wp"), type: "number", key: "ecommercePurchases" },
  couponUsedPercent: { label: __("Coupon Used %", "google-analytics-dashboard-for-wp"), type: "percent", key: "couponUsedPercent" },
  cartAbandonRatePercent: { label: __("Cart Abandon Rate %", "google-analytics-dashboard-for-wp"), type: "percent", key: "cartAbandonRatePercent" }
};
...
function getMetricsForTab(tabId, metrics = {}) {
  const tabMetrics = {
    traffic: [
      { id: "totalUsers", label: __("Total Users", "google-analytics-dashboard-for-wp"), value: metrics.totalUsers || 0, type: "number" },
      { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), value: metrics.newUsers || 0, type: "number" },
      { id: "returningUsers", label: __("Returning Users", "google-analytics-dashboard-for-wp"), value: metrics.returningUsers || 0, type: "number" },
      { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), value: metrics.engagementRate || 0, type: "percent" }
    ],
    engagement: [
      { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), value: metrics.sessions || 0, type: "number" },
      { id: "pageViews", label: __("Page Views", "google-analytics-dashboard-for-wp"), value: metrics.pageViews || 0, type: "number" },
      { id: "avgSessionDuration", label: __("Avg. Session Duration", "google-analytics-dashboard-for-wp"), value: metrics.avgSessionDuration || 0, type: "duration" },
      { id: "bounceRate", label: __("Bounce Rate", "google-analytics-dashboard-for-wp"), value: metrics.bounceRate || 0, type: "percent" }
    ],
    referrals: [
      { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), value: metrics.sessions || 0, type: "number" },
      { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), value: metrics.engagedSessions || 0, type: "number" },
      { id: "sessionKeyEventRate", label: __("Session Key Event Rate", "google-analytics-dashboard-for-wp"), value: metrics.sessionKeyEventRate || 0, type: "percent" }
    ],
    ecommerce: [
      { id: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp"), value: metrics.revenue || 0, type: "currency" },
      { id: "transactions", label: __("Transactions", "google-analytics-dashboard-for-wp"), value: metrics.transactions || 0, type: "number" },
      { id: "avgOrderValue", label: __("Avg. Order Value", "google-analytics-dashboard-for-wp"), value: metrics.avgOrderValue || 0, type: "currency" },
      { id: "conversionRate", label: __("Conversion Rate", "google-analytics-dashboard-for-wp"), value: metrics.conversionRate || 0, type: "percent" }
    ]
  };
...
const _hoisted_1$5 = { class: "exactmetrics-overview-report-traffic-chart-section" };
const _hoisted_2$5 = { class: "exactmetrics-overview-report-traffic-chart-tabs" };
const _hoisted_3$5 = ["onClick"];
const _hoisted_4$5 = { class: "exactmetrics-overview-tab__label" };
const _hoisted_5$4 = { class: "exactmetrics-traffic-chart-key-metrics" };
const _hoisted_6$4 = { class: "exactmetrics-traffic-chart-key-metrics__row" };
const _hoisted_7$4 = { class: "exactmetrics-traffic-chart-key-metrics__container" };
const _hoisted_8$4 = { class: "exactmetrics-overview-metric__label" };
const _hoisted_9$3 = { class: "exactmetrics-overview-metric__value-wrap" };
const _hoisted_10$2 = { class: "exactmetrics-overview-metric__value" };
const _hoisted_11$2 = {
  key: 1,
...
const _hoisted_13$2 = { class: "exactmetrics-traffic-chart-key-metrics__container exactmetrics-traffic-chart-key-metrics__container--previous" };
const _hoisted_14$2 = { class: "exactmetrics-overview-metric__label" };
const _hoisted_15$2 = { class: "exactmetrics-overview-metric__value-wrap" };
const _hoisted_16$2 = { class: "exactmetrics-overview-metric__value" };
const _hoisted_17$2 = {
  key: 0,
  class: "exactmetrics-overview-metric__date-range"
};
const _hoisted_18$2 = { class: "exactmetrics-traffic-chart-legends" };
const _hoisted_19$2 = { class: "exactmetrics-traffic-chart-legend__label" };
const _hoisted_20$2 = { class: "exactmetrics-overview-report-traffic-chart-wrapper" };
const _hoisted_21$2 = {
  key: 0,
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const SAMPLE_KEY_METRICS_BY_TAB = {
      traffic: [
        { id: "totalUsers", label: __("Total Users", "google-analytics-dashboard-for-wp"), value: 8432, type: "number", percentChange: { value: 14.2, positive: true } },
        { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), value: 6218, type: "number", percentChange: { value: 11.5, positive: true } },
        { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 62.3, type: "percent", percentChange: { value: 4.8, positive: true } }
      ],
      engagement: [
        { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), value: 6218, type: "number", percentChange: { value: 11.5, positive: true } },
        { id: "returningUsers", label: __("Returning Users", "google-analytics-dashboard-for-wp"), value: 2214, type: "number", percentChange: { value: 7.3, positive: true } },
        { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 62.3, type: "percent", percentChange: { value: 4.8, positive: true } }
      ],
      referrals: [
        { id: "totalUsers", label: __("Total Users", "google-analytics-dashboard-for-wp"), value: 3150, type: "number", percentChange: { value: 9.6, positive: true } },
        { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), value: 2340, type: "number", percentChange: { value: 6.1, positive: true } },
        { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 58.7, type: "percent", percentChange: { value: 3.2, positive: true } }
      ],
      ecommerce: [
        { id: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp"), value: 12450, type: "currency", percentChange: { value: 18.4, positive: true } },
        { id: "transactions", label: __("Transactions", "google-analytics-dashboard-for-wp"), value: 184, type: "number", percentChange: { value: 12.1, positive: true } },
        { id: "avgOrderValue", label: __("Avg. Order Value", "google-analytics-dashboard-for-wp"), value: 67.66, type: "currency", percentChange: { value: 5.3, positive: true } },
        { id: "conversionRate", label: __("Conversion Rate", "google-analytics-dashboard-for-wp"), value: 2.4, type: "percent", percentChange: { value: 8.7, positive: true } }
      ]
    };
    ...
    const siteNotesIcon = "writing-tool-em";
    ...
    const METRICS_OPTIONS_BY_TAB = {
      traffic: [
        { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "sessionKeyEventRate", label: __("Key Event Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "totalUsers", label: __("Total Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "returningUsers", label: __("Returning Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "pageViewsPerUser", label: __("Pageviews / User", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "bounceRate", label: __("Bounce Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "ecommercePurchases", label: __("Purchases", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "totalRevenue", label: __("Revenue", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averagePurchaseRevenue", label: __("Average Order Value", "google-analytics-dashboard-for-wp"), icon: "link" }
      ],
      engagement: [
        { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        ...
        { id: "pageViewsPerUser", label: __("Pageviews / User", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "bounceRate", label: __("Bounce Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averageSessionDuration", label: __("Session Duration", "google-analytics-dashboard-for-wp"), icon: "link" }
      ],
      referrals: [
        { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
      ...
      ecommerce: [
        { id: "itemsPurchased", label: __("Items Purchased", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averagePurchaseRevenue", label: __("Average Order Value (AOV)", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "couponUsedPercent", label: __("Coupon Used %", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "cartAbandonRatePercent", label: __("Cart Abandon Rate %", "google-analytics-dashboard-for-wp"), icon: "link" }
      ]
    };
    ...
    const TAB_DEFINITIONS = [
      { id: "traffic", label: __("Traffic", "google-analytics-dashboard-for-wp"), icon: "chart-line" },
      { id: "engagement", label: __("Engagement", "google-analytics-dashboard-for-wp"), icon: "users" },
      { id: "referrals", label: __("Referrals", "google-analytics-dashboard-for-wp"), icon: "referrals" },
      { id: "ecommerce", label: __("eCommerce", "google-analytics-dashboard-for-wp"), icon: "cart" }
    ];
    ...
    async function loadOverviewData() {
      ...
      try {
        ...
        if (currentLoadId !== overviewLoadId.value) return;
        if (!isUpsell) {
          error.value = err?.message || err?.title || __("Error loading overview data.", "google-analytics-dashboard-for-wp");
        }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        ...
        createBaseVNode("div", _hoisted_23$1, [
          !unref(siteNotesStore).showSiteNotes ? (openBlock(), createElementBlock("button", {
            ...
            createBaseVNode("span", null, toDisplayString(unref(__)("Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ])) : createCommentVNode("", true)
        ]),
        ...
        unref(siteNotesStore).showSiteNotes ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
          createBaseVNode("button", {
            ...
            createBaseVNode("span", null, toDisplayString(unref(__)("Close Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ])
        ])) : createCommentVNode("", true)
      ]);
    };
...
const _hoisted_1$4 = { class: "exactmetrics-overview-key-metrics" };
const _hoisted_2$4 = { class: "exactmetrics-overview-key-metrics__header" };
const _hoisted_3$4 = { class: "exactmetrics-overview-key-metrics__title" };
const _hoisted_4$4 = ["href"];
const _hoisted_5$3 = { class: "exactmetrics-overview-key-metrics__container" };
const _hoisted_6$3 = { class: "exactmetrics-overview-key-metrics__item" };
const _hoisted_7$3 = { class: "exactmetrics-overview-key-metrics__label" };
const _hoisted_8$3 = { class: "exactmetrics-overview-key-metrics__value-row" };
const _hoisted_9$2 = { class: "exactmetrics-overview-key-metrics__value" };
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const KEY_METRICS_BY_TAB = {
      traffic: [
        { id: "organic", label: __("Organic Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "social", label: __("Social Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "paid", label: __("Paid Media Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "email", label: __("Email Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "referral", label: __("Referral Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "direct", label: __("Direct Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true }
      ],
      engagement: [
        { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), apiKey: "sessions" },
        { id: "engagementRate", label: __("Engagement Rate", "google-analytics-dashboard-for-wp"), apiKey: "engagementRate", type: "percent" },
        { id: "bounceRate", label: __("Bounce Rate", "google-analytics-dashboard-for-wp"), apiKey: "bounceRate", type: "percent" },
        { id: "newUsers", label: __("New Users", "google-analytics-dashboard-for-wp"), apiKey: "newUsers" },
        { id: "returningUsers", label: __("Returning Users", "google-analytics-dashboard-for-wp"), apiKey: "returningUsers" },
        { id: "sessionDuration", label: __("Session Duration", "google-analytics-dashboard-for-wp"), apiKey: "averageSessionDuration", type: "duration" }
      ],
      referrals: [
        { id: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), apiKey: "sessions" },
        { id: "engagedSessions", label: __("Engaged Sessions", "google-analytics-dashboard-for-wp"), apiKey: "engagedSessions" },
        { id: "users", label: __("Users", "google-analytics-dashboard-for-wp"), apiKey: "totalUsers" }
      ],
      ecommerce: [
        { id: "transactions", label: __("Transactions", "google-analytics-dashboard-for-wp"), apiKey: "ecommercePurchases" },
        { id: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp"), apiKey: "totalRevenue", type: "currency" },
        { id: "aov", label: __("AOV", "google-analytics-dashboard-for-wp"), apiKey: "averagePurchaseRevenue", type: "currency" },
        { id: "addToCarts", label: __("Add to Carts", "google-analytics-dashboard-for-wp"), apiKey: "addToCarts" },
        { id: "conversionRate", label: __("Conversion Rate", "google-analytics-dashboard-for-wp"), apiKey: "conversionRate", type: "percent" },
        { id: "abandonmentRate", label: __("Abandonment Rate", "google-analytics-dashboard-for-wp"), apiKey: "abandonmentRate", type: "percent" }
      ]
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$4, [
          createBaseVNode("h2", _hoisted_3$4, toDisplayString(unref(__)("Key Metrics", "google-analytics-dashboard-for-wp")), 1),
          __props.viewFullReportUrl ? (openBlock(), createElementBlock("a", {
            ...
            createBaseVNode("span", null, toDisplayString(unref(__)("View Full Report", "google-analytics-dashboard-for-wp")), 1),
            createVNode(Icon, {
              name: "chevron-right",
              size: 20
            })
...
const _hoisted_1$3 = { class: "exactmetrics-overview-report-table" };
const _hoisted_2$3 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_3$3 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_4$3 = {
  key: 0,
  class: "exactmetrics-overview-report-table__demo-badge"
};
const _hoisted_5$2 = { class: "exactmetrics-overview-report-table__header-right" };
const _hoisted_6$2 = {
  key: 0,
...
const _hoisted_10$1 = { class: "exactmetrics-overview-report-table__table-wrapper" };
const _hoisted_11$1 = { class: "exactmetrics-overview-report-table__table" };
const _hoisted_12$1 = ["onClick"];
const _hoisted_13$1 = { class: "exactmetrics-overview-report-table__th-content" };
const _hoisted_14$1 = {
  key: 0,
...
const _hoisted_18$1 = { class: "exactmetrics-overview-report-table__cell-inner" };
const _hoisted_19$1 = {
  key: 0,
  class: "exactmetrics-overview-report-table__row-number"
};
const _hoisted_20$1 = {
  key: 1,
...
const _hoisted_23 = {
  key: 0,
  class: "exactmetrics-overview-report-table__footer"
};
const _hoisted_24 = {
  key: 1,
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$3, [
          createBaseVNode("h3", _hoisted_3$3, [
            ...
            needsAddonGate.value ? (openBlock(), createElementBlock("span", _hoisted_4$3, toDisplayString(unref(__)("Demo Data", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
          ]),
        ...
        createBaseVNode("div", _hoisted_10$1, [
          createBaseVNode("table", _hoisted_11$1, [
            ...
            createBaseVNode("tbody", null, [
              __props.loading ? (openBlock(), createElementBlock("tr", _hoisted_14$1, [
                ...
                }, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 9, _hoisted_17$1)
          ...
          __props.hasLoadMore && (__props.rows.length > __props.rowLimit || needsAddonGate.value) ? (openBlock(), createElementBlock("div", _hoisted_24, [
            createBaseVNode("button", {
              ...
              createBaseVNode("span", null, toDisplayString(unref(__)("Load More", "google-analytics-dashboard-for-wp")), 1),
              createVNode(Icon, {
                name: "load-more",
                size: 16
              })
...
const _hoisted_1$2 = { class: "exactmetrics-overview-upsell-cta__content" };
const _hoisted_2$2 = { class: "exactmetrics-overview-upsell-cta__text" };
const _hoisted_3$2 = { class: "exactmetrics-overview-upsell-cta__title" };
const _hoisted_4$2 = { class: "exactmetrics-overview-upsell-cta__description" };
const _hoisted_5$1 = ["href"];
const _hoisted_6$1 = ["src"];
const _hoisted_7$1 = { class: "exactmetrics-overview-upsell-cta__image" };
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const text = {
      title: __("Get Better Insights. Take Action. ", "google-analytics-dashboard-for-wp"),
      titleHighlight: __("Grow FASTER!", "google-analytics-dashboard-for-wp"),
      description: __("Join over 3 million owners and start making data-driven decisions to grow your business.", "google-analytics-dashboard-for-wp"),
      upgradeToPro: __("Upgrade to Pro", "google-analytics-dashboard-for-wp")
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const text = {
      customDimensions: __("Custom Dimensions", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
      dimensions: "/wp-admin/admin.php?page=exactmetrics_reports#/dimensions"
    };
    const customDimensionsTabs = [
      { label: __("Logged In", "google-analytics-dashboard-for-wp"), value: "loggedIn" },
      { label: __("Post Type", "google-analytics-dashboard-for-wp"), value: "postType" },
      { label: __("Author", "google-analytics-dashboard-for-wp"), value: "author" },
      { label: __("Category", "google-analytics-dashboard-for-wp"), value: "category" },
      { label: __("Tags", "google-analytics-dashboard-for-wp"), value: "tags" },
      { label: __("Focus Keyword", "google-analytics-dashboard-for-wp"), value: "focusKeyword" },
      { label: __("Day of Week", "google-analytics-dashboard-for-wp"), value: "dayOfWeek" },
      { label: __("SEO Score", "google-analytics-dashboard-for-wp"), value: "seoScore" }
    ];
    const customDimensionsActiveTab = ref("loggedIn");
    const customDimensionsColumnLabels = {
      loggedIn: __("Logged In", "google-analytics-dashboard-for-wp"),
      postType: __("Post Type", "google-analytics-dashboard-for-wp"),
      author: __("Author", "google-analytics-dashboard-for-wp"),
      category: __("Category", "google-analytics-dashboard-for-wp"),
      tags: __("Tags", "google-analytics-dashboard-for-wp"),
      focusKeyword: __("Focus Keyword", "google-analytics-dashboard-for-wp"),
      dayOfWeek: __("Day of Week", "google-analytics-dashboard-for-wp"),
      seoScore: __("SEO Score", "google-analytics-dashboard-for-wp")
    };
    const customDimensionsColumnsBase = [
      { key: "dimensionValue", label: "" },
      { key: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp") },
      { key: "users", label: __("Users", "google-analytics-dashboard-for-wp") },
      { key: "engagement", label: __("Engagement Rate", "google-analytics-dashboard-for-wp") },
      { key: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp") },
      { key: "purchases", label: __("Purchases", "google-analytics-dashboard-for-wp") },
      { key: "averageOrderValue", label: __("Average Order Value (AOV)", "google-analytics-dashboard-for-wp") },
      { key: "conversionRate", label: __("Conversion Rate", "google-analytics-dashboard-for-wp") }
    ];
    ...
    const DAY_OF_WEEK_NAMES = [
      __("Sunday", "google-analytics-dashboard-for-wp"),
      __("Monday", "google-analytics-dashboard-for-wp"),
      __("Tuesday", "google-analytics-dashboard-for-wp"),
      __("Wednesday", "google-analytics-dashboard-for-wp"),
      __("Thursday", "google-analytics-dashboard-for-wp"),
      __("Friday", "google-analytics-dashboard-for-wp"),
      __("Saturday", "google-analytics-dashboard-for-wp")
    ];
...
const _hoisted_4$1 = { class: "exactmetrics-overview-ecommerce-funnel__title" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3$1, [
            createBaseVNode("h2", _hoisted_4$1, toDisplayString(unref(__)("Funnels", "google-analytics-dashboard-for-wp")), 1),
            createBaseVNode("div", _hoisted_5, [
              withDirectives(createBaseVNode("select", {
                ...
                createBaseVNode("option", _hoisted_7, toDisplayString(unref(__)("Choose Funnel", "google-analytics-dashboard-for-wp")), 1),
          ...
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("button", {
              ...
              createBaseVNode("span", null, toDisplayString(unref(__)("Manage Funnels", "google-analytics-dashboard-for-wp")), 1),
              createVNode(Icon, {
                name: "settings",
                size: 16
              })
        ...
        activeFunnel.value && funnelLoading.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
          createBaseVNode("span", null, toDisplayString(unref(__)("Loading funnel data...", "google-analytics-dashboard-for-wp")), 1)
              ...
              createBaseVNode("tr", null, [
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_15, [
                    createBaseVNode("span", null, toDisplayString(unref(sprintf)(
                      ...
                      unref(__)("%s - Steps", "google-analytics-dashboard-for-wp"),
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_16, [
                    createBaseVNode("span", null, toDisplayString(unref(__)("Active Users (% of Step 1)", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_17, [
                    createBaseVNode("span", null, toDisplayString(unref(__)("Completion Rates", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_18, [
                    createBaseVNode("span", null, toDisplayString(unref(__)("Abandonments", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_19, [
                    createBaseVNode("span", null, toDisplayString(unref(__)("Abandonment Rate", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_20, [
                    createBaseVNode("span", null, toDisplayString(unref(__)("Overall Conversion Rate", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
            ...
            createBaseVNode("tfoot", null, [
              createBaseVNode("tr", null, [
                createBaseVNode("td", null, toDisplayString(unref(sprintf)(
                  /* translators: %s - funnel name */
                  unref(__)("%s Conversion Rate", "google-analytics-dashboard-for-wp"),
                  activeFunnel.value.name
                )), 1),
          ...
          createBaseVNode("p", null, toDisplayString(unref(__)("No funnel data for this period", "google-analytics-dashboard-for-wp")), 1)
        ])) : (openBlock(), createElementBlock("div", _hoisted_22, [
          createVNode(Icon, {
            name: "no-saved-filters",
            size: 64
          }),
          createBaseVNode("p", null, toDisplayString(unref(__)("Select a funnel to view data", "google-analytics-dashboard-for-wp")), 1)
        ])),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const text = {
      formSubmissions: __("Form Submissions", "google-analytics-dashboard-for-wp"),
      eCommerceLog: __("eCommerce Log", "google-analytics-dashboard-for-wp"),
      eCommerceData: __("eCommerce Data", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
    ...
    const formSubmissionsTabs = [
      { label: __("Source / Medium", "google-analytics-dashboard-for-wp"), value: "sourceMedium" },
      { label: __("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" }
    ];
    const formSubmissionsActiveTab = ref("sourceMedium");
    const formSubmissionsColumnsByTab = {
      sourceMedium: [
        { key: "formSubmitDate", label: __("Form Submit Date", "google-analytics-dashboard-for-wp") },
        { key: "formId", label: __("Form ID", "google-analytics-dashboard-for-wp") },
        { key: "country", label: __("Country", "google-analytics-dashboard-for-wp") },
        { key: "source", label: __("Source", "google-analytics-dashboard-for-wp") },
        { key: "medium", label: __("Medium", "google-analytics-dashboard-for-wp") }
      ],
      campaign: [
        { key: "campaign", label: __("Campaign", "google-analytics-dashboard-for-wp") },
        { key: "formId", label: __("Form ID", "google-analytics-dashboard-for-wp") },
        { key: "country", label: __("Country", "google-analytics-dashboard-for-wp") },
        { key: "source", label: __("Source", "google-analytics-dashboard-for-wp") },
        { key: "medium", label: __("Medium", "google-analytics-dashboard-for-wp") }
    ...
    function parseSourceMediumRows(apiData) {
      const rows = Array.isArray(apiData?.rows) ? apiData.rows : Array.isArray(apiData) ? apiData : [];
      if (rows.length === 0) return [];
      const empty = __("(not set)", "google-analytics-dashboard-for-wp");
    ...
    const eCommerceLogTabs = [
      { label: __("Date", "google-analytics-dashboard-for-wp"), value: "date" },
      { label: __("Source / Medium", "google-analytics-dashboard-for-wp"), value: "sourceMedium" },
      { label: __("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" }
    ];
    const eCommerceLogActiveTab = ref("date");
    const eCommerceLogColumnDefs = [
      { key: "transactionDate", label: __("Transaction Date", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionId", label: __("Transaction ID", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionSource", label: __("Transaction Source", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionMedium", label: __("Transaction medium", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionCampaign", label: __("Transaction Campaign", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp") }
    ];
    ...
    const eCommerceDataTabs = [
      { label: __("Coupon", "google-analytics-dashboard-for-wp"), value: "coupon" }
    ];
    const eCommerceDataActiveTab = ref("coupon");
    const eCommerceDataColumns = [
      { key: "productName", label: __("Product Name", "google-analytics-dashboard-for-wp") },
      { key: "coupon", label: __("Coupon", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "revenue", label: __("Revenue", "google-analytics-dashboard-for-wp") },
      { key: "orders", label: __("Orders", "google-analytics-dashboard-for-wp") },
      { key: "percentOfSales", label: __("% of Sales", "google-analytics-dashboard-for-wp") }
    ];
...
const _hoisted_3 = {
  key: 2,
  class: "exactmetrics-overview-report-two-col"
};
const _hoisted_4 = { class: "exactmetrics-overview-report-two-col" };
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text = {
      marketingCampaigns: __("Marketing Campaigns", "google-analytics-dashboard-for-wp"),
      pages: __("Pages", "google-analytics-dashboard-for-wp"),
      demographics: __("Demographics", "google-analytics-dashboard-for-wp"),
      devices: __("Devices", "google-analytics-dashboard-for-wp"),
      topReferrals: __("Top 10 Referrals", "google-analytics-dashboard-for-wp"),
      topPosts: __("Top 10 Posts/Pages", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
      ...
      topPosts: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-landing-pages"
    };
    ...
    const marketingCampaignsTabs = [
      { label: __("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" },
      { label: __("Source", "google-analytics-dashboard-for-wp"), value: "source" },
      { label: __("Medium", "google-analytics-dashboard-for-wp"), value: "medium" },
      { label: __("Term", "google-analytics-dashboard-for-wp"), value: "term" },
      { label: __("Content", "google-analytics-dashboard-for-wp"), value: "content" }
    ];
    const marketingCampaignsActiveTab = ref("campaign");
    const marketingCampaignsColumnLabels = {
      campaign: __("Campaign Name", "google-analytics-dashboard-for-wp"),
      source: __("Source", "google-analytics-dashboard-for-wp"),
      medium: __("Medium", "google-analytics-dashboard-for-wp"),
      term: __("Term", "google-analytics-dashboard-for-wp"),
      content: __("Content", "google-analytics-dashboard-for-wp")
    };
    ...
    const marketingCampaignsColumnsBase = [
      ...
      { key: "users", label: __("Users", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "engagement", label: __("Engagement", "google-analytics-dashboard-for-wp"), sortable: true },
      ...
      { key: "averageOrderValue", label: __("Average Order Value", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "conversionRate", label: __("Conversion Rate", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    ...
    const pagesTabs = [
      { label: __("Landing Page", "google-analytics-dashboard-for-wp"), value: "landingPage" },
      { label: __("Page Location", "google-analytics-dashboard-for-wp"), value: "pageLocation" },
      { label: __("Page Title", "google-analytics-dashboard-for-wp"), value: "pageTitle" },
      { label: __("Query String", "google-analytics-dashboard-for-wp"), value: "queryString" }
    ];
    const pagesActiveTab = ref("landingPage");
    const pagesColumnLabels = {
      landingPage: __("Landing Page", "google-analytics-dashboard-for-wp"),
      pageLocation: __("Page Location", "google-analytics-dashboard-for-wp"),
      pageTitle: __("Page Title", "google-analytics-dashboard-for-wp"),
      queryString: __("Query String", "google-analytics-dashboard-for-wp")
    };
    ...
    const demographicsTabs = [
      { label: __("Country", "google-analytics-dashboard-for-wp"), value: "country" },
      { label: __("State", "google-analytics-dashboard-for-wp"), value: "state" },
      { label: __("New vs Returning", "google-analytics-dashboard-for-wp"), value: "newVsReturning" }
    ];
    ...
    const demographicsColumnLabels = {
      ...
      state: __("State", "google-analytics-dashboard-for-wp"),
      newVsReturning: __("New vs Returning", "google-analytics-dashboard-for-wp")
    };
    ...
    const devicesTabs = [
      { label: __("Browser", "google-analytics-dashboard-for-wp"), value: "browser" },
      { label: __("OS", "google-analytics-dashboard-for-wp"), value: "os" },
      { label: __("Size", "google-analytics-dashboard-for-wp"), value: "size" }
    ];
    const devicesActiveTab = ref("browser");
    const devicesColumnLabels = {
      browser: __("Browser", "google-analytics-dashboard-for-wp"),
      os: __("OS", "google-analytics-dashboard-for-wp"),
      size: __("Size", "google-analytics-dashboard-for-wp")
    };
    ...
    const topReferralsColumns = [
      { key: "name", label: __("Referral", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
    const topReferralsData = computed(() => parseNameSessionsRows(marketingCampaignsDataRef.value?.source));
    const topPostsColumns = [
      { key: "name", label: __("Title", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "sessions", label: __("Sessions", "google-analytics-dashboard-for-wp"), sortable: true }
    ];
              ...
              demographicsActiveTab.value === "country" && demographicsData.value.length > 0 ? {
                ...
                fn: withCtx(() => [
                  createVNode(UniversallyPromo, {
                    class: "exactmetrics-overview-report__universally-promo",
                    "promo-id": "universally_overview_country",
                    bare: "",
                    "show-info": "",
                    text: unref(__)("Translate your website with Universally. ", "google-analytics-dashboard-for-wp")
                  }, null, 8, ["text"])
                ]),
                key: "0"
              } : void 0
