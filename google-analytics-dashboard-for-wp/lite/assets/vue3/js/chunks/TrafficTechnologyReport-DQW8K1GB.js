import { a1 as storeToRefs, o as openBlock, E as createBlock, D as withCtx, u as unref, c as createElementBlock, b as createVNode, t as toDisplayString, a as createBaseVNode, s as createCommentVNode, F as Fragment, m as computed } from "./toastStore-nTGs-rGm.js";
import { _ as __ } from "./default-i18n-KrIlCc2E.js";
import { u as useOverviewReportStore, A as isSampleDataEnabled, b as buildApiFilters } from "../reports-B_hJZd5_.js";
import { a as generateTrafficTechnologySample, b as fetchTrafficTechnologyData } from "./trafficSampleData-BTxFRSeQ.js";
...
import { _ as _sfc_main$1 } from "./ReportPieChart-DRNYn8qZ.js";
...
const _hoisted_3 = {
  key: 2,
  class: "exactmetrics-technology-report"
};
const _hoisted_4 = { class: "exactmetrics-overview-report-table" };
const _hoisted_5 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_6 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-technology-report__period-label"
};
const _hoisted_8 = {
  key: 1,
  class: "exactmetrics-report-pie-chart__empty"
};
const _hoisted_9 = { class: "exactmetrics-technology-report__compare-divider" };
const _hoisted_10 = { class: "exactmetrics-technology-report__period-label exactmetrics-technology-report__period-label--prev" };
const _hoisted_11 = { class: "exactmetrics-overview-report-table" };
...
const _hoisted_16 = { class: "exactmetrics-technology-report__compare-divider" };
const _hoisted_17 = { class: "exactmetrics-technology-report__period-label exactmetrics-technology-report__period-label--prev" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const previousDateLabel = computed(() => {
      ...
      if (!s || !e) return __("Previous Period", "google-analytics-dashboard-for-wp");
      return `${formatShortDate(s)} - ${formatShortDate(e)}`;
    });
    ...
    function parsePieRows(rows, isCompare = false, period = "current") {
      ...
      for (const row of visibleRows) {
        const label = row?.d?.[0] || __("(not set)", "google-analytics-dashboard-for-wp");
        const m0 = row?.m?.[0];
        let value = 0;
    ...
    const browserBreakdown = computed(() => {
      ...
      if (rest.length) {
        ...
        if (othersCurr > 0 || othersPrev > 0) {
          labels.push(__("All Others", "google-analytics-dashboard-for-wp"));
          ...
          unref(loading) ? (openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_4, [
              createBaseVNode("div", _hoisted_5, [
                createBaseVNode("h3", _hoisted_6, toDisplayString(unref(__)("Browser Breakdown", "google-analytics-dashboard-for-wp")), 1),
              ...
              }, null, 8, ["data", "layout"])) : (openBlock(), createElementBlock("div", _hoisted_8, toDisplayString(unref(__)("No browser data available.", "google-analytics-dashboard-for-wp")), 1)),
            ...
            createBaseVNode("div", _hoisted_11, [
              createBaseVNode("div", _hoisted_12, [
                createBaseVNode("h3", _hoisted_13, toDisplayString(unref(__)("Device Breakdown", "google-analytics-dashboard-for-wp")), 1),
              ...
              deviceChart.value.series.length ? (openBlock(), createBlock(_sfc_main$1, {
                ...
                height: 280,
                layout: unref(pieLayout)
              }, null, 8, ["data", "layout"])) : (openBlock(), createElementBlock("div", _hoisted_15, toDisplayString(unref(__)("No device data available.", "google-analytics-dashboard-for-wp")), 1)),
