...
import { y as onMounted, x as nextTick, z as onBeforeUnmount, o as openBlock, c as createElementBlock, E as createBlock, u as unref, t as toDisplayString, s as createCommentVNode, j as ref, m as computed } from "./toastStore-CjmlShHI.js";
const _hoisted_1 = { class: "exactmetrics-apex-chart" };
const _hoisted_2 = {
  key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        hasData.value && isMounted.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          series: series.value
        }, null, 8, ["type", "height", "options", "series"])) : !hasData.value ? (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
      ]);
    };
  }
};
