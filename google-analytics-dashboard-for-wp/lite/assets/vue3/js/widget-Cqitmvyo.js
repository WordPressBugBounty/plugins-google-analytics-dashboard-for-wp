import { l as defineStore, y as onMounted, J as onUnmounted, o as openBlock, c as createElementBlock, a as createBaseVNode, B as withModifiers, F as Fragment, f as renderList, i as normalizeClass, s as createCommentVNode, j as ref, m as computed, u as unref, t as toDisplayString, A as createTextVNode, G as withKeys, a1 as storeToRefs, E as createBlock, b as createVNode, a2 as resolveDirective, w as withDirectives, C as watch, a3 as useSlots, K as renderSlot, a4 as createSlots, D as withCtx, n as normalizeStyle, a5 as resolveDynamicComponent, x as nextTick, d as createApp } from "./chunks/toastStore-CjmlShHI.js";
import { r as miAjax, j as getMiGlobal, n as getUpgradeUrl, k as isPro, q as sanitizeHtml, p as isNetworkAdmin, s as setupPinia } from "./chunks/ajax-Uw5S1uqk.js";
import { _ as _sfc_main$A, i as installOverlays } from "./chunks/AppOverlays-GGnrWZ9e.js";
...
import { m } from "./chunks/vue3-apexcharts-ErQ4EB6K.js";
...
function defaultReports() {
  return {
    overview: {
      type: "overview",
      name: __$1("Overview Report", "google-analytics-dashboard-for-wp"),
      enabled: true,
      component: "WidgetReportOverview"
    },
    toppages: {
      type: "overview",
      name: __$1("Top Posts/Pages", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    newvsreturn: {
      type: "overview",
      name: __$1("New vs. Returning Visitors", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    devices: {
      type: "overview",
      name: __$1("Device Breakdown", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    landingpages: {
      type: "publisher",
      name: __$1("Top Landing Pages", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    outboundlinks: {
      type: "publisher",
      name: __$1("Top Outbound Links", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    affiliatelinks: {
      type: "publisher",
      name: __$1("Top Affiliate Links", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    downloadlinks: {
      type: "publisher",
      name: __$1("Top Download Links", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    infobox: {
      type: "ecommerce",
      name: __$1("Overview", "google-analytics-dashboard-for-wp"),
      enabled: false,
      component: "WidgetReportEcommerceOverview"
    },
    products: {
      type: "ecommerce",
      name: __$1("Top Products", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    conversions: {
      type: "ecommerce",
      name: __$1("Top Conversion Sources", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    addremove: {
      type: "ecommerce",
      name: __$1("Total Add/Remove", "google-analytics-dashboard-for-wp"),
      enabled: false,
      component: "WidgetReportAddRemove"
    },
    newcustomers: {
      type: "ecommerce",
      name: __$1("New Customers", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
    ...
    abandonedcheckouts: {
      type: "ecommerce",
      name: __$1("Abandoned Checkouts", "google-analytics-dashboard-for-wp"),
      tooltip: __$1(
...
const useWidgetStore = defineStore("widget", {
  ...
  actions: {
    /**
     * Hydrate state from the `window.exactmetrics.widget_state` payload
    ...
    async saveWidgetState() {
      ...
      try {
        await miAjax("exactmetrics_save_widget_state", {
          width: this.width,
    ...
    async markNoticeClosed() {
      try {
        await miAjax("exactmetrics_mark_notice_closed");
...
const useWidgetReportsStore = defineStore("widgetReports", {
  ...
  actions: {
    ...
    /** Mark the widget as loading (adds the `exactmetrics-blur` class). */
    enableBlur() {
      this._inflight += 1;
      this.blur = true;
    },
    ...
    /**
     * Classic Vue 2 endpoint: POSTs to admin-ajax `exactmetrics_vue_get_report_data`
     * with the report name + date range. Matches the existing PHP handler.
     *
     * Toggles the shared `blur` flag so `App.vue` can add the
     * `exactmetrics-blur` class while the widget is fetching — same UX as
     * the Vue 2 widget.
     */
    async fetchReportData(report) {
      ...
      try {
        const data = await miAjax("exactmetrics_vue_get_report_data", payload);
        ...
        const message = err?.message || __("Error loading report data.", "google-analytics-dashboard-for-wp");
...
const _hoisted_1$x = { class: "exactmetrics-widget-datepicker" };
const _hoisted_2$l = { class: "exactmetrics-reports-datepicker" };
const _hoisted_3$f = { class: "exactmetrics-reports-interval-dropdown-container" };
const _hoisted_4$e = ["innerHTML"];
const _hoisted_5$8 = { class: "exactmetrics-datepicker-default-buttons" };
...
const _sfc_main$z = {
  ...
  setup(__props) {
    ...
    function buttonClass(key) {
      return {
        "exactmetrics-button": true,
        "exactmetrics-selected-interval": normalizedKey.value === key
      };
    }
      ...
      for (const type of activeTypes) {
        widgetReports.fetchReportData(type).catch(() => {
          widgetStore.setReportError(
            type,
            __2("Error loading report data.", "google-analytics-dashboard-for-wp")
          );
        });
      }
        ...
        createBaseVNode("div", _hoisted_2$l, [
          createBaseVNode("div", _hoisted_3$f, [
            createBaseVNode("button", {
              ...
              ref: triggerEl,
              type: "button",
              class: "exactmetrics-reports-interval-date-info",
              onClick: withModifiers(toggleDropdown, ["stop"])
            }, [
              createBaseVNode("span", { innerHTML: selectedIntervalHtml.value }, null, 8, _hoisted_4$e),
            ...
            dropdownVisible.value ? (openBlock(), createElementBlock("div", {
              ...
              ref_key: "dropdownEl",
              ref: dropdownEl,
              class: "exactmetrics-reports-intervals-dropdown"
            }, [
...
const _hoisted_2$k = { class: "exactmetrics-lite-datepicker" };
const _hoisted_3$e = ["innerHTML"];
const _hoisted_4$d = ["href"];
const _hoisted_5$7 = ["textContent"];
const _sfc_main$y = {
  __name: "WidgetSettingsIntervalUpsell",
  setup(__props) {
    const { __: __2, sprintf } = wp.i18n;
    const widgetStore = useWidgetStore();
    const LEGACY_KEYS = { 7: "last7days", 30: "last30days", 90: "last90days" };
    const dropdownOpen = ref(false);
    const dropdownEl = ref(null);
    const text_customize_date = sprintf(
      __2("You can customize your %sdate range only in the PRO version.", "google-analytics-dashboard-for-wp"),
      "<br />"
    );
    const text_upgrade = __2("Upgrade to PRO", "google-analytics-dashboard-for-wp");
    const upgradeUrl = getUpgradeUrl("reports", "datepicker");
    const intervalHtml = computed(() => {
      const key = widgetStore.interval;
      const normalized = dateIntervals[key] ? key : LEGACY_KEYS[key] || "last30days";
      const interval = dateIntervals[normalized];
      const start = interval.start;
      const end = interval.end;
      const range = `${start.format("MMMM D")} - ${end.format("MMMM D, YYYY")}`;
      return `${interval.text}<span class="exactmetrics-interval-full-dates">${range}</span>`;
    });
    const btnGroupClass = computed(() => ({
      "exactmetrics-btn-group": true,
      "exactmetrics-btn-group-open": dropdownOpen.value
    }));
    function toggleDropdown() {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(btnGroupClass.value)
      }, [
        createBaseVNode("button", {
          type: "button",
          class: "exactmetrics-btn-group-label",
          onClick: withModifiers(toggleDropdown, ["stop"]),
          innerHTML: intervalHtml.value
        }, null, 8, _hoisted_1$w),
        dropdownOpen.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          ref_key: "dropdownEl",
          ref: dropdownEl,
          class: "exactmetrics-btn-group-list exactmetrics-widget-upsell-dropdown"
        }, [
          createBaseVNode("div", _hoisted_2$k, [
            createBaseVNode("p", { innerHTML: unref(text_customize_date) }, null, 8, _hoisted_3$e),
            createBaseVNode("a", {
              class: "exactmetrics-button exactmetrics-button-text",
...
const _hoisted_1$v = ["aria-label", "title"];
const _sfc_main$x = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const tooltip = computed(
      () => widgetStore.isFullWidth ? __2("Show in widget mode", "google-analytics-dashboard-for-wp") : __2("Show in full-width mode", "google-analytics-dashboard-for-wp")
    );
    async function onToggle() {
      ...
      if (nextFull) {
        ...
        for (const type of activeTypes) {
          widgetReports.fetchReportData(type).catch(() => {
            widgetStore.setReportError(type, __2("Error loading report data.", "google-analytics-dashboard-for-wp"));
          });
        }
      }
      widgetStore.saveWidgetState();
    ...
    function applyFullWidthDom() {
      const widgetEl = document.getElementById("exactmetrics_reports_widget");
      ...
      if (widgetStore.isFullWidth) {
        widgetEl.classList.add("exactmetrics-widget-full-width");
        widgetEl.classList.remove("exactmetrics-widget-regular-width");
        welcomePanel.parentNode?.insertBefore(widgetEl, welcomePanel);
      } else {
        widgetEl.classList.remove("exactmetrics-widget-full-width");
        widgetEl.classList.add("exactmetrics-widget-regular-width");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        type: "button",
        class: "exactmetrics-width-button",
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        class: normalizeClass(__props.report.enabled ? "exactmetrics-checked" : ""),
        tabindex: "0",
...
const _hoisted_1$t = { class: "exactmetrics-widget-compact-toggle" };
...
const _sfc_main$v = {
  ...
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const widgetStore = useWidgetStore();
    const text_compact = __2("Compact View", "google-analytics-dashboard-for-wp");
    function toggle() {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$t, [
        createBaseVNode("label", {
          class: normalizeClass(unref(widgetStore).compact ? "exactmetrics-checked" : ""),
          tabindex: "0",
...
const _hoisted_1$s = { class: "exactmetrics-widget-setting-hide" };
...
const _sfc_main$u = {
  ...
  setup(__props) {
    ...
    const screenOptionsHelp = __2(
      "https://www.exactmetrics.com/docs/how-to-hide-the-exactmetrics-dashboard-widget/",
      "google-analytics-dashboard-for-wp"
    );
    return (_ctx, _cache) => {
...
const _hoisted_1$r = { class: "exactmetrics-widget-dropdown" };
...
const _sfc_main$t = {
  ...
  setup(__props) {
    ...
    const dropdownVisible = ref(false);
    const dropdownEl = ref(null);
    const text_settings_dropdown = __2("Settings Menu", "google-analytics-dashboard-for-wp");
    const text_overview = __2("Show Overview Reports", "google-analytics-dashboard-for-wp");
    const text_publisher = __2("Show Publishers Reports", "google-analytics-dashboard-for-wp");
    const text_ecommerce = __2("Show eCommerce Reports", "google-analytics-dashboard-for-wp");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$r, [
        ...
        dropdownVisible.value ? (openBlock(), createElementBlock("div", {
          ...
          ref_key: "dropdownEl",
          ref: dropdownEl,
          class: "exactmetrics-widget-dropdown-content"
        }, [
          !__props.lite ? (openBlock(), createBlock(_sfc_main$v, { key: 0 })) : createCommentVNode("", true),
          createBaseVNode("span", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(overviewReports.value, (report, key) => {
            return openBlock(), createElementBlock("div", {
              key,
              class: "exactmetrics-widget-setting"
            }, [
...
const _hoisted_1$q = ["href", "innerHTML"];
const _sfc_main$s = {
  ...
  setup(__props) {
    ...
    const buttonHtml = computed(() => {
      ...
      {
        return sprintf(
          __2("View All Reports %s", "google-analytics-dashboard-for-wp"),
    ...
    return (_ctx, _cache) => {
      return reportsUrl.value ? (openBlock(), createElementBlock("a", {
        ...
        class: "exactmetrics-button exactmetrics-button-full-report",
        innerHTML: buttonHtml.value
      }, null, 8, _hoisted_1$q)) : createCommentVNode("", true);
    };
  }
};
const _hoisted_1$p = { class: "exactmetrics-widget-settings" };
const _sfc_main$r = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$p, [
        unref(isProVersion) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          showFullReportButton.value ? (openBlock(), createBlock(_sfc_main$s, { key: 0 })) : createCommentVNode("", true)
        ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          (openBlock(), createBlock(_sfc_main$y, { key: 0 })),
          createVNode(_sfc_main$x, {
            ref_key: "width",
            ref: width
          }, null, 512),
          createVNode(_sfc_main$t, { lite: true }),
          showFullReportButton.value ? (openBlock(), createBlock(_sfc_main$s, { key: 2 })) : createCommentVNode("", true)
        ], 64))
      ]);
    };
  }
...
const _hoisted_1$o = {
  key: 0,
  class: "exactmetrics-reports-link"
};
...
const _sfc_main$q = {
  ...
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const reportsUrl = computed(() => getMiGlobal("reports_url", ""));
    const text_view_all = __2("View All Reports", "google-analytics-dashboard-for-wp");
    return (_ctx, _cache) => {
      return reportsUrl.value ? (openBlock(), createElementBlock("div", _hoisted_1$o, [
        createBaseVNode("a", {
          href: reportsUrl.value,
          class: "exactmetrics-button exactmetrics-button-small"
        }, [
...
const _sfc_main$p = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return __props.content ? withDirectives((openBlock(), createElementBlock("span", _hoisted_1$n, [..._cache[0] || (_cache[0] = [
        createBaseVNode("i", {
...
const _hoisted_1$m = { class: "exactmetrics-widget-loading" };
const _hoisted_2$e = {
  key: 0,
  class: "exactmetrics-roller"
};
const _sfc_main$o = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$m, [
        (openBlock(), createElementBlock("div", _hoisted_2$e, [..._cache[0] || (_cache[0] = [
...
const _hoisted_1$l = { class: "exactmetrics-upsell-overlay" };
const _hoisted_2$d = { class: "exactmetrics-upsell-top" };
const _hoisted_3$b = ["textContent"];
const _hoisted_4$b = { class: "exactmetrics-upsell-content" };
const _hoisted_5$5 = { class: "exactmetrics-upsell-content__features" };
const _hoisted_6$5 = ["textContent"];
const _hoisted_7$5 = ["textContent"];
const _hoisted_8$4 = ["textContent"];
const _hoisted_9$4 = { class: "exactmetrics-upsell-content__features-cliff" };
const _hoisted_10$2 = ["textContent"];
const _hoisted_11$1 = ["innerHTML"];
const _hoisted_12$1 = { class: "exactmetrics-upsell-content-buttons" };
...
const _sfc_main$n = {
  ...
  setup(__props) {
    ...
    const UPSELL_CONTENT = {
      publisher: {
        mainheading: __2("Publishers Report", "google-analytics-dashboard-for-wp"),
        title: __2(
          "Improve Your Conversion Rate With Insights Into Which Content Works Best.",
          "google-analytics-dashboard-for-wp"
        ),
        features: [
          __2("Top Landing Pages", "google-analytics-dashboard-for-wp"),
          __2("Top Affilliate Links", "google-analytics-dashboard-for-wp"),
          __2("Top Exit Pages", "google-analytics-dashboard-for-wp"),
          __2("Top Download Links", "google-analytics-dashboard-for-wp"),
          __2("Top Outbound Links", "google-analytics-dashboard-for-wp"),
          __2("Scroll Depth", "google-analytics-dashboard-for-wp")
        ]
      },
      overview: {
        mainheading: __2("Publishers Report", "google-analytics-dashboard-for-wp"),
      ...
      ecommerce: {
        mainheading: __2("eCommerce Report", "google-analytics-dashboard-for-wp"),
        title: __2(
          "Increase Sales and Make More Money With Enhanced eCommerce Insights.",
          "google-analytics-dashboard-for-wp"
        ),
        features: [
          __2("10+ eCommerce Integrations", "google-analytics-dashboard-for-wp"),
          __2("Average Order Value", "google-analytics-dashboard-for-wp"),
          __2("Total Revenue", "google-analytics-dashboard-for-wp"),
          __2("Sessions to Purchase", "google-analytics-dashboard-for-wp"),
          __2("Top Conversion Sources", "google-analytics-dashboard-for-wp"),
          __2("Top Products", "google-analytics-dashboard-for-wp"),
          __2("Number of Transactions", "google-analytics-dashboard-for-wp"),
          __2("Time to Purchase", "google-analytics-dashboard-for-wp")
        ]
      }
    };
    ...
    const subheading = computed(
      () => content.value.mainheading ? sprintf(
        ...
        __2("What’s in the %s?", "google-analytics-dashboard-for-wp"),
    ...
    const text_features_cliff = __2("And more!", "google-analytics-dashboard-for-wp");
    const text_upgrade_button = __2("Upgrade and Unlock", "google-analytics-dashboard-for-wp");
    return (_ctx, _cache) => {
...
const _hoisted_3$a = { class: "exactmetrics-clearfix" };
const _hoisted_4$a = ["title", "textContent"];
const _hoisted_5$4 = {
  key: 1,
  class: "exactmetrics-reports-infobox-number",
  title: "0"
};
...
const _sfc_main$m = {
  ...
  setup(__props) {
    ...
    const changeClass = computed(() => {
      let cls = "exactmetrics-reports-infobox-prev";
      if (props.change === "" || props.change == null || typeof props.change === "undefined") {
        return cls + " exactmetrics-prev-nochange";
      }
      return cls + " exactmetrics-" + props.color;
    });
    const changeText = computed(() => {
      ...
      if (!isNaN(change) && change !== 0) {
        ...
        return '<span class="exactmetrics-arrow exactmetrics-' + props.direction + " exactmetrics-" + props.color + '"></span> ' + Math.abs(change) + "%";
      }
      return __2("No change", "google-analytics-dashboard-for-wp");
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        id: __props.id,
        class: "exactmetrics-reports-infobox"
      }, [
        __props.title ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "exactmetrics-report-title",
          textContent: toDisplayString(__props.title)
        }, null, 8, _hoisted_2$c)) : createCommentVNode("", true),
        createVNode(_sfc_main$p, { content: __props.tooltip }, null, 8, ["content"]),
        createBaseVNode("div", _hoisted_3$a, [
          ...
          __props.days ? (openBlock(), createElementBlock("div", {
            key: 2,
            class: "exactmetrics-reports-infobox-compare",
...
const _hoisted_1$j = { class: "exactmetrics-report-tabs-navigation" };
const _hoisted_2$b = ["textContent"];
const _hoisted_3$9 = ["textContent"];
const _hoisted_4$9 = { class: "exactmetrics-report-tabs-content" };
const _hoisted_5$3 = {
  key: 1,
  class: "exactmetrics-report-tabs-content-overlay"
};
const _hoisted_6$3 = { class: "exactmetrics-report-tabs-content-overlay-box" };
const _hoisted_7$3 = ["textContent"];
const _hoisted_8$3 = ["textContent"];
const _hoisted_9$3 = { class: "exactmetrics-report-row exactmetrics-report-infobox-row" };
const _sfc_main$l = {
  ...
  setup(__props) {
    ...
    const text_sessions = __2("Sessions", "google-analytics-dashboard-for-wp");
    const text_pageviews = __2("Pageviews", "google-analytics-dashboard-for-wp");
    const text_duration = __2("Avg. Session Duration", "google-analytics-dashboard-for-wp");
    const text_total_users = __2("Total Users", "google-analytics-dashboard-for-wp");
    const text_bounce = __2("Bounce Rate", "google-analytics-dashboard-for-wp");
    const text_new_users = __2("New Users", "google-analytics-dashboard-for-wp");
    ...
    function tabClass(tab) {
      return tab === current_tab.value ? "exactmetrics-active-tab-button" : "";
    }
    ...
    onMounted(() => {
      if (typeof window !== "undefined" && window.jQuery) {
        ...
        if (container) {
          window.jQuery(container).on("sortstop.exactmetrics-widget-overview", forceRerender);
        }
      }
    });
    onUnmounted(() => {
      if (typeof window !== "undefined" && window.jQuery) {
        const container = document.getElementById("dashboard-widgets");
        if (container) {
          window.jQuery(container).off("sortstop.exactmetrics-widget-overview", forceRerender);
        }
      }
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        showChart.value ? (openBlock(), createElementBlock("div", {
          key: chartKey.value,
          class: "exactmetrics-report-tabs exactmetrics-report-row"
        }, [
...
const _hoisted_3$8 = { class: "exactmetrics-table-box-list" };
const _hoisted_4$8 = { class: "exactmetrics-table-list-item-td-text" };
const _hoisted_5$2 = ["textContent"];
const _hoisted_6$2 = ["innerHTML"];
const _hoisted_7$2 = { class: "exactmetrics-table-list-item-td-number" };
const _hoisted_8$2 = ["innerHTML"];
const _hoisted_9$2 = {
  key: 1,
  class: "exactmetrics-table-box-footer"
};
const _sfc_main$k = {
  ...
  setup(__props) {
    ...
    const titleClass = computed(() => {
      let cls = "exactmetrics-report-title";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_3$8, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(tableRows.value, (row, index) => {
            return openBlock(), createElementBlock("div", {
              key: index,
              class: "exactmetrics-table-list-item"
            }, [
              createBaseVNode("div", _hoisted_4$8, [
                createBaseVNode("span", {
                  class: "exactmetrics-reports-list-count",
                  textContent: toDisplayString(row.number)
                }, null, 8, _hoisted_5$2),
                createBaseVNode("span", {
                  class: "exactmetrics-reports-list-text",
                  innerHTML: unref(sanitizeHtml)(row.text)
                }, null, 8, _hoisted_6$2)
              ]),
              createBaseVNode("div", _hoisted_7$2, [
                createBaseVNode("span", {
                  class: "exactmetrics-reports-list-number",
...
const _sfc_main$j = {
  ...
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const widgetReports = useWidgetReportsStore();
    const text_button = __2("View Full Posts/Pages Report", "google-analytics-dashboard-for-wp");
    const reportUrl = getReportUrl("publishers-pages");
    const text_top_posts = __2("Top Posts/Pages", "google-analytics-dashboard-for-wp");
...
const _hoisted_4$7 = { class: "exactmetrics-reports-pie-chart-holder" };
const _hoisted_5$1 = { class: "exactmetrics-reports-pie-chart-and-legend" };
const _hoisted_6$1 = {
  key: 0,
  class: "exactmetrics-widget-chart-empty"
};
const _hoisted_7$1 = {
  key: 0,
  class: "exactmetrics-pie-chart-legend"
};
const _hoisted_8$1 = { class: "exactmetrics-pie-chart-legend-text-and-value" };
const _hoisted_9$1 = ["textContent"];
const _hoisted_10$1 = { class: "exactmetrics-pie-chart-legend-value" };
const _sfc_main$i = {
  ...
  setup(__props) {
    ...
    const apexchart = m;
    const props = __props;
    const text_no_data = __2("No data available", "google-analytics-dashboard-for-wp");
    ...
    return (_ctx, _cache) => {
      return __props.chartData ? (openBlock(), createElementBlock("div", {
        key: 0,
        id: __props.id,
        class: "exactmetrics-reports-pie-chart"
      }, [
        __props.title ? (openBlock(), createElementBlock("h3", {
          key: 0,
          class: "exactmetrics-report-title",
...
const _sfc_main$h = {
  ...
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const widgetReports = useWidgetReportsStore();
    const text_title = __2("New vs. Returning Visitors", "google-analytics-dashboard-for-wp");
    ...
    const chartData = computed(() => {
      ...
      return {
        labels: [
          __2("New Visitors", "google-analytics-dashboard-for-wp"),
          __2("Returning Visitors", "google-analytics-dashboard-for-wp")
        ],
...
const _sfc_main$g = {
  ...
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const widgetReports = useWidgetReportsStore();
    const text_title = __2("Device Breakdown", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This graph shows the percentage of sessions on your site from different types of devices: traditional desktops/laptops, tablets, and mobile phones.",
      "google-analytics-dashboard-for-wp"
    );
    ...
    const chartData = computed(() => {
      ...
      return {
        labels: [
          __2("Desktop", "google-analytics-dashboard-for-wp"),
          __2("Tablet", "google-analytics-dashboard-for-wp"),
          __2("Mobile", "google-analytics-dashboard-for-wp")
        ],
        values: [
...
const _hoisted_3$6 = { class: "exactmetrics-table-box-list exactmetrics-table-box-table" };
const _hoisted_4$6 = { key: 0 };
const _hoisted_5 = { key: 0 };
const _hoisted_6 = { class: "exactmetrics-report-box-table-head-columns" };
const _hoisted_7 = ["textContent"];
const _hoisted_8 = ["textContent"];
const _hoisted_9 = ["innerHTML"];
const _hoisted_10 = {
  key: 1,
  class: "exactmetrics-table-no-data"
};
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(row, (cell, cellIndex) => {
                    return openBlock(), createElementBlock("td", { key: cellIndex }, [
                      createBaseVNode("div", {
                        class: "exactmetrics-table-mobile-heading",
                        textContent: toDisplayString(__props.headers[cellIndex] || "")
                      }, null, 8, _hoisted_8),
                      createBaseVNode("div", {
                        class: "exactmetrics-table-item-content",
...
const _hoisted_1$e = { class: "exactmetrics-widget-pro-upsell" };
const _hoisted_2$7 = ["textContent"];
const _hoisted_3$5 = { class: "exactmetrics-widget-pro-upsell__body" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$e, [
        createBaseVNode("p", {
          class: "exactmetrics-widget-pro-upsell__title",
          textContent: toDisplayString(__props.title)
        }, null, 8, _hoisted_2$7),
...
const _sfc_main$d = {
  ...
  setup(__props) {
    ...
    const text_title = __2("Top Landing Pages", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This list shows the top pages users first land on when visiting your website.",
      "google-analytics-dashboard-for-wp"
    );
    const text_button = __2("View Full Top Landing Pages Report", "google-analytics-dashboard-for-wp");
    ...
    const headers = [
      __2("Page Titles", "google-analytics-dashboard-for-wp"),
      __2("Visits", "google-analytics-dashboard-for-wp"),
      __2("Avg. Duration", "google-analytics-dashboard-for-wp"),
      __2("Bounce Rate", "google-analytics-dashboard-for-wp")
    ];
...
const _sfc_main$c = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    const licenseStore = useLicenseStore();
    const text_title = __2("Top Outbound Links", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This list shows the top links clicked on your website that go to another website.",
      "google-analytics-dashboard-for-wp"
    );
    const text_button = __2("View Full Outbound Links Report", "google-analytics-dashboard-for-wp");
...
const _sfc_main$b = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    const licenseStore = useLicenseStore();
    const text_title = __2("Top Affiliate Links", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This list shows the top affiliate links your visitors clicked the most.",
      "google-analytics-dashboard-for-wp"
    );
    const text_button = __2("View Full Affiliate Links Report", "google-analytics-dashboard-for-wp");
    const reportUrl = getReportUrl("publishers");
    const publisher = computed(() => widgetReports.publisher || {});
    const showUpsell = computed(() => {
      const license = isNetworkAdmin() ? licenseStore.license_network : licenseStore.license;
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    const licenseStore = useLicenseStore();
    const text_title = __2("Top Download Links", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This list shows the download links your visitors clicked the most.",
      "google-analytics-dashboard-for-wp"
    );
    const text_button = __2("View Full Download Links Report", "google-analytics-dashboard-for-wp");
    const reportUrl = getReportUrl("publishers");
    const publisher = computed(() => widgetReports.publisher || {});
    const showUpsell = computed(() => {
      const license = isNetworkAdmin() ? licenseStore.license_network : licenseStore.license;
...
const _hoisted_1$9 = {
  key: 1,
  class: "exactmetrics-ecommerce-overview"
};
const _hoisted_2$6 = { class: "exactmetrics-report-row exactmetrics-report-infobox-row" };
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("eCommerce Overview", "google-analytics-dashboard-for-wp");
    const text_conversion_rate = __2("Conversion Rate", "google-analytics-dashboard-for-wp");
    const text_transactions = __2("Transactions", "google-analytics-dashboard-for-wp");
    const text_revenue = __2("Revenue", "google-analytics-dashboard-for-wp");
    const text_avg_order = __2("Avg. Order Value", "google-analytics-dashboard-for-wp");
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("Top Products", "google-analytics-dashboard-for-wp");
    const text_empty = __2(
    ...
    const text_button = __2("View Full Top Products Report", "google-analytics-dashboard-for-wp");
    const reportUrl = getReportUrl("ecommerce");
    const headers = [
      __2("Product Name", "google-analytics-dashboard-for-wp"),
      __2("Quantity", "google-analytics-dashboard-for-wp"),
      __2("% of Sales", "google-analytics-dashboard-for-wp"),
      __2("Total Revenue", "google-analytics-dashboard-for-wp")
    ];
    const ecommerce = computed(() => widgetReports.ecommerce || {});
    const showUpsell = computed(() => {
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("Top Conversion Sources", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "This list shows the top referral websites in terms of product revenue.",
      "google-analytics-dashboard-for-wp"
    );
    ...
    const reportUrl = getReportUrl("ecommerce");
    const headers = [
      __2("Sources", "google-analytics-dashboard-for-wp"),
      __2("Visits", "google-analytics-dashboard-for-wp"),
      __2("% of Visits", "google-analytics-dashboard-for-wp"),
      __2("Revenue", "google-analytics-dashboard-for-wp")
    ];
    const ecommerce = computed(() => widgetReports.ecommerce || {});
    const showUpsell = computed(() => {
      return true;
    ...
    const rows = computed(() => {
      ...
      return items.map((row) => {
        ...
        const sourceCell = favicon ? `<img class="exactmetrics-reports-referral-icon" src="${favicon}" alt="referral-icon" /> ${escape(url)}` : escape(url);
        return [
          sourceCell,
...
const _hoisted_1$6 = {
  key: 1,
  class: "exactmetrics-report-row exactmetrics-report-infobox-row"
};
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("Total Add/Remove", "google-analytics-dashboard-for-wp");
    const text_added = __2("Added to Cart", "google-analytics-dashboard-for-wp");
    const text_removed = __2("Removed from Cart", "google-analytics-dashboard-for-wp");
    const ecommerce = computed(() => widgetReports.ecommerce || {});
    const range = computed(() => ecommerce.value?.infobox?.range ?? 0);
    const showUpsell = computed(() => {
      return true;
...
const _hoisted_1$5 = {
  key: 1,
  class: "exactmetrics-reports-infobox exactmetrics-widget-simple-metric"
};
const _hoisted_2$5 = ["textContent"];
const _hoisted_3$4 = { class: "exactmetrics-clearfix" };
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("New Customers", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "The percentage of first time purchasers.",
      "google-analytics-dashboard-for-wp"
    );
    ...
    return (_ctx, _cache) => {
      return showUpsell.value ? (openBlock(), createBlock(_sfc_main$e, {
        ...
        createVNode(_sfc_main$p, { content: unref(text_tooltip) }, null, 8, ["content"]),
...
const _hoisted_3$3 = { class: "exactmetrics-clearfix" };
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const widgetReports = useWidgetReportsStore();
    useLicenseStore();
    const text_title = __2("Abandoned Checkouts", "google-analytics-dashboard-for-wp");
    const text_tooltip = __2(
      "The percentage of checkouts that do not result in a transaction.",
      "google-analytics-dashboard-for-wp"
    );
...
const _hoisted_2$3 = { class: "exactmetrics-widget-report-title" };
const _hoisted_3$2 = {
  key: 1,
  class: "exactmetrics-widget-content"
};
const _hoisted_4$2 = {
  key: 0,
  class: "exactmetrics-widget-report-error"
};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const COMPONENT_MAP = {
      WidgetReportOverview: _sfc_main$l,
    ...
    const accordionClass = computed(() => ({
      "exactmetrics-widget-accordion-lite": !isFullWidth.value
    }));
    ...
    function reportRowClass(key) {
      return `exactmetrics-widget-report-element exactmetrics-widget-report-${key}`;
    }
    function toggleClass(key) {
      return {
        "exactmetrics-widget-toggle": true,
        "exactmetrics-widget-toggle-active": activeReport.value === key
      };
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-widget-accordion", accordionClass.value])
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(visibleReports.value, (report, key) => {
          return openBlock(), createElementBlock("div", {
            ...
            showReport(key, report) ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
              unref(widgetStore).error[report.type] ? (openBlock(), createElementBlock("div", _hoisted_4$2, toDisplayString(unref(widgetStore).error[report.type]), 1)) : shouldShowUpsell(key, report) ? (openBlock(), createBlock(_sfc_main$n, {
                key: 1,
                type: upsellType(report)
              }, null, 8, ["type"])) : !isReportLoaded(report.type) || unref(widgetReports).isLoading(report.type) ? (openBlock(), createBlock(_sfc_main$o, { key: 2 })) : (openBlock(), createBlock(resolveDynamicComponent(getReportComponent(report.component)), {
                key: 3,
                "report-key": key
              }, null, 8, ["report-key"]))
            ])) : createCommentVNode("", true)
        ...
        !unref(widgetStore).isFullWidth ? (openBlock(), createBlock(_sfc_main$q, { key: 0 })) : createCommentVNode("", true)
      ], 2);
    };
  }
};
const _hoisted_1$2 = {
  key: 0,
  class: "exactmetrics-widget-footer"
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const { __: __2, sprintf } = wp.i18n;
    const text_learn_more = __2("Learn More", "google-analytics-dashboard-for-wp");
    ...
    const suggestion = computed(() => {
      if (!userfeedbackInstalled.value) {
        return {
          plugin: "UserFeedback",
          actionText: __2("Install", "google-analytics-dashboard-for-wp"),
          actionUrl: userfeedbackUrl.value,
          learnUrl: "https://userfeedback.com/?utm_source=EM&utm_medium=referral&utm_campaign=emlink"
        };
      }
      if (!userfeedbackEnabled.value) {
        return {
          plugin: "UserFeedback",
          actionText: __2("Activate", "google-analytics-dashboard-for-wp"),
          actionUrl: userfeedbackUrl.value,
    ...
    const recommendedPrefix = computed(() => {
      ...
      return sprintf(
        '%1$s <span class="exactmetrics-dark">%2$s</span>',
        __2("Recommended Plugin:", "google-analytics-dashboard-for-wp"),
        pluginName
      );
    });
    return (_ctx, _cache) => {
...
const _hoisted_1$1 = { class: "exactmetrics-widget-reauth" };
const _hoisted_2$1 = ["href"];
const _sfc_main$1 = {
  __name: "ReportReAuth",
  setup(__props) {
    const { __: __2 } = wp.i18n;
    const text_heading = __2("Authentication Expired", "google-analytics-dashboard-for-wp");
    const text_body = __2(
      "Your Google Analytics authentication has expired. Please re-authenticate from ExactMetrics Settings.",
      "google-analytics-dashboard-for-wp"
    );
    const text_button = __2("Open Settings", "google-analytics-dashboard-for-wp");
    const settingsUrl = computed(() => {
      const url = getMiGlobal("reports_url", "");
      if (!url) return getMiGlobal("wizard_url", "#");
      return url.replace("exactmetrics_reports", "exactmetrics_settings");
    });
    return (_ctx, _cache) => {
...
const _hoisted_4 = { class: "exactmetrics-fullwidth-report-title" };
const _sfc_main = {
  __name: "App",
  setup(__props) {
    const { __: __2 } = wp.i18n;
    ...
    const text_overview_report = __2("Overview Report", "google-analytics-dashboard-for-wp");
    const text_no_permission = __2(
      "You don't have permission to view ExactMetrics reports.",
      "google-analytics-dashboard-for-wp"
    );
    ...
    const text_setup_button = __2("Setup Website Analytics", "google-analytics-dashboard-for-wp");
    const mainClass = computed(() => {
      const classes = ["exactmetrics-dashboard-widget-page"];
      if (widgetStore.compact) classes.push("exactmetrics-dashboard-widget-compact");
      if (widgetReports.blur) classes.push("exactmetrics-blur");
      return classes.join(" ");
    });
    onMounted(async () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-app-surface", mainClass.value])
      }, [
        ...
        !canViewReports.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createBaseVNode("a", {
            ...
            class: "mi-dw-btn-large exactmetrics-setup-wizard-link"
          ...
          unref(widgetStore).isFullWidth ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            _cache[0] || (_cache[0] = createBaseVNode("div", { class: "exactmetrics-fullwidth-mascot" }, null, -1)),
...
const mountEl = document.getElementById("exactmetrics-dashboard-widget");
if (mountEl) {
  ...
  app.config.errorHandler = (err, _vm, info) => {
    console.error("[exactmetrics-widget]", err, info);
  };
  app.mount(mountEl);
}
