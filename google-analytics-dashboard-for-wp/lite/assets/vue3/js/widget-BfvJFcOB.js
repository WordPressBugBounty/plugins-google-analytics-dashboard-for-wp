    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$p, [
        unref(isProVersion) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          (openBlock(), createBlock(_sfc_main$s, { key: 2 }))
        ], 64))
      ]);
    };
  }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const settingsUrl = computed(() => {
      ...
      return reportsUrl.replace("exactmetrics_reports", "exactmetrics_settings");
    });
    return (_ctx, _cache) => {
